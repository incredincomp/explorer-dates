...
const DEFAULT_DECORATION_POOL_SIZE = Number(env.EXPLORER_DATES_DECORATION_POOL_SIZE || 2048);
const DEFAULT_FLYWEIGHT_CACHE_SIZE = Number(env.EXPLORER_DATES_FLYWEIGHT_CACHE_SIZE || 4096);
const WORKSPACE_SCALE_BALANCED_THRESHOLD = Number(
    env.EXPLORER_DATES_WORKSPACE_BALANCED_THRESHOLD || 15000
);
const WORKSPACE_SCALE_LARGE_THRESHOLD = Number(env.EXPLORER_DATES_WORKSPACE_LARGE_THRESHOLD || 250000);
const WORKSPACE_SCALE_EXTREME_THRESHOLD = Number(env.EXPLORER_DATES_WORKSPACE_EXTREME_THRESHOLD || 400000);
const WORKSPACE_SCAN_MAX_RESULTS = Number(
    env.EXPLORER_DATES_WORKSPACE_SCAN_MAX_RESULTS ||
