...
explorerDatesApi.registerPlugin('myPlugin', myPlugin);
    ...
    </html>`}l(Ci,"getApiInformationHtml");function _i(a){let e=l(o=>{if(o<1024)return`${o} B`;let i=o/1024;return i<1024?`${i.toFixed(1)} KB`:`${(i/1024).toFixed(1)} MB`},"formatFileSize"),t=a.map(o=>`
        <tr>
            <td>${o.path}</td>
    ...
    `}l(_i,"generateWorkspaceActivityHTML");function xi(a){return`
        <!DOCTYPE html>
        <html>
        <head>
            <meta charset="UTF-8">
