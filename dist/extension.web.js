...
explorerDatesApi.registerPlugin('myPlugin', myPlugin);
    ...
    </html>`}l(_i,"generateDiagnosticsWebview");function xi(a){let e=l(t=>{if(t===0)return"0 B";let o=1024,i=["B","KB","MB","GB"],s=Math.floor(Math.log(t)/Math.log(o));return parseFloat((t/Math.pow(o,s)).toFixed(2))+" "+i[s]},"formatBytes");return`
        <!DOCTYPE html>
        <html>
        <head>
            <meta charset="UTF-8">
