var to=Object.defineProperty;var l=(a,e)=>to(a,"name",{value:e,configurable:!0});var S=(a,e)=>()=>(e||a((e={exports:{}}).exports,e),e.exports);var A=S((Mi,it)=>{var fe=require("vscode"),ve=class ve{constructor(){this._outputChannel=fe.window.createOutputChannel("Explorer Dates"),this._isEnabled=!1,this._updateConfig(),fe.workspace.onDidChangeConfiguration(e=>{e.affectsConfiguration("explorerDates.enableLogging")&&this._updateConfig()})}_updateConfig(){let e=fe.workspace.getConfiguration("explorerDates");this._isEnabled=e.get("enableLogging",!1)}debug(e,...t){if(this._isEnabled){let i=`[${new Date().toISOString()}] [DEBUG] ${e}`;this._outputChannel.appendLine(i),t.length>0&&this._outputChannel.appendLine(JSON.stringify(t,null,2))}}info(e,...t){let i=`[${new Date().toISOString()}] [INFO] ${e}`;this._outputChannel.appendLine(i),t.length>0&&this._outputChannel.appendLine(JSON.stringify(t,null,2))}warn(e,...t){let i=`[${new Date().toISOString()}] [WARN] ${e}`;this._outputChannel.appendLine(i),t.length>0&&this._outputChannel.appendLine(JSON.stringify(t,null,2))}error(e,t,...o){let r=`[${new Date().toISOString()}] [ERROR] ${e}`;this._outputChannel.appendLine(r),t instanceof Error&&(this._outputChannel.appendLine(`Error: ${t.message}`),t.stack&&this._outputChannel.appendLine(`Stack: ${t.stack}`)),o.length>0&&this._outputChannel.appendLine(JSON.stringify(o,null,2))}show(){this._outputChannel.show()}clear(){this._outputChannel.clear()}dispose(){this._outputChannel.dispose()}};l(ve,"Logger");var se=ve,we=null;function oo(){return we||(we=new se),we}l(oo,"getLogger");it.exports={Logger:se,getLogger:oo}});var Z=S((Ai,rt)=>{var be=require("vscode"),ae={en:{now:"now",minutes:"m",hours:"h",days:"d",weeks:"w",months:"mo",years:"y",justNow:"just now",minutesAgo:l(a=>`${a} minute${a!==1?"s":""} ago`,"minutesAgo"),hoursAgo:l(a=>`${a} hour${a!==1?"s":""} ago`,"hoursAgo"),yesterday:"yesterday",daysAgo:l(a=>`${a} day${a!==1?"s":""} ago`,"daysAgo"),lastModified:"Last modified",refreshSuccess:"Date decorations refreshed",activationError:"Explorer Dates failed to activate",errorAccessingFile:"Error accessing file for decoration"},es:{now:"ahora",minutes:"m",hours:"h",days:"d",weeks:"s",months:"m",years:"a",justNow:"ahora mismo",minutesAgo:l(a=>`hace ${a} minuto${a!==1?"s":""}`,"minutesAgo"),hoursAgo:l(a=>`hace ${a} hora${a!==1?"s":""}`,"hoursAgo"),yesterday:"ayer",daysAgo:l(a=>`hace ${a} d\xEDa${a!==1?"s":""}`,"daysAgo"),lastModified:"\xDAltima modificaci\xF3n",refreshSuccess:"Decoraciones de fecha actualizadas",activationError:"Explorer Dates no se pudo activar",errorAccessingFile:"Error al acceder al archivo para decoraci\xF3n"},fr:{now:"maintenant",minutes:"m",hours:"h",days:"j",weeks:"s",months:"m",years:"a",justNow:"\xE0 l'instant",minutesAgo:l(a=>`il y a ${a} minute${a!==1?"s":""}`,"minutesAgo"),hoursAgo:l(a=>`il y a ${a} heure${a!==1?"s":""}`,"hoursAgo"),yesterday:"hier",daysAgo:l(a=>`il y a ${a} jour${a!==1?"s":""}`,"daysAgo"),lastModified:"Derni\xE8re modification",refreshSuccess:"D\xE9corations de date actualis\xE9es",activationError:"\xC9chec de l'activation d'Explorer Dates",errorAccessingFile:"Erreur lors de l'acc\xE8s au fichier pour la d\xE9coration"},de:{now:"jetzt",minutes:"Min",hours:"Std",days:"T",weeks:"W",months:"Mon",years:"J",justNow:"gerade eben",minutesAgo:l(a=>`vor ${a} Minute${a!==1?"n":""}`,"minutesAgo"),hoursAgo:l(a=>`vor ${a} Stunde${a!==1?"n":""}`,"hoursAgo"),yesterday:"gestern",daysAgo:l(a=>`vor ${a} Tag${a!==1?"en":""}`,"daysAgo"),lastModified:"Zuletzt ge\xE4ndert",refreshSuccess:"Datumsdekorationen aktualisiert",activationError:"Explorer Dates konnte nicht aktiviert werden",errorAccessingFile:"Fehler beim Zugriff auf Datei f\xFCr Dekoration"},ja:{now:"\u4ECA",minutes:"\u5206",hours:"\u6642\u9593",days:"\u65E5",weeks:"\u9031",months:"\u30F6\u6708",years:"\u5E74",justNow:"\u305F\u3063\u305F\u4ECA",minutesAgo:l(a=>`${a}\u5206\u524D`,"minutesAgo"),hoursAgo:l(a=>`${a}\u6642\u9593\u524D`,"hoursAgo"),yesterday:"\u6628\u65E5",daysAgo:l(a=>`${a}\u65E5\u524D`,"daysAgo"),lastModified:"\u6700\u7D42\u66F4\u65B0",refreshSuccess:"\u65E5\u4ED8\u88C5\u98FE\u304C\u66F4\u65B0\u3055\u308C\u307E\u3057\u305F",activationError:"Explorer Dates\u306E\u30A2\u30AF\u30C6\u30A3\u30D9\u30FC\u30B7\u30E7\u30F3\u306B\u5931\u6557\u3057\u307E\u3057\u305F",errorAccessingFile:"\u30D5\u30A1\u30A4\u30EB\u30A2\u30AF\u30BB\u30B9\u4E2D\u306B\u30A8\u30E9\u30FC\u304C\u767A\u751F\u3057\u307E\u3057\u305F"},zh:{now:"\u73B0\u5728",minutes:"\u5206\u949F",hours:"\u5C0F\u65F6",days:"\u5929",weeks:"\u5468",months:"\u6708",years:"\u5E74",justNow:"\u521A\u521A",minutesAgo:l(a=>`${a}\u5206\u949F\u524D`,"minutesAgo"),hoursAgo:l(a=>`${a}\u5C0F\u65F6\u524D`,"hoursAgo"),yesterday:"\u6628\u5929",daysAgo:l(a=>`${a}\u5929\u524D`,"daysAgo"),lastModified:"\u6700\u540E\u4FEE\u6539",refreshSuccess:"\u65E5\u671F\u88C5\u9970\u5DF2\u5237\u65B0",activationError:"Explorer Dates \u6FC0\u6D3B\u5931\u8D25",errorAccessingFile:"\u8BBF\u95EE\u6587\u4EF6\u88C5\u9970\u65F6\u51FA\u9519"}},_e=class _e{constructor(){this._currentLocale="en",this._updateLocale(),be.workspace.onDidChangeConfiguration(e=>{e.affectsConfiguration("explorerDates.locale")&&this._updateLocale()})}_updateLocale(){let t=be.workspace.getConfiguration("explorerDates").get("locale","auto");t==="auto"&&(t=be.env.language.split("-")[0]),ae[t]||(t="en"),this._currentLocale=t}getString(e,...t){let i=(ae[this._currentLocale]||ae.en)[e];return typeof i=="function"?i(...t):i||ae.en[e]||e}getCurrentLocale(){return this._currentLocale}formatDate(e,t={}){try{return e.toLocaleDateString(this._currentLocale,t)}catch{return e.toLocaleDateString("en",t)}}};l(_e,"LocalizationManager");var ne=_e,ye=null;function io(){return ye||(ye=new ne),ye}l(io,"getLocalization");rt.exports={LocalizationManager:ne,getLocalization:io}});var Ce=S((Ii,at)=>{var st=require("vscode");function ro(){try{return st?.env?.uiKind===st?.UIKind?.Web}catch{return!1}}l(ro,"isWebEnvironment");at.exports={isWebEnvironment:ro}});var B=S((Ri,ct)=>{function K(a=""){return a?a.replace(/\\/g,"/"):""}l(K,"normalizePath");function so(a=""){let e=K(a);return e?e.split("/").filter(Boolean):[]}l(so,"getSegments");function nt(a=""){let e=so(a);return e.length?e[e.length-1]:""}l(nt,"getFileName");function ao(a=""){let e=nt(a),t=e.lastIndexOf(".");return t<=0?"":e.substring(t).toLowerCase()}l(ao,"getExtension");function no(a=""){let e=K(a),t=e.lastIndexOf("/");return t===-1?"":e.substring(0,t)}l(no,"getDirectory");function co(...a){return K(a.filter(Boolean).join("/")).replace(/\/+/g,"/")}l(co,"joinPath");function lo(a=""){return K(a).toLowerCase()}l(lo,"getCacheKey");function ho(a=""){if(!a)return"";if(typeof a=="string")return a;if(typeof a.fsPath=="string"&&a.fsPath.length>0)return a.fsPath;if(typeof a.path=="string"&&a.path.length>0)return a.path;if(typeof a.toString=="function")try{return a.toString(!0)}catch{return a.toString()}return String(a)}l(ho,"getUriPath");function uo(a="",e=""){let t=K(a),o=K(e);return t&&o.startsWith(t)?o.substring(t.length).replace(/^\/+/,""):o}l(uo,"getRelativePath");ct.exports={normalizePath:K,getFileName:nt,getExtension:ao,getDirectory:no,joinPath:co,getCacheKey:lo,getUriPath:ho,getRelativePath:uo}});var j=S((Ni,dt)=>{var z=require("vscode"),{isWebEnvironment:go}=Ce(),{normalizePath:po}=B(),lt=!0,k=null;if(!lt)try{k=require("fs").promises}catch{k=null}var xe=class xe{constructor(){this.isWeb=lt||go()}_toPath(e){return e?typeof e=="string"?e:e instanceof z.Uri?e.fsPath||e.path:String(e):""}_toUri(e){if(e instanceof z.Uri)return e;if(typeof e=="string")return z.Uri.file(e);throw new Error(`Unsupported target type: ${typeof e}`)}async stat(e){if(!this.isWeb&&k)return k.stat(this._toPath(e));let t=this._toUri(e),o=await z.workspace.fs.stat(t);return{...o,mtime:new Date(o.mtime),ctime:new Date(o.ctime),birthtime:new Date(o.ctime),isFile:l(()=>o.type===z.FileType.File,"isFile"),isDirectory:l(()=>o.type===z.FileType.Directory,"isDirectory")}}async readFile(e,t="utf8"){if(!this.isWeb&&k)return k.readFile(this._toPath(e),t);let o=this._toUri(e),i=await z.workspace.fs.readFile(o);return t===null||t==="binary"?i:new TextDecoder(t).decode(i)}async writeFile(e,t,o="utf8"){if(!this.isWeb&&k)return k.writeFile(this._toPath(e),t,o);let i=this._toUri(e),r=typeof t=="string"?new TextEncoder().encode(t):t;await z.workspace.fs.writeFile(i,r)}async mkdir(e,t={recursive:!0}){if(!this.isWeb&&k)return k.mkdir(this._toPath(e),t);let o=this._toUri(e);await z.workspace.fs.createDirectory(o)}async readdir(e,t={withFileTypes:!1}){if(!this.isWeb&&k)return k.readdir(this._toPath(e),t);let o=this._toUri(e),i=await z.workspace.fs.readDirectory(o);return t.withFileTypes?i.map(([r,s])=>({name:r,isDirectory:l(()=>s===z.FileType.Directory,"isDirectory"),isFile:l(()=>s===z.FileType.File,"isFile")})):i.map(([r])=>r)}async delete(e,t={recursive:!1}){if(!this.isWeb&&k){let i=this._toPath(e);return t.recursive?k.rm?k.rm(i,t):k.rmdir(i,t):k.unlink(i)}let o=this._toUri(e);await z.workspace.fs.delete(o,t)}async exists(e){try{return await this.stat(e),!0}catch{return!1}}async ensureDirectory(e){let t=po(this._toPath(e));await this.mkdir(t,{recursive:!0})}};l(xe,"FileSystemAdapter");var ce=xe,mo=new ce;dt.exports={FileSystemAdapter:ce,fileSystem:mo}});var ut=S((Oi,ht)=>{var P=require("vscode"),{getLogger:fo}=A(),{fileSystem:wo}=j(),{normalizePath:De,getRelativePath:vo,getFileName:bo}=B(),Fe=class Fe{constructor(){this._logger=fo(),this._fs=wo,this._commonExclusions=["node_modules",".npm",".yarn","coverage","nyc_output","dist","build","out","target","bin","obj",".vscode",".idea",".vs",".vscode-test",".git",".svn",".hg",".bzr",".pnpm-store","bower_components","jspm_packages","tmp","temp",".tmp",".cache",".parcel-cache",".DS_Store","Thumbs.db","__pycache__",".pytest_cache",".tox","venv",".env",".virtualenv","vendor",".docker","logs","*.log"],this._patternScores=new Map,this._workspaceAnalysis=new Map,this._logger.info("SmartExclusionManager initialized")}async cleanupAllWorkspaceProfiles(){let e=P.workspace.getConfiguration("explorerDates"),t=e.get("workspaceExclusionProfiles",{}),o=!1;for(let[i,r]of Object.entries(t)){let s=Array.isArray(r)?r:[],n=this._dedupeList(s);this._areListsEqual(s,n)||(t[i]=n,o=!0,this._logger.debug(`Deduped workspace exclusions for ${i}`,{before:s.length,after:n.length}))}o?(await e.update("workspaceExclusionProfiles",t,P.ConfigurationTarget.Global),this._logger.info("Cleaned up duplicate workspace exclusions",{workspaceCount:Object.keys(t).length})):this._logger.debug("Workspace exclusion profiles already clean")}async analyzeWorkspace(e){try{let t=De(e?.fsPath||e?.path||""),o={detectedPatterns:[],suggestedExclusions:[],projectType:"unknown",riskFolders:[]};o.projectType=await this._detectProjectType(e);let i=await this._scanForExclusionCandidates(e,t),r=this._scorePatterns(i,o.projectType);return o.detectedPatterns=i,o.suggestedExclusions=r.filter(s=>s.score>.7).map(s=>s.pattern),o.riskFolders=r.filter(s=>s.riskLevel==="high").map(s=>s.pattern),this._workspaceAnalysis.set(t,o),this._logger.info(`Workspace analysis complete for ${t}`,o),o}catch(t){return this._logger.error("Failed to analyze workspace",t),null}}async _detectProjectType(e){let t=[{file:"package.json",type:"javascript"},{file:"pom.xml",type:"java"},{file:"Cargo.toml",type:"rust"},{file:"setup.py",type:"python"},{file:"requirements.txt",type:"python"},{file:"Gemfile",type:"ruby"},{file:"composer.json",type:"php"},{file:"go.mod",type:"go"},{file:"CMakeLists.txt",type:"cpp"},{file:"Dockerfile",type:"docker"}];if(!e)return"unknown";for(let o of t)try{let i=P.Uri.joinPath(e,o.file);if(await this._fs.exists(i))return o.type}catch{}return"unknown"}async _scanForExclusionCandidates(e,t,o=2){let i=[],r=l(async(s,n=0)=>{if(!(n>o))try{let d=await this._fs.readdir(s,{withFileTypes:!0});for(let c of d)if(c.isDirectory()){let u=P.Uri.joinPath(s,c.name),h=De(u.fsPath||u.path),w=vo(t,h);this._commonExclusions.includes(c.name)&&i.push({name:c.name,path:w,type:"common",size:await this._getDirectorySize(u)});let f=await this._getDirectorySize(u);f>10485760&&i.push({name:c.name,path:w,type:"large",size:f}),await r(u,n+1)}}catch{}},"scanDirectory");return await r(e),i}async _getDirectorySize(e){try{let t=await this._fs.readdir(e,{withFileTypes:!0}),o=0,i=0;for(let r of t){if(i>100)break;if(r.isFile())try{let s=P.Uri.joinPath(e,r.name),n=await this._fs.stat(s);o+=n.size,i++}catch{}}return o}catch{return 0}}_scorePatterns(e,t){return e.map(o=>{let i=0,r="low";switch(o.type==="common"&&(i+=.8),o.size>100*1024*1024?(i+=.9,r="high"):o.size>10*1024*1024&&(i+=.5,r="medium"),t){case"javascript":["node_modules",".npm","coverage","dist","build"].includes(o.name)&&(i+=.9);break;case"python":["__pycache__",".pytest_cache","venv",".env"].includes(o.name)&&(i+=.9);break;case"java":["target","build",".gradle"].includes(o.name)&&(i+=.9);break}return["src","lib","app","components","pages"].includes(o.name.toLowerCase())&&(i=0,r="none"),{pattern:o.name,path:o.path,score:Math.min(i,1),riskLevel:r,size:o.size,type:o.type}})}async getWorkspaceExclusions(e){let t=P.workspace.getConfiguration("explorerDates"),o=t.get("workspaceExclusionProfiles",{}),i=this._getWorkspaceKey(e),r=o[i]||[],s=this._dedupeList(r);if(s.length!==r.length){o[i]=s;try{await t.update("workspaceExclusionProfiles",o,P.ConfigurationTarget.Global),this._logger.info(`Cleaned duplicate exclusions for ${i}`,{before:r.length,after:s.length})}catch(n){this._logger.warn(`Failed to persist cleaned exclusions for ${i}`,n)}}return s}async saveWorkspaceExclusions(e,t){let o=P.workspace.getConfiguration("explorerDates"),i=o.get("workspaceExclusionProfiles",{}),r=this._getWorkspaceKey(e),s=this._dedupeList(t);if(Array.isArray(i[r])?this._areListsEqual(i[r],s):!1){this._logger.debug(`No workspace exclusion changes for ${r}`);return}i[r]=s,await o.update("workspaceExclusionProfiles",i,P.ConfigurationTarget.Global),this._logger.info(`Saved workspace exclusions for ${r}`,s)}async getCombinedExclusions(e){let t=P.workspace.getConfiguration("explorerDates"),o=t.get("excludedFolders",[]),i=t.get("excludedPatterns",[]),r=t.get("smartExclusions",!0),s=[...o],n=[...i],d=await this.getWorkspaceExclusions(e);if(s.push(...d),r){let c=await this.analyzeWorkspace(e);c&&s.push(...c.suggestedExclusions)}return s=[...new Set(s)],n=[...new Set(n)],{folders:s,patterns:n}}_getWorkspaceKey(e){if(!e)return"unknown-workspace";let t=e.fsPath||e.path||"";return bo(t)||De(t)}async suggestExclusions(e){let t=await this.analyzeWorkspace(e),o=this._dedupeList(t?.suggestedExclusions||[]);if(!t||o.length===0)return;let i=await this.getWorkspaceExclusions(e),r=o.filter(c=>!i.includes(c));if(r.length===0){this._logger.debug("No new smart exclusions detected",{workspace:this._getWorkspaceKey(e)});return}let s=this._mergeExclusions(i,r);await this.saveWorkspaceExclusions(e,s);let n=r.length===1?`Explorer Dates automatically excluded "${r[0]}" to keep Explorer responsive.`:`Explorer Dates automatically excluded ${r.length} folders to keep Explorer responsive.`,d=await P.window.showInformationMessage(`${n} Keep these exclusions?`,"Keep","Review","Revert");d==="Revert"?(await this.saveWorkspaceExclusions(e,i),P.window.showInformationMessage("Smart exclusions reverted. Decorations will refresh for the restored folders."),this._logger.info("User reverted smart exclusions",{reverted:r})):d==="Review"?(this._showExclusionReview(t),this._logger.info("User reviewing smart exclusions",{pending:r})):this._logger.info("User kept smart exclusions",{accepted:r})}_dedupeList(e=[]){return Array.from(new Set(e.filter(Boolean)))}_mergeExclusions(e=[],t=[]){return this._dedupeList([...e||[],...t||[]])}_areListsEqual(e=[],t=[]){return e.length!==t.length?!1:e.every((o,i)=>o===t[i])}_showExclusionReview(e){let t=P.window.createWebviewPanel("exclusionReview","Smart Exclusion Review",P.ViewColumn.One,{enableScripts:!0});t.webview.html=this._generateReviewHTML(e)}_generateReviewHTML(e){let t=l(i=>{if(i<1024)return`${i} B`;let r=i/1024;return r<1024?`${r.toFixed(1)} KB`:`${(r/1024).toFixed(1)} MB`},"formatSize"),o=e.detectedPatterns.map(i=>`
            <tr>
                <td>${i.name}</td>
                <td>${i.path}</td>
                <td>${t(i.size)}</td>
...
`),d)try{let f=t||e,O=(await this._fileSystem.readFile(f,"utf8")).split(`
`).length;h+=`\u{1F4CF} Lines: ${O.toLocaleString()}
`}catch{}return h+=`\u{1F4C2} Path: ${e}`,r&&(h+=`

\u{1F464} Last Modified By: ${r.authorName}`,r.authorEmail&&(h+=` (${r.authorEmail})`),r.authorDate&&(h+=`
   ${r.authorDate}`)),h}_formatDateReadable(e){let t=new Date,o=t.getTime()-e.getTime(),i=Math.floor(o/(1e3*60)),r=Math.floor(o/(1e3*60*60)),s=Math.floor(o/(1e3*60*60*24));return i<1?this._l10n.getString("justNow"):i<60?this._l10n.getString("minutesAgo",i):r<24&&e.toDateString()===t.toDateString()?this._l10n.getString("hoursAgo",r):s<7?s===1?this._l10n.getString("yesterday"):this._l10n.getString("daysAgo",s):e.getFullYear()===t.getFullYear()?this._l10n.formatDate(e,{month:"short",day:"numeric"}):this._l10n.formatDate(e,{month:"short",day:"numeric",year:"numeric"})}async _getGitBlameInfo(e){if(!this._gitAvailable||!ee)return null;try{let t=p.workspace.getWorkspaceFolder(p.Uri.file(e));if(!t)return null;let o=t.uri.fsPath||t.uri.path,i=jo(o,e),{stdout:r}=await ee(`git log -1 --format="%an|%ae|%ad" -- "${i}"`,{cwd:t.uri.fsPath,timeout:2e3});if(!r||!r.trim())return null;let[s,n,d]=r.trim().split("|");return{authorName:s||"Unknown",authorEmail:n||"",authorDate:d||""}}catch{return null}}_getInitials(e){if(!e||typeof e!="string")return null;let t=e.trim().split(/\s+/).filter(Boolean);return t.length===0?null:t.length===1?t[0].substring(0,2).toUpperCase():(t[0][0]+(t[1][0]||"")).substring(0,2).toUpperCase()}_formatCompactSize(e){if(typeof e!="number"||isNaN(e))return null;let t=["B","K","M","G","T"],o=0,i=e;for(;i>=1024&&o<t.length-1;)i=i/1024,o++;let r=Math.round(i),s=t[o];if(r<=9)return`${r}${s}`;let n=String(r);return n.length>=2?n.slice(0,2):n}_formatFullDate(e){let t={year:"numeric",month:"long",day:"numeric",hour:"2-digit",minute:"2-digit",second:"2-digit",timeZoneName:"short"};return e.toLocaleString("en-US",t)}_getCacheKey(e){return Uo(J(e))}async provideFileDecoration(e,t){let o=Date.now();try{if(!e){this._logger.error("\u274C Invalid URI provided to provideFileDecoration:",e);return}let i=J(e);if(!i){this._logger.error("\u274C Could not resolve path for URI in provideFileDecoration:",e);return}let r=q(i);this._logger.info(`\u{1F50D} VSCODE REQUESTED DECORATION: ${r} (${i})`),this._logger.info(`\u{1F4CA} Call context: token=${!!t}, cancelled=${t?.isCancellationRequested}`);let s=p.workspace.getConfiguration("explorerDates"),n=l((E,tt)=>{if(this._previewSettings&&Object.prototype.hasOwnProperty.call(this._previewSettings,E)){let ot=this._previewSettings[E];return this._logger.debug(`\u{1F3AD} Using preview value for ${E}: ${ot} (config has: ${s.get(E,tt)})`),ot}return s.get(E,tt)},"_get");if(this._previewSettings&&this._logger.info(`\u{1F3AD} Processing ${r} in PREVIEW MODE with settings:`,this._previewSettings),!n("showDateDecorations",!0)){this._logger.info(`\u274C RETURNED UNDEFINED: Decorations disabled globally for ${r}`);return}if(await this._isExcludedSimple(e)){this._logger.info(`\u274C File excluded: ${r}`);return}this._logger.debug(`\u{1F50D} Processing file: ${r}`);let d=this._getCacheKey(e);if(this._previewSettings)this._logger.debug(`\u{1F504} Skipping cache due to active preview settings for: ${r}`);else{let E=await this._getCachedDecoration(d,r);if(E)return E}if(this._metrics.cacheMisses++,this._logger.debug(`\u274C Cache miss for: ${r} (key: ${d.substring(0,50)}...)`),t?.isCancellationRequested){this._logger.debug(`Decoration cancelled for: ${i}`);return}let c=await this._fileSystem.stat(e);if(!(typeof c.isFile=="function"?c.isFile():!0))return;let h=c.mtime instanceof Date?c.mtime:new Date(c.mtime),w=c.birthtime instanceof Date?c.birthtime:new Date(c.birthtime||c.ctime||c.mtime),f={mtime:h,birthtime:w,size:c.size},v=Date.now()-h.getTime(),O=n("dateDecorationFormat","smart"),L=n("colorScheme","none"),te=n("highContrastMode",!1),ue=n("showFileSize",!1),oe=n("fileSizeFormat","auto"),ie=n("accessibilityMode",!1),H=n("fadeOldFiles",!1),Ye=n("fadeThreshold",30),y=n("showGitInfo","none"),U=n("badgePriority","time"),ge=(y!=="none"||U==="author")&&this._gitAvailable,Ze=ge?y:"none";U==="author"&&!ge&&(U="time");let Xe=ge?await this._getGitBlameInfo(i):null,pe=this._generateBadgeDetails({filePath:i,stat:f,diffMs:v,dateFormat:O,badgePriority:U,showFileSize:ue,fileSizeFormat:oe,gitBlame:Xe,showGitInfo:Ze}),Zt=le(i),Xt=[".js",".ts",".jsx",".tsx",".py",".rb",".php",".java",".cpp",".c",".cs",".go",".rs",".kt",".swift"].includes(Zt),et=ie&&this._accessibility?.shouldEnhanceAccessibility();this._logger.debug(`\u{1F50D} Tooltip generation for ${r}: accessibilityMode=${ie}, shouldUseAccessible=${et}, previewMode=${!!this._previewSettings}`);let re=await this._buildTooltipContent({filePath:i,resourceUri:e,stat:f,badgeDetails:pe,gitBlame:Ze==="none"?null:Xe,shouldUseAccessibleTooltips:et,fileSizeFormat:oe,isCodeFile:Xt}),G;L!=="none"&&(G=this._themeIntegration?this._themeIntegration.applyThemeAwareColorScheme(L,i,v):this._getColorByScheme(h,L,i)),this._logger.debug(`\u{1F3A8} Color scheme setting: ${L}, using color: ${G?"yes":"no"}`),H&&Math.floor(v/864e5)>Ye&&(G=new p.ThemeColor("editorGutter.commentRangeForeground"));let me=kt(pe.displayBadge)||kt(pe.badge)||"??";this._accessibility?.shouldEnhanceAccessibility()&&(me=this._accessibility.getAccessibleBadge(me));let $;try{if($=new p.FileDecoration(me),re&&re.length<500&&($.tooltip=re,this._logger.debug(`\u{1F4DD} Added tooltip (${re.length} chars)`)),G){let E=this._enhanceColorForSelection(G);$.color=E,this._logger.debug(`\u{1F3A8} Added enhanced color: ${E.id||E} (original: ${G.id||G})`)}$.propagate=!1}catch(E){this._logger.error("\u274C Failed to create decoration:",E),$=new p.FileDecoration("!!"),$.propagate=!1}if(this._logger.debug(`\u{1F3A8} Color/contrast check for ${r}: colorScheme=${L}, highContrastMode=${te}, hasColor=${!!G}, previewMode=${!!this._previewSettings}`),te&&($.color=new p.ThemeColor("editorWarning.foreground"),this._logger.info(`\u{1F506} Applied high contrast color (overriding colorScheme=${L})`)),this._previewSettings?this._logger.debug(`\u{1F504} Skipping cache storage due to preview mode for: ${r}`):await this._storeDecorationInCache(d,$,r),this._metrics.totalDecorations++,!$?.badge){this._logger.error(`\u274C Decoration badge is invalid for: ${r}`);return}let eo=Date.now()-o;return this._logger.info(`\u2705 Decoration created for: ${r} (badge: ${$.badge||"undefined"}) - Cache key: ${d.substring(0,30)}...`),this._logger.info("\u{1F3AF} RETURNING DECORATION TO VSCODE:",{file:r,badge:$.badge,hasTooltip:!!$.tooltip,hasColor:!!$.color,colorType:$.color?.constructor?.name,processingTimeMs:eo,decorationType:$.constructor.name}),$}catch(i){this._metrics.errors++;let r=o?Date.now()-o:0,s=q(e),n=J(e)||"unknown-uri";this._logger.error(`\u274C DECORATION ERROR for ${s}:`,{error:i.message,stack:i.stack?.split(`
`)[0],processingTimeMs:r,uri:n}),this._logger.error(`\u274C CRITICAL ERROR DETAILS for ${s}: ${i.message}`),this._logger.error(`\u274C Error type: ${i.constructor.name}`),this._logger.error(`\u274C Full stack: ${i.stack}`),this._logger.info(`\u274C RETURNED UNDEFINED: Error occurred for ${s}`);return}}getMetrics(){let e={...this._metrics,cacheSize:this._decorationCache.size,cacheHitRate:this._metrics.cacheHits+this._metrics.cacheMisses>0?(this._metrics.cacheHits/(this._metrics.cacheHits+this._metrics.cacheMisses)*100).toFixed(2)+"%":"0.00%"};return this._advancedCache&&(e.advancedCache=this._advancedCache.getStats()),this._batchProcessor&&(e.batchProcessor=this._batchProcessor.getMetrics()),e.cacheDebugging={memoryCacheKeys:Array.from(this._decorationCache.keys()).slice(0,5),cacheTimeout:this._cacheTimeout,maxCacheSize:this._maxCacheSize,keyStatsSize:this._cacheKeyStats?this._cacheKeyStats.size:0},e}async initializeAdvancedSystems(e){try{this._extensionContext=e,this._isWeb&&await this._maybeWarnAboutGitLimitations(),this._advancedCache=new No(e),await this._advancedCache.initialize(),this._logger.info("Advanced cache initialized"),this._batchProcessor.initialize(),this._logger.info("Batch processor initialized"),await this._applyProgressiveLoadingSetting(),p.workspace.getConfiguration("explorerDates").get("autoThemeAdaptation",!0)&&(await this._themeIntegration.autoConfigureForTheme(),this._logger.info("Theme integration configured")),this._accessibility.shouldEnhanceAccessibility()&&(await this._accessibility.applyAccessibilityRecommendations(),this._logger.info("Accessibility recommendations applied"));try{await this._smartExclusion.cleanupAllWorkspaceProfiles()}catch(o){this._logger.warn("Failed to clean workspace exclusion profiles",o)}if(p.workspace.workspaceFolders)for(let o of p.workspace.workspaceFolders)try{await this._smartExclusion.suggestExclusions(o.uri),this._logger.info(`Smart exclusions analyzed for: ${o.name}`)}catch(i){this._logger.error(`Failed to analyze smart exclusions for ${o.name}`,i)}this._logger.info("Advanced systems initialized successfully")}catch(t){this._logger.error("Failed to initialize advanced systems",t)}}async _maybeWarnAboutGitLimitations(){if(!this._gitWarningShown){this._gitWarningShown=!0;try{let e=this._extensionContext?.globalState,t=Ko.WEB_GIT_NOTICE;if(e?.get(t,!1))return;if(e?.update)try{await e.update(t,!0)}catch(i){this._logger.debug("Failed to persist Git limitation notice flag",i)}Promise.resolve().then(()=>{p.window.showInformationMessage("Explorer Dates: Git attribution badges are unavailable on VS Code for Web. Time-based decorations remain available.")})}catch(e){this._logger.debug("Failed to display Git limitation notice",e)}}}_enhanceColorForSelection(e){let t={"charts.yellow":"list.warningForeground","charts.red":"list.errorForeground","charts.green":"list.highlightForeground","charts.blue":"symbolIcon.functionForeground","charts.purple":"symbolIcon.classForeground","charts.orange":"list.warningForeground","terminal.ansiYellow":"list.warningForeground","terminal.ansiGreen":"list.highlightForeground","terminal.ansiRed":"list.errorForeground","terminal.ansiBlue":"symbolIcon.functionForeground","terminal.ansiMagenta":"symbolIcon.classForeground","terminal.ansiCyan":"symbolIcon.stringForeground","editorGutter.commentRangeForeground":"list.deemphasizedForeground","editorWarning.foreground":"list.warningForeground","editorError.foreground":"list.errorForeground","editorInfo.foreground":"list.highlightForeground"},o=e.id||e,i=t[o];return i?(this._logger.debug(`\u{1F527} Enhanced color ${o} \u2192 ${i} for better selection visibility`),new p.ThemeColor(i)):e}async dispose(){this._logger.info("Disposing FileDateDecorationProvider",this.getMetrics()),this._advancedCache&&await this._advancedCache.dispose(),this._cancelProgressiveWarmupJobs(),this._batchProcessor&&this._batchProcessor.dispose(),this._decorationCache.clear(),this._onDidChangeFileDecorations.dispose(),this._fileWatcher&&this._fileWatcher.dispose()}};l(Le,"FileDateDecorationProvider");var Re=Le;$t.exports={FileDateDecorationProvider:Re}});var Et=S((exports,module)=>{var vscode=require("vscode"),{fileSystem}=j(),{getFileName,getRelativePath}=B(),isWeb=!0,childProcess=null;function loadChildProcess(){return!childProcess&&!isWeb&&(childProcess=eval("require")("child_process")),childProcess}l(loadChildProcess,"loadChildProcess");function registerCoreCommands({context:a,fileDateProvider:e,logger:t,l10n:o}){let i=[];i.push(vscode.commands.registerCommand("explorerDates.refreshDateDecorations",()=>{try{if(e){e.clearAllCaches(),e.refreshAll();let r=o?.getString("refreshSuccess")||"Date decorations refreshed - all caches cleared";vscode.window.showInformationMessage(r),t.info("Date decorations refreshed manually with cache clear")}}catch(r){t.error("Failed to refresh decorations",r),vscode.window.showErrorMessage(`Failed to refresh decorations: ${r.message}`)}})),i.push(vscode.commands.registerCommand("explorerDates.previewConfiguration",r=>{try{e&&(e.applyPreviewSettings(r),t.info("Configuration preview applied",r))}catch(s){t.error("Failed to apply configuration preview",s)}})),i.push(vscode.commands.registerCommand("explorerDates.clearPreview",()=>{try{e&&(e.applyPreviewSettings(null),t.info("Configuration preview cleared"))}catch(r){t.error("Failed to clear configuration preview",r)}})),i.push(vscode.commands.registerCommand("explorerDates.showMetrics",()=>{try{if(e){let r=e.getMetrics(),s=`Explorer Dates Metrics:
...
${Object.entries(s).map(([d,c])=>`${d}: ${JSON.stringify(c)}`).join(`
`)}`;vscode.window.showInformationMessage(n,{modal:!0}),t.info("Current configuration displayed",s)}catch(r){t.error("Failed to show configuration",r)}})),i.push(vscode.commands.registerCommand("explorerDates.resetToDefaults",async()=>{try{let r=vscode.workspace.getConfiguration("explorerDates");await r.update("highContrastMode",!1,vscode.ConfigurationTarget.Global),await r.update("badgePriority","time",vscode.ConfigurationTarget.Global),await r.update("accessibilityMode",!1,vscode.ConfigurationTarget.Global),vscode.window.showInformationMessage("Reset high contrast, badge priority, and accessibility mode to defaults. Changes should take effect immediately."),t.info("Reset problematic settings to defaults"),e&&(e.clearAllCaches(),e.refreshAll())}catch(r){t.error("Failed to reset settings",r),vscode.window.showErrorMessage(`Failed to reset settings: ${r.message}`)}})),i.push(vscode.commands.registerCommand("explorerDates.toggleDecorations",()=>{try{let r=vscode.workspace.getConfiguration("explorerDates"),s=r.get("showDateDecorations",!0);r.update("showDateDecorations",!s,vscode.ConfigurationTarget.Global);let n=s?o?.getString("decorationsDisabled")||"Date decorations disabled":o?.getString("decorationsEnabled")||"Date decorations enabled";vscode.window.showInformationMessage(n),t.info(`Date decorations toggled to: ${!s}`)}catch(r){t.error("Failed to toggle decorations",r),vscode.window.showErrorMessage(`Failed to toggle decorations: ${r.message}`)}})),i.push(vscode.commands.registerCommand("explorerDates.copyFileDate",async r=>{try{let s=r;if(!s&&vscode.window.activeTextEditor&&(s=vscode.window.activeTextEditor.document.uri),!s){vscode.window.showWarningMessage("No file selected");return}let n=await fileSystem.stat(s),d=(n.mtime instanceof Date?n.mtime:new Date(n.mtime)).toLocaleString();await vscode.env.clipboard.writeText(d),vscode.window.showInformationMessage(`Copied to clipboard: ${d}`),t.info(`File date copied for: ${s.fsPath||s.path}`)}catch(s){t.error("Failed to copy file date",s),vscode.window.showErrorMessage(`Failed to copy file date: ${s.message}`)}})),i.push(vscode.commands.registerCommand("explorerDates.showFileDetails",async r=>{try{let s=r;if(!s&&vscode.window.activeTextEditor&&(s=vscode.window.activeTextEditor.document.uri),!s){vscode.window.showWarningMessage("No file selected");return}let n=await fileSystem.stat(s),d=getFileName(s.fsPath||s.path),c=e?._formatFileSize(n.size,"auto")||`${n.size} bytes`,u=(n.mtime instanceof Date?n.mtime:new Date(n.mtime)).toLocaleString(),h=(n.birthtime instanceof Date?n.birthtime:new Date(n.birthtime||n.mtime)).toLocaleString(),w=`File: ${d}
Size: ${c}
Modified: ${u}
Created: ${h}
Path: ${s.fsPath||s.path}`;vscode.window.showInformationMessage(w,{modal:!0}),t.info(`File details shown for: ${s.fsPath||s.path}`)}catch(s){t.error("Failed to show file details",s),vscode.window.showErrorMessage(`Failed to show file details: ${s.message}`)}})),i.push(vscode.commands.registerCommand("explorerDates.toggleFadeOldFiles",()=>{try{let r=vscode.workspace.getConfiguration("explorerDates"),s=r.get("fadeOldFiles",!1);r.update("fadeOldFiles",!s,vscode.ConfigurationTarget.Global);let n=s?"Fade old files disabled":"Fade old files enabled";vscode.window.showInformationMessage(n),t.info(`Fade old files toggled to: ${!s}`)}catch(r){t.error("Failed to toggle fade old files",r),vscode.window.showErrorMessage(`Failed to toggle fade old files: ${r.message}`)}})),i.push(vscode.commands.registerCommand("explorerDates.showFileHistory",async r=>{try{if(isWeb){vscode.window.showInformationMessage("Git history is unavailable on VS Code for Web.");return}let s=r;if(!s&&vscode.window.activeTextEditor&&(s=vscode.window.activeTextEditor.document.uri),!s){vscode.window.showWarningMessage("No file selected");return}let n=vscode.workspace.getWorkspaceFolder(s);if(!n){vscode.window.showWarningMessage("File is not in a workspace");return}let c=`git log --oneline -10 -- "${getRelativePath(n.uri.fsPath||n.uri.path,s.fsPath||s.path)}"`;loadChildProcess().exec(c,{cwd:n.uri.fsPath,timeout:3e3},(h,w)=>{if(h){h.message.includes("not a git repository")?vscode.window.showWarningMessage("This file is not in a Git repository"):vscode.window.showErrorMessage(`Git error: ${h.message}`);return}if(!w.trim()){vscode.window.showInformationMessage("No Git history found for this file");return}let f=w.trim(),v=getFileName(s.fsPath||s.path);vscode.window.showInformationMessage(`Recent commits for ${v}:

${f}`,{modal:!0})}),t.info(`File history requested for: ${s.fsPath||s.path}`)}catch(s){t.error("Failed to show file history",s),vscode.window.showErrorMessage(`Failed to show file history: ${s.message}`)}})),i.push(vscode.commands.registerCommand("explorerDates.compareWithPrevious",async r=>{try{if(isWeb){vscode.window.showInformationMessage("Git comparisons are unavailable on VS Code for Web.");return}let s=r;if(!s&&vscode.window.activeTextEditor&&(s=vscode.window.activeTextEditor.document.uri),!s){vscode.window.showWarningMessage("No file selected");return}if(!vscode.workspace.getWorkspaceFolder(s)){vscode.window.showWarningMessage("File is not in a workspace");return}await vscode.commands.executeCommand("git.openChange",s),t.info(`Git diff opened for: ${s.fsPath||s.path}`)}catch(s){t.error("Failed to compare with previous version",s),vscode.window.showErrorMessage(`Failed to compare with previous version: ${s.message}`)}})),i.forEach(r=>a.subscriptions.push(r))}l(registerCoreCommands,"registerCoreCommands");module.exports={registerCoreCommands}});var Pt=S((or,At)=>{var T=require("vscode"),{getLogger:Jo}=A(),We=class We{constructor(e){this._logger=Jo(),this._provider=e,this._testResults=[]}async runComprehensiveDiagnostics(){this._logger.info("\u{1F50D} Starting comprehensive decoration diagnostics...");let e={timestamp:new Date().toISOString(),vscodeVersion:T.version,extensionVersion:T.extensions.getExtension("incredincomp.explorer-dates")?.packageJSON?.version,tests:{}};return e.tests.vscodeSettings=await this._testVSCodeSettings(),e.tests.providerRegistration=await this._testProviderRegistration(),e.tests.fileProcessing=await this._testFileProcessing(),e.tests.decorationCreation=await this._testDecorationCreation(),e.tests.cacheAnalysis=await this._testCacheAnalysis(),e.tests.extensionConflicts=await this._testExtensionConflicts(),e.tests.uriPathIssues=await this._testURIPathIssues(),this._logger.info("\u{1F50D} Comprehensive diagnostics completed",e),e}async _testVSCodeSettings(){let e=T.workspace.getConfiguration("explorer"),t=T.workspace.getConfiguration("workbench"),o=T.workspace.getConfiguration("explorerDates"),i={"explorer.decorations.badges":e.get("decorations.badges"),"explorer.decorations.colors":e.get("decorations.colors"),"workbench.colorTheme":t.get("colorTheme"),"explorerDates.showDateDecorations":o.get("showDateDecorations"),"explorerDates.colorScheme":o.get("colorScheme"),"explorerDates.showGitInfo":o.get("showGitInfo")},r=[];return i["explorer.decorations.badges"]===!1&&r.push("CRITICAL: explorer.decorations.badges is disabled"),i["explorer.decorations.colors"]===!1&&r.push("WARNING: explorer.decorations.colors is disabled"),i["explorerDates.showDateDecorations"]===!1&&r.push("CRITICAL: explorerDates.showDateDecorations is disabled"),{status:r.length>0?"ISSUES_FOUND":"OK",settings:i,issues:r}}async _testProviderRegistration(){let e=[];if(!this._provider)return e.push("CRITICAL: Decoration provider is null/undefined"),{status:"FAILED",issues:e};typeof this._provider.provideFileDecoration!="function"&&e.push("CRITICAL: provideFileDecoration method missing"),this._provider.onDidChangeFileDecorations||e.push("WARNING: onDidChangeFileDecorations event emitter missing");let t=T.Uri.file("/test/path");try{let o=await this._provider.provideFileDecoration(t);this._logger.debug("Provider test call completed",{result:!!o})}catch(o){e.push(`ERROR: Provider test call failed: ${o.message}`)}return{status:e.length>0?"ISSUES_FOUND":"OK",providerActive:!!this._provider,issues:e}}async _testFileProcessing(){let e=T.workspace.workspaceFolders;if(!e||e.length===0)return{status:"NO_WORKSPACE",issues:["No workspace folders available"]};let t=[],o=[];try{let i=["package.json","README.md","extension.js","src/logger.js"];for(let r of i){let s=T.Uri.joinPath(e[0].uri,r);try{await T.workspace.fs.stat(s);let n=this._provider._isExcludedSimple?await this._provider._isExcludedSimple(s):!1,d=await this._provider.provideFileDecoration(s);t.push({file:r,exists:!0,excluded:n,hasDecoration:!!d,badge:d?.badge,uri:s.toString()})}catch(n){t.push({file:r,exists:!1,error:n.message})}}}catch(i){o.push(`File processing test failed: ${i.message}`)}return{status:o.length>0?"ISSUES_FOUND":"OK",testFiles:t,issues:o}}async _testDecorationCreation(){let e=[],t=[];try{let i=new T.FileDecoration("test");e.push({name:"Simple decoration",success:!0,badge:i.badge})}catch(i){e.push({name:"Simple decoration",success:!1,error:i.message}),t.push("CRITICAL: Cannot create simple FileDecoration")}try{let i=new T.FileDecoration("test","Test tooltip");e.push({name:"Decoration with tooltip",success:!0,hasTooltip:!!(i&&i.tooltip)})}catch(i){e.push({name:"Decoration with tooltip",success:!1,error:i.message}),t.push("WARNING: Cannot create FileDecoration with tooltip")}try{let i=new T.FileDecoration("test","Test tooltip",new T.ThemeColor("charts.red"));e.push({name:"Decoration with color",success:!0,hasColor:!!i.color})}catch(i){e.push({name:"Decoration with color",success:!1,error:i.message}),t.push("WARNING: Cannot create FileDecoration with color")}let o=["1d","10m","2h","!!","\u25CF\u25CF","JA12","123456789"];for(let i of o)try{let r=new T.FileDecoration(i);e.push({name:`Badge format: ${i}`,success:!0,badge:r.badge,length:i.length})}catch(r){e.push({name:`Badge format: ${i}`,success:!1,error:r.message}),i.length<=8&&t.push(`WARNING: Valid badge format '${i}' failed`)}return{status:t.length>0?"ISSUES_FOUND":"OK",tests:e,issues:t}}async _testCacheAnalysis(){let e={memoryCache:{size:this._provider._decorationCache?.size||0,maxSize:this._provider._maxCacheSize||0},advancedCache:{available:!!this._provider._advancedCache,initialized:!1},metrics:this._provider.getMetrics?this._provider.getMetrics():null},t=[];return e.memoryCache.size>e.memoryCache.maxSize*.9&&t.push("WARNING: Memory cache is nearly full"),e.metrics&&e.metrics.cacheHits===0&&e.metrics.cacheMisses>10&&t.push("WARNING: Cache hit rate is 0% - potential cache key issues"),{status:t.length>0?"ISSUES_FOUND":"OK",cacheInfo:e,issues:t}}async _testExtensionConflicts(){let e=T.extensions.all,t=[],o=[];for(let r of e){if(!r.isActive)continue;let s=r.packageJSON;s.contributes?.commands?.some(d=>d.command?.includes("decoration")||d.title?.includes("decoration")||d.title?.includes("badge")||d.title?.includes("explorer"))&&o.push({id:r.id,name:s.displayName||s.name,version:s.version}),["file-icons","vscode-icons","material-icon-theme","explorer-exclude","hide-files","file-watcher"].some(d=>r.id.includes(d))&&t.push({id:r.id,name:s.displayName||s.name,reason:"Known to potentially interfere with file decorations"})}let i=[];return o.length>1&&i.push(`WARNING: ${o.length} extensions might provide file decorations`),t.length>0&&i.push(`WARNING: ${t.length} potentially conflicting extensions detected`),{status:i.length>0?"ISSUES_FOUND":"OK",decorationExtensions:o,potentialConflicts:t,issues:i}}async _testURIPathIssues(){let e=T.workspace.workspaceFolders;if(!e||e.length===0)return{status:"NO_WORKSPACE",issues:["No workspace available for URI testing"]};let t=[],o=[],i=["package.json","src/logger.js","README.md",".gitignore"];for(let r of i){let s=T.Uri.joinPath(e[0].uri,r);t.push({path:r,scheme:s.scheme,fsPath:s.fsPath,authority:s.authority,valid:s.scheme==="file"&&s.fsPath.length>0}),s.scheme!=="file"&&o.push(`WARNING: Non-file URI scheme for ${r}: ${s.scheme}`),(s.fsPath.includes("\\\\")||s.fsPath.includes("//"))&&o.push(`WARNING: Potential path separator issues in ${r}`)}return{status:o.length>0?"ISSUES_FOUND":"OK",tests:t,issues:o}}};l(We,"DecorationDiagnostics");var Ne=We;At.exports={DecorationDiagnostics:Ne}});var zt=S((rr,It)=>{var Q=require("vscode"),{getFileName:Qo}=B();async function Yo(){let a=A().getLogger();a.info("\u{1F3A8} Testing VS Code decoration rendering...");let i=class i{constructor(){this._onDidChangeFileDecorations=new Q.EventEmitter,this.onDidChangeFileDecorations=this._onDidChangeFileDecorations.event}provideFileDecoration(s){let n=Qo(s.fsPath||s.path),d=new Q.FileDecoration("TEST");return d.tooltip=`Test decoration for ${n}`,d.color=new Q.ThemeColor("charts.red"),a.info(`\u{1F9EA} Test provider returning decoration for: ${n}`),d}};l(i,"TestDecorationProvider");let e=i,t=new e,o=Q.window.registerFileDecorationProvider(t);return a.info("\u{1F9EA} Test decoration provider registered"),setTimeout(()=>{t._onDidChangeFileDecorations.fire(void 0),a.info("\u{1F504} Test decoration refresh triggered"),setTimeout(()=>{o.dispose(),a.info("\u{1F9EA} Test decoration provider disposed")},1e4)},1e3),"Test decoration provider registered for 10 seconds"}l(Yo,"testVSCodeDecorationRendering");async function Zo(){let a=A().getLogger();a.info("\u{1F527} Testing FileDecoration API...");let e=[];try{let o=new Q.FileDecoration("MIN");e.push({name:"Minimal decoration",success:!0,badge:o.badge}),a.info("\u2705 Minimal decoration created successfully")}catch(o){e.push({name:"Minimal decoration",success:!1,error:o.message}),a.error("\u274C Minimal decoration failed:",o)}try{let o=new Q.FileDecoration("FULL","Full decoration tooltip",new Q.ThemeColor("charts.blue"));o.propagate=!1,e.push({name:"Full decoration",success:!0,badge:o.badge,hasTooltip:!!o.tooltip,hasColor:!!o.color,propagate:o.propagate}),a.info("\u2705 Full decoration created successfully")}catch(o){e.push({name:"Full decoration",success:!1,error:o.message}),a.error("\u274C Full decoration failed:",o)}let t=["charts.red","charts.blue","charts.green","charts.yellow","terminal.ansiRed","terminal.ansiGreen","terminal.ansiBlue","editorError.foreground","editorWarning.foreground","editorInfo.foreground"];for(let o of t)try{e.push({name:`ThemeColor: ${o}`,success:!0,colorId:o})}catch(i){e.push({name:`ThemeColor: ${o}`,success:!1,error:i.message}),a.error(`\u274C ThemeColor ${o} failed:`,i)}return e}l(Zo,"testFileDecorationAPI");It.exports={testVSCodeDecorationRendering:Yo,testFileDecorationAPI:Zo}});var Lt=S((ar,Rt)=>{var m=require("vscode"),{fileSystem:Xo}=j(),{getFileName:ei,getRelativePath:ti}=B();function oi({context:a,fileDateProvider:e,logger:t,generators:o}){let{generateWorkspaceActivityHTML:i,generatePerformanceAnalyticsHTML:r,generateDiagnosticsHTML:s,generateDiagnosticsWebview:n}=o,d=[];d.push(m.commands.registerCommand("explorerDates.showWorkspaceActivity",async()=>{try{let c=m.window.createWebviewPanel("workspaceActivity","Workspace File Activity",m.ViewColumn.One,{enableScripts:!0});if(!m.workspace.workspaceFolders){m.window.showWarningMessage("No workspace folder open");return}let u=m.workspace.workspaceFolders[0],h=[],w=await m.workspace.findFiles("**/*","**/node_modules/**",100);for(let f of w)try{let v=await Xo.stat(f);(typeof v.isFile!="function"||v.isFile())&&h.push({path:ti(u.uri.fsPath||u.uri.path,f.fsPath||f.path),modified:v.mtime instanceof Date?v.mtime:new Date(v.mtime),size:v.size})}catch{}h.sort((f,v)=>v.modified.getTime()-f.modified.getTime()),c.webview.html=i(h.slice(0,50)),t.info("Workspace activity panel opened")}catch(c){t.error("Failed to show workspace activity",c),m.window.showErrorMessage(`Failed to show workspace activity: ${c.message}`)}})),d.push(m.commands.registerCommand("explorerDates.showPerformanceAnalytics",async()=>{try{let c=m.window.createWebviewPanel("performanceAnalytics","Explorer Dates Performance Analytics",m.ViewColumn.One,{enableScripts:!0}),u=e?e.getMetrics():{};c.webview.html=r(u),t.info("Performance analytics panel opened")}catch(c){t.error("Failed to show performance analytics",c),m.window.showErrorMessage(`Failed to show performance analytics: ${c.message}`)}})),d.push(m.commands.registerCommand("explorerDates.debugCache",async()=>{try{if(e){let c=e.getMetrics(),u={"Cache Summary":{"Memory Cache Size":c.cacheSize,"Cache Hit Rate":c.cacheHitRate,"Total Hits":c.cacheHits,"Total Misses":c.cacheMisses,"Cache Timeout":`${c.cacheDebugging.cacheTimeout}ms`},"Advanced Cache":c.advancedCache||"Not available","Sample Cache Keys":c.cacheDebugging.memoryCacheKeys||[]};m.window.showInformationMessage(`Cache Debug Info:
${JSON.stringify(u,null,2)}`,{modal:!0}),t.info("Cache debug info displayed",u)}}catch(c){t.error("Failed to show cache debug info",c),m.window.showErrorMessage(`Failed to show cache debug info: ${c.message}`)}})),d.push(m.commands.registerCommand("explorerDates.runDiagnostics",async()=>{try{let c=m.workspace.getConfiguration("explorerDates"),u=m.window.activeTextEditor,h={"Extension Status":{"Provider Active":e?"Yes":"No","Decorations Enabled":c.get("showDateDecorations",!0)?"Yes":"No","VS Code Version":m.version,"Extension Version":a.extension.packageJSON.version}};if(u){let{uri:f}=u.document;f.scheme==="file"&&(h["Current File"]={"File Path":f.fsPath,"File Extension":ei(f.fsPath||f.path).split(".").pop()||"No extension","Is Excluded":e?await e._isExcludedSimple(f):"Unknown"})}if(h.Configuration={"Excluded Folders":c.get("excludedFolders",[]),"Excluded Patterns":c.get("excludedPatterns",[]),"Color Scheme":c.get("colorScheme","none"),"Cache Timeout":`${c.get("cacheTimeout",3e4)}ms`},e){let f=e.getMetrics();h.Performance={"Total Decorations":f.totalDecorations,"Cache Size":f.cacheSize,Errors:f.errors}}let w=m.window.createWebviewPanel("explorerDatesDiagnostics","Explorer Dates Diagnostics",m.ViewColumn.One,{enableScripts:!0});w.webview.html=s(h),t.info("Diagnostics panel opened",h)}catch(c){t.error("Failed to run diagnostics",c),m.window.showErrorMessage(`Failed to run diagnostics: ${c.message}`)}})),d.push(m.commands.registerCommand("explorerDates.testDecorations",async()=>{try{t.info("\u{1F50D} Starting comprehensive decoration diagnostics...");let{DecorationDiagnostics:c}=Pt(),h=await new c(e).runComprehensiveDiagnostics(),w=m.window.createWebviewPanel("decorationDiagnostics","Decoration Diagnostics - Root Cause Analysis",m.ViewColumn.One,{enableScripts:!0});w.webview.html=n(h);let f=[],v=[];Object.values(h.tests).forEach(O=>{O.issues&&O.issues.forEach(L=>{L.startsWith("CRITICAL:")?f.push(L):L.startsWith("WARNING:")&&v.push(L)})}),f.length>0?m.window.showErrorMessage(`CRITICAL ISSUES FOUND: ${f.join(", ")}`):v.length>0?m.window.showWarningMessage(`Warnings found: ${v.length} potential issues detected. Check diagnostics panel.`):m.window.showInformationMessage("No critical issues found. Decorations should be working properly."),t.info("\u{1F50D} Comprehensive diagnostics completed",h)}catch(c){t.error("Failed to run comprehensive diagnostics",c),m.window.showErrorMessage(`Diagnostics failed: ${c.message}`)}})),d.push(m.commands.registerCommand("explorerDates.monitorDecorations",async()=>{if(!e){m.window.showErrorMessage("Decoration provider not available");return}e.startProviderCallMonitoring(),e.forceRefreshAllDecorations(),setTimeout(()=>{let c=e.getProviderCallStats(),u=`VS Code Decoration Requests: ${c.totalCalls} calls for ${c.uniqueFiles} files`;m.window.showInformationMessage(u),t.info("\u{1F50D} Decoration monitoring results:",c)},5e3),m.window.showInformationMessage("Started monitoring VS Code decoration requests. Results in 5 seconds...")})),d.push(m.commands.registerCommand("explorerDates.testVSCodeRendering",async()=>{try{let{testVSCodeDecorationRendering:c,testFileDecorationAPI:u}=zt();t.info("\u{1F3A8} Testing VS Code decoration rendering system...");let h=await u();t.info("\u{1F527} FileDecoration API tests:",h);let w=await c();t.info("\u{1F3A8} Decoration rendering test:",w),m.window.showInformationMessage('VS Code decoration rendering test started. Check Output panel and Explorer for "TEST" badges on files.')}catch(c){t.error("Failed to test VS Code rendering:",c),m.window.showErrorMessage(`VS Code rendering test failed: ${c.message}`)}})),d.push(m.commands.registerCommand("explorerDates.quickFix",async()=>{try{let c=m.workspace.getConfiguration("explorerDates"),u=[];c.get("showDateDecorations",!0)||u.push({issue:"Date decorations are disabled",description:"Enable date decorations",fix:l(async()=>c.update("showDateDecorations",!0,m.ConfigurationTarget.Global),"fix")});let h=c.get("excludedPatterns",[]);if(h.includes("**/*")&&u.push({issue:"All files are excluded by pattern",description:"Remove overly broad exclusion pattern",fix:l(async()=>{let f=h.filter(v=>v!=="**/*");await c.update("excludedPatterns",f,m.ConfigurationTarget.Global)},"fix")}),u.length===0){m.window.showInformationMessage("No common issues detected. Decorations should be working.");return}let w=await m.window.showQuickPick(u.map(f=>({label:f.description,description:f.issue,fix:f.fix})),{placeHolder:"Select an issue to fix automatically"});w&&(await w.fix(),m.window.showInformationMessage("Fixed! Try refreshing decorations now."),e&&(e.clearAllCaches(),e.refreshAll()))}catch(c){t.error("Failed to run quick fix",c),m.window.showErrorMessage(`Failed to run quick fix: ${c.message}`)}})),d.push(m.commands.registerCommand("explorerDates.showKeyboardShortcuts",async()=>{try{e?._accessibility?await e._accessibility.showKeyboardShortcutsHelp():m.window.showInformationMessage("Keyboard shortcuts: Ctrl+Shift+D (toggle), Ctrl+Shift+C (copy date), Ctrl+Shift+I (file details), Ctrl+Shift+R (refresh), Ctrl+Shift+A (workspace activity)"),t.info("Keyboard shortcuts help shown")}catch(c){t.error("Failed to show keyboard shortcuts help",c),m.window.showErrorMessage(`Failed to show keyboard shortcuts help: ${c.message}`)}})),d.forEach(c=>a.subscriptions.push(c))}l(oi,"registerAnalysisCommands");Rt.exports={registerAnalysisCommands:oi}});var Wt=S((cr,Nt)=>{var Y=require("vscode");function ii({context:a,logger:e,getOnboardingManager:t}){let o=[];o.push(Y.commands.registerCommand("explorerDates.showFeatureTour",async()=>{try{await t().showFeatureTour(),e.info("Feature tour opened")}catch(i){e.error("Failed to show feature tour",i),Y.window.showErrorMessage(`Failed to show feature tour: ${i.message}`)}})),o.push(Y.commands.registerCommand("explorerDates.showQuickSetup",async()=>{try{await t().showQuickSetupWizard(),e.info("Quick setup wizard opened")}catch(i){e.error("Failed to show quick setup wizard",i),Y.window.showErrorMessage(`Failed to show quick setup wizard: ${i.message}`)}})),o.push(Y.commands.registerCommand("explorerDates.showWhatsNew",async()=>{try{let i=a.extension.packageJSON.version;await t().showWhatsNew(i),e.info("What's new panel opened")}catch(i){e.error("Failed to show what's new",i),Y.window.showErrorMessage(`Failed to show what's new: ${i.message}`)}})),o.forEach(i=>a.subscriptions.push(i))}l(ii,"registerOnboardingCommands");Nt.exports={registerOnboardingCommands:ii}});var Bt=S((dr,Ot)=>{var _=require("vscode"),{getLogger:ri}=A(),{getLocalization:si}=Z(),Be=class Be{constructor(e){this._context=e,this._logger=ri(),this._l10n=si(),this._hasShownWelcome=e.globalState.get("explorerDates.hasShownWelcome",!1),this._hasCompletedSetup=e.globalState.get("explorerDates.hasCompletedSetup",!1),this._onboardingVersion=e.globalState.get("explorerDates.onboardingVersion","0.0.0"),this._logger.info("OnboardingManager initialized",{hasShownWelcome:this._hasShownWelcome,hasCompletedSetup:this._hasCompletedSetup,onboardingVersion:this._onboardingVersion})}async shouldShowOnboarding(){let e=this._context.extension.packageJSON.version;return!this._hasShownWelcome||!this._hasCompletedSetup||this._shouldShowVersionUpdate(e)}_shouldShowVersionUpdate(e){if(this._onboardingVersion==="0.0.0")return!0;let[t]=e.split(".").map(Number),[o]=this._onboardingVersion.split(".").map(Number);return t>o}_isMinorUpdate(e){if(this._onboardingVersion==="0.0.0")return!1;let[t,o]=e.split(".").map(Number),[i,r]=this._onboardingVersion.split(".").map(Number);return t===i&&o>r}async showWelcomeMessage(){try{let e=this._context.extension.packageJSON.version,t=this._hasShownWelcome,o=this._isMinorUpdate(e);if(o)return this._showGentleUpdateNotification(e);let i=t?`Explorer Dates has been updated to v${e} with new features and improvements!`:"See file modification dates right in VS Code Explorer with intuitive time badges, file sizes, Git info, and much more!",r=t?["\u{1F4D6} What's New","\u2699\uFE0F Settings","Dismiss"]:["\u{1F680} Quick Setup","\u{1F4D6} Feature Tour","\u2699\uFE0F Settings","Maybe Later"],s=await _.window.showInformationMessage(i,{modal:!1},...r);switch(await this._context.globalState.update("explorerDates.hasShownWelcome",!0),await this._context.globalState.update("explorerDates.onboardingVersion",e),s){case"\u{1F680} Quick Setup":await this.showQuickSetupWizard();break;case"\u{1F4D6} Feature Tour":await this.showFeatureTour();break;case"\u{1F4D6} What's New":await this.showWhatsNew(e);break;case"\u2699\uFE0F Settings":await _.commands.executeCommand("workbench.action.openSettings","explorerDates");break;case"previewConfiguration":await _.commands.executeCommand("explorerDates.previewConfiguration",i.settings);break;case"clearPreview":await _.commands.executeCommand("explorerDates.clearPreview");break}this._logger.info("Welcome message shown",{action:s,isUpdate:t,isMinorUpdate:o})}catch(e){this._logger.error("Failed to show welcome message",e)}}async _showGentleUpdateNotification(e){let t=_.window.createStatusBarItem(_.StatusBarAlignment.Right,100);t.text=`$(check) Explorer Dates updated to v${e}`,t.tooltip="Click to see what's new in Explorer Dates",t.command="explorerDates.showWhatsNew",t.show(),setTimeout(()=>{t.dispose()},1e4),await this._context.globalState.update("explorerDates.onboardingVersion",e),this._logger.info("Showed gentle update notification",{version:e})}async showQuickSetupWizard(){try{let e=_.window.createWebviewPanel("explorerDatesSetup","Explorer Dates Quick Setup",_.ViewColumn.One,{enableScripts:!0,retainContextWhenHidden:!0});e.webview.html=this._generateSetupWizardHTML(),e.webview.onDidReceiveMessage(async t=>{await this._handleSetupWizardMessage(t,e)}),this._logger.info("Quick setup wizard opened")}catch(e){this._logger.error("Failed to show setup wizard",e)}}async _handleSetupWizardMessage(e,t){try{switch(e.command){case"applyConfiguration":await this._applyQuickConfiguration(e.configuration),await this._context.globalState.update("explorerDates.hasCompletedSetup",!0),_.window.showInformationMessage("\u2705 Explorer Dates configured successfully!"),t.dispose();break;case"previewConfiguration":e.settings&&(await _.commands.executeCommand("explorerDates.previewConfiguration",e.settings),this._logger.info("Configuration preview applied via webview",e.settings));break;case"clearPreview":await _.commands.executeCommand("explorerDates.clearPreview"),this._logger.info("Configuration preview cleared via webview");break;case"skipSetup":await this._context.globalState.update("explorerDates.hasCompletedSetup",!0),t.dispose();break;case"openSettings":await _.commands.executeCommand("workbench.action.openSettings","explorerDates"),t.dispose();break}}catch(o){this._logger.error("Failed to handle setup wizard message",o)}}async _applyQuickConfiguration(e){let t=_.workspace.getConfiguration("explorerDates");if(e.preset){let i=this._getConfigurationPresets()[e.preset];if(i){this._logger.info(`Applying preset: ${e.preset}`,i.settings);for(let[r,s]of Object.entries(i.settings))await t.update(r,s,_.ConfigurationTarget.Global),this._logger.debug(`Updated setting: explorerDates.${r} = ${s}`);this._logger.info(`Applied preset: ${e.preset}`,i.settings),_.window.showInformationMessage(`Applied "${i.name}" configuration. Changes should be visible immediately!`)}}if(e.individual){for(let[o,i]of Object.entries(e.individual))await t.update(o,i,_.ConfigurationTarget.Global);this._logger.info("Applied individual settings",e.individual)}try{await _.commands.executeCommand("explorerDates.refreshDateDecorations"),this._logger.info("Decorations refreshed after configuration change")}catch(o){this._logger.warn("Failed to refresh decorations after configuration change",o)}}_getConfigurationPresets(){return{minimal:{name:"Minimal",description:"Clean and simple - just show modification times in short format",settings:{dateDecorationFormat:"relative-short",colorScheme:"none",highContrastMode:!1,showFileSize:!1,showGitInfo:"none",badgePriority:"time",fadeOldFiles:!1,enableContextMenu:!1,showStatusBar:!1}},developer:{name:"Developer",description:"Perfect for development - includes Git info, file sizes, and color coding",settings:{dateDecorationFormat:"smart",colorScheme:"recency",highContrastMode:!1,showFileSize:!0,fileSizeFormat:"auto",showGitInfo:"author",badgePriority:"time",fadeOldFiles:!0,fadeThreshold:30,enableContextMenu:!0,showStatusBar:!0}},powerUser:{name:"Power User",description:"Maximum information - all features enabled with vibrant colors",settings:{dateDecorationFormat:"smart",colorScheme:"vibrant",highContrastMode:!1,showFileSize:!0,fileSizeFormat:"auto",showGitInfo:"both",badgePriority:"time",fadeOldFiles:!0,fadeThreshold:14,enableContextMenu:!0,showStatusBar:!0,smartExclusions:!0,progressiveLoading:!0,persistentCache:!0}},gitFocused:{name:"Git-Focused",description:"Show author initials as badges with full Git information in tooltips",settings:{dateDecorationFormat:"smart",colorScheme:"file-type",highContrastMode:!1,showFileSize:!1,showGitInfo:"both",badgePriority:"author",fadeOldFiles:!1,enableContextMenu:!0,showStatusBar:!0}},accessible:{name:"Accessible",description:"High contrast and screen reader friendly with detailed tooltips",settings:{dateDecorationFormat:"relative-short",colorScheme:"none",highContrastMode:!0,accessibilityMode:!0,showFileSize:!1,showGitInfo:"none",badgePriority:"time",fadeOldFiles:!1,enableContextMenu:!0,keyboardNavigation:!0}}}}async showFeatureTour(){try{let e=_.window.createWebviewPanel("explorerDatesFeatureTour","Explorer Dates Feature Tour",_.ViewColumn.One,{enableScripts:!0,retainContextWhenHidden:!0});e.webview.html=this._generateFeatureTourHTML(),e.webview.onDidReceiveMessage(async t=>{t.command==="openSettings"?await _.commands.executeCommand("workbench.action.openSettings",t.setting||"explorerDates"):t.command==="runCommand"&&await _.commands.executeCommand(t.commandId)}),this._logger.info("Feature tour opened")}catch(e){this._logger.error("Failed to show feature tour",e)}}_generateSetupWizardHTML(){let e=this._getConfigurationPresets(),t={minimal:e.minimal,developer:e.developer,accessible:e.accessible};return`
            <!DOCTYPE html>
            <html>
            <head>
                <meta charset="UTF-8">
...
explorerDatesApi.registerPlugin('myPlugin', myPlugin);
    ...
    </html>`}l(_i,"getApiInformationHtml");function Ci(a){let e=l(o=>{if(o<1024)return`${o} B`;let i=o/1024;return i<1024?`${i.toFixed(1)} KB`:`${(i/1024).toFixed(1)} MB`},"formatFileSize"),t=a.map(o=>`
        <tr>
            <td>${o.path}</td>
    ...
    `}l(Ci,"generateWorkspaceActivityHTML");function xi(a){return`
        <!DOCTYPE html>
        <html>
        <head>
            <meta charset="UTF-8">
    ...
    `}l(xi,"generateDiagnosticsHTML");function Di(a){return`<!DOCTYPE html>
    <html>
    <head>
        <meta charset="UTF-8">
    ...
    </html>`}l(Di,"generateDiagnosticsWebview");function Si(a){let e=l(t=>{if(t===0)return"0 B";let o=1024,i=["B","KB","MB","GB"],r=Math.floor(Math.log(t)/Math.log(o));return parseFloat((t/Math.pow(o,r)).toFixed(2))+" "+i[r]},"formatBytes");return`
        <!DOCTYPE html>
        <html>
        <head>
            <meta charset="UTF-8">
    ...
    `}l(Si,"generatePerformanceAnalyticsHTML");function Vt(a){let e=b.window.createStatusBarItem(b.StatusBarAlignment.Right,100);e.command="explorerDates.showFileDetails",e.tooltip="Click to show detailed file information";let t=l(async()=>{try{let o=b.window.activeTextEditor;if(!o){e.hide();return}let i=o.document.uri;if(i.scheme!=="file"){e.hide();return}let r=await wi.stat(i),s=r.mtime instanceof Date?r.mtime:new Date(r.mtime),n=W._formatDateBadge(s,"smart"),d=W._formatFileSize(r.size,"auto");e.text=`$(clock) ${n} $(file) ${d}`,e.show()}catch(o){e.hide(),D.debug("Failed to update status bar",o)}},"updateStatusBar");return b.window.onDidChangeActiveTextEditor(t),b.window.onDidChangeTextEditorSelection(t),t(),a.subscriptions.push(e),e}l(Vt,"initializeStatusBar");async function Fi(a){try{D=mi(),he=fi(),D.info("Explorer Dates: Extension activated");let e=b.env.uiKind===b.UIKind.Web;await b.commands.executeCommand("setContext","explorerDates.gitFeaturesAvailable",!e);let t=b.workspace.getConfiguration("explorerDates"),o=t.get("enableWorkspaceTemplates",!0),i=t.get("enableReporting",!0),r=t.get("enableExtensionApi",!0);W=new pi;let s=b.window.registerFileDecorationProvider(W);a.subscriptions.push(s),a.subscriptions.push(W),a.subscriptions.push(D),await W.initializeAdvancedSystems(a);let n=null,d=null,c=null,u=null,h=l(()=>{if(!n){let{OnboardingManager:y}=Bt();n=new y(a)}return n},"getOnboardingManager"),w=l(()=>{if(!o)throw new Error("Workspace templates are disabled via explorerDates.enableWorkspaceTemplates");if(!d){let{WorkspaceTemplatesManager:y}=jt();d=new y(a)}return d},"getWorkspaceTemplatesManager"),f=l(()=>{if(!c){let{ExtensionApiManager:y}=Ht();c=new y}return c},"getExtensionApiManager"),v=l(()=>{if(!i)throw new Error("Reporting is disabled via explorerDates.enableReporting");if(!u){let{ExportReportingManager:y}=Kt();u=new y}return u},"getExportReportingManager"),O=l(()=>f().getApi(),"apiFactory");r?a.exports=O:(a.exports=void 0,D.info("Explorer Dates API exports disabled via explorerDates.enableExtensionApi")),b.workspace.getConfiguration("explorerDates").get("showWelcomeOnStartup",!0)&&await h().shouldShowOnboarding()&&setTimeout(()=>{h().showWelcomeMessage()},5e3),vi({context:a,fileDateProvider:W,logger:D,l10n:he}),bi({context:a,fileDateProvider:W,logger:D,generators:{generateWorkspaceActivityHTML:Ci,generatePerformanceAnalyticsHTML:Si,generateDiagnosticsHTML:xi,generateDiagnosticsWebview:Di}}),yi({context:a,logger:D,getOnboardingManager:h});let te=b.commands.registerCommand("explorerDates.openTemplateManager",async()=>{try{if(!o){b.window.showInformationMessage("Workspace templates are disabled. Enable explorerDates.enableWorkspaceTemplates to use this command.");return}await w().showTemplateManager(),D.info("Template manager opened")}catch(y){D.error("Failed to open template manager",y),b.window.showErrorMessage(`Failed to open template manager: ${y.message}`)}});a.subscriptions.push(te);let ue=b.commands.registerCommand("explorerDates.saveTemplate",async()=>{try{if(!o){b.window.showInformationMessage("Workspace templates are disabled. Enable explorerDates.enableWorkspaceTemplates to save templates.");return}let y=await b.window.showInputBox({prompt:"Enter template name",placeHolder:"e.g., My Project Setup"});if(y){let U=await b.window.showInputBox({prompt:"Enter description (optional)",placeHolder:"Brief description of this template"})||"";await w().saveCurrentConfiguration(y,U)}D.info("Template saved")}catch(y){D.error("Failed to save template",y),b.window.showErrorMessage(`Failed to save template: ${y.message}`)}});a.subscriptions.push(ue);let oe=b.commands.registerCommand("explorerDates.generateReport",async()=>{try{if(!i){b.window.showInformationMessage("Reporting features are disabled. Enable explorerDates.enableReporting to generate reports.");return}await v().showReportDialog(),D.info("Report generation started")}catch(y){D.error("Failed to generate report",y),b.window.showErrorMessage(`Failed to generate report: ${y.message}`)}});a.subscriptions.push(oe);let ie=b.commands.registerCommand("explorerDates.showApiInfo",async()=>{try{if(!r){b.window.showInformationMessage("Explorer Dates API is disabled via settings.");return}let y=b.window.createWebviewPanel("apiInfo","Explorer Dates API Information",b.ViewColumn.One,{enableScripts:!0});y.webview.html=_i(O()),D.info("API information panel opened")}catch(y){D.error("Failed to show API information",y),b.window.showErrorMessage(`Failed to show API information: ${y.message}`)}});a.subscriptions.push(ie);let H;b.workspace.getConfiguration("explorerDates").get("showStatusBar",!1)&&(H=Vt(a)),b.workspace.onDidChangeConfiguration(y=>{if(y.affectsConfiguration("explorerDates.showStatusBar")){let U=b.workspace.getConfiguration("explorerDates").get("showStatusBar",!1);U&&!H?H=Vt(a):!U&&H&&(H.dispose(),H=null)}}),D.info("Explorer Dates: Date decorations ready")}catch(e){let t=`${he?he.getString("activationError"):"Explorer Dates failed to activate"}: ${e.message}`;throw D&&D.error("Extension activation failed",e),b.window.showErrorMessage(t),e}}l(Fi,"activate");async function ki(){try{D&&D.info("Explorer Dates extension is being deactivated"),W&&typeof W.dispose=="function"&&await W.dispose(),D&&D.info("Explorer Dates extension deactivated successfully")}catch(a){D&&D.error("Explorer Dates: Error during deactivation",a)}}l(ki,"deactivate");Jt.exports={activate:Fi,deactivate:ki}});var Yt=Qt();module.exports={activate:Yt.activate,deactivate:Yt.deactivate};
