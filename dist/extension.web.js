var eo=Object.defineProperty;var l=(a,e)=>eo(a,"name",{value:e,configurable:!0});var S=(a,e)=>()=>(e||a((e={exports:{}}).exports,e),e.exports);var P=S((ki,tt)=>{var pe=require("vscode"),fe=class fe{constructor(){this._outputChannel=pe.window.createOutputChannel("Explorer Dates"),this._isEnabled=!1,this._updateConfig(),pe.workspace.onDidChangeConfiguration(e=>{e.affectsConfiguration("explorerDates.enableLogging")&&this._updateConfig()})}_updateConfig(){let e=pe.workspace.getConfiguration("explorerDates");this._isEnabled=e.get("enableLogging",!1)}debug(e,...t){if(this._isEnabled){let i=`[${new Date().toISOString()}] [DEBUG] ${e}`;this._outputChannel.appendLine(i),t.length>0&&this._outputChannel.appendLine(JSON.stringify(t,null,2))}}info(e,...t){let i=`[${new Date().toISOString()}] [INFO] ${e}`;this._outputChannel.appendLine(i),t.length>0&&this._outputChannel.appendLine(JSON.stringify(t,null,2))}warn(e,...t){let i=`[${new Date().toISOString()}] [WARN] ${e}`;this._outputChannel.appendLine(i),t.length>0&&this._outputChannel.appendLine(JSON.stringify(t,null,2))}error(e,t,...o){let r=`[${new Date().toISOString()}] [ERROR] ${e}`;this._outputChannel.appendLine(r),t instanceof Error&&(this._outputChannel.appendLine(`Error: ${t.message}`),t.stack&&this._outputChannel.appendLine(`Stack: ${t.stack}`)),o.length>0&&this._outputChannel.appendLine(JSON.stringify(o,null,2))}show(){this._outputChannel.show()}clear(){this._outputChannel.clear()}dispose(){this._outputChannel.dispose()}};l(fe,"Logger");var re=fe,me=null;function to(){return me||(me=new re),me}l(to,"getLogger");tt.exports={Logger:re,getLogger:to}});var Z=S((Mi,ot)=>{var we=require("vscode"),se={en:{now:"now",minutes:"m",hours:"h",days:"d",weeks:"w",months:"mo",years:"y",justNow:"just now",minutesAgo:l(a=>`${a} minute${a!==1?"s":""} ago`,"minutesAgo"),hoursAgo:l(a=>`${a} hour${a!==1?"s":""} ago`,"hoursAgo"),yesterday:"yesterday",daysAgo:l(a=>`${a} day${a!==1?"s":""} ago`,"daysAgo"),lastModified:"Last modified",refreshSuccess:"Date decorations refreshed",activationError:"Explorer Dates failed to activate",errorAccessingFile:"Error accessing file for decoration"},es:{now:"ahora",minutes:"m",hours:"h",days:"d",weeks:"s",months:"m",years:"a",justNow:"ahora mismo",minutesAgo:l(a=>`hace ${a} minuto${a!==1?"s":""}`,"minutesAgo"),hoursAgo:l(a=>`hace ${a} hora${a!==1?"s":""}`,"hoursAgo"),yesterday:"ayer",daysAgo:l(a=>`hace ${a} d\xEDa${a!==1?"s":""}`,"daysAgo"),lastModified:"\xDAltima modificaci\xF3n",refreshSuccess:"Decoraciones de fecha actualizadas",activationError:"Explorer Dates no se pudo activar",errorAccessingFile:"Error al acceder al archivo para decoraci\xF3n"},fr:{now:"maintenant",minutes:"m",hours:"h",days:"j",weeks:"s",months:"m",years:"a",justNow:"\xE0 l'instant",minutesAgo:l(a=>`il y a ${a} minute${a!==1?"s":""}`,"minutesAgo"),hoursAgo:l(a=>`il y a ${a} heure${a!==1?"s":""}`,"hoursAgo"),yesterday:"hier",daysAgo:l(a=>`il y a ${a} jour${a!==1?"s":""}`,"daysAgo"),lastModified:"Derni\xE8re modification",refreshSuccess:"D\xE9corations de date actualis\xE9es",activationError:"\xC9chec de l'activation d'Explorer Dates",errorAccessingFile:"Erreur lors de l'acc\xE8s au fichier pour la d\xE9coration"},de:{now:"jetzt",minutes:"Min",hours:"Std",days:"T",weeks:"W",months:"Mon",years:"J",justNow:"gerade eben",minutesAgo:l(a=>`vor ${a} Minute${a!==1?"n":""}`,"minutesAgo"),hoursAgo:l(a=>`vor ${a} Stunde${a!==1?"n":""}`,"hoursAgo"),yesterday:"gestern",daysAgo:l(a=>`vor ${a} Tag${a!==1?"en":""}`,"daysAgo"),lastModified:"Zuletzt ge\xE4ndert",refreshSuccess:"Datumsdekorationen aktualisiert",activationError:"Explorer Dates konnte nicht aktiviert werden",errorAccessingFile:"Fehler beim Zugriff auf Datei f\xFCr Dekoration"},ja:{now:"\u4ECA",minutes:"\u5206",hours:"\u6642\u9593",days:"\u65E5",weeks:"\u9031",months:"\u30F6\u6708",years:"\u5E74",justNow:"\u305F\u3063\u305F\u4ECA",minutesAgo:l(a=>`${a}\u5206\u524D`,"minutesAgo"),hoursAgo:l(a=>`${a}\u6642\u9593\u524D`,"hoursAgo"),yesterday:"\u6628\u65E5",daysAgo:l(a=>`${a}\u65E5\u524D`,"daysAgo"),lastModified:"\u6700\u7D42\u66F4\u65B0",refreshSuccess:"\u65E5\u4ED8\u88C5\u98FE\u304C\u66F4\u65B0\u3055\u308C\u307E\u3057\u305F",activationError:"Explorer Dates\u306E\u30A2\u30AF\u30C6\u30A3\u30D9\u30FC\u30B7\u30E7\u30F3\u306B\u5931\u6557\u3057\u307E\u3057\u305F",errorAccessingFile:"\u30D5\u30A1\u30A4\u30EB\u30A2\u30AF\u30BB\u30B9\u4E2D\u306B\u30A8\u30E9\u30FC\u304C\u767A\u751F\u3057\u307E\u3057\u305F"},zh:{now:"\u73B0\u5728",minutes:"\u5206\u949F",hours:"\u5C0F\u65F6",days:"\u5929",weeks:"\u5468",months:"\u6708",years:"\u5E74",justNow:"\u521A\u521A",minutesAgo:l(a=>`${a}\u5206\u949F\u524D`,"minutesAgo"),hoursAgo:l(a=>`${a}\u5C0F\u65F6\u524D`,"hoursAgo"),yesterday:"\u6628\u5929",daysAgo:l(a=>`${a}\u5929\u524D`,"daysAgo"),lastModified:"\u6700\u540E\u4FEE\u6539",refreshSuccess:"\u65E5\u671F\u88C5\u9970\u5DF2\u5237\u65B0",activationError:"Explorer Dates \u6FC0\u6D3B\u5931\u8D25",errorAccessingFile:"\u8BBF\u95EE\u6587\u4EF6\u88C5\u9970\u65F6\u51FA\u9519"}},be=class be{constructor(){this._currentLocale="en",this._updateLocale(),we.workspace.onDidChangeConfiguration(e=>{e.affectsConfiguration("explorerDates.locale")&&this._updateLocale()})}_updateLocale(){let t=we.workspace.getConfiguration("explorerDates").get("locale","auto");t==="auto"&&(t=we.env.language.split("-")[0]),se[t]||(t="en"),this._currentLocale=t}getString(e,...t){let i=(se[this._currentLocale]||se.en)[e];return typeof i=="function"?i(...t):i||se.en[e]||e}getCurrentLocale(){return this._currentLocale}formatDate(e,t={}){try{return e.toLocaleDateString(this._currentLocale,t)}catch{return e.toLocaleDateString("en",t)}}};l(be,"LocalizationManager");var ae=be,ve=null;function oo(){return ve||(ve=new ae),ve}l(oo,"getLocalization");ot.exports={LocalizationManager:ae,getLocalization:oo}});var ye=S((Ai,rt)=>{var it=require("vscode");function io(){try{return it?.env?.uiKind===it?.UIKind?.Web}catch{return!1}}l(io,"isWebEnvironment");rt.exports={isWebEnvironment:io}});var O=S((Ii,at)=>{function K(a=""){return a?a.replace(/\\/g,"/"):""}l(K,"normalizePath");function ro(a=""){let e=K(a);return e?e.split("/").filter(Boolean):[]}l(ro,"getSegments");function st(a=""){let e=ro(a);return e.length?e[e.length-1]:""}l(st,"getFileName");function so(a=""){let e=st(a),t=e.lastIndexOf(".");return t<=0?"":e.substring(t).toLowerCase()}l(so,"getExtension");function ao(a=""){let e=K(a),t=e.lastIndexOf("/");return t===-1?"":e.substring(0,t)}l(ao,"getDirectory");function no(...a){return K(a.filter(Boolean).join("/")).replace(/\/+/g,"/")}l(no,"joinPath");function co(a=""){return K(a).toLowerCase()}l(co,"getCacheKey");function lo(a="",e=""){let t=K(a),o=K(e);return t&&o.startsWith(t)?o.substring(t.length).replace(/^\/+/,""):o}l(lo,"getRelativePath");at.exports={normalizePath:K,getFileName:st,getExtension:so,getDirectory:ao,joinPath:no,getCacheKey:co,getRelativePath:lo}});var j=S((Ri,ct)=>{var z=require("vscode"),{isWebEnvironment:ho}=ye(),{normalizePath:uo}=O(),nt=!0,T=null;if(!nt)try{T=require("fs").promises}catch{T=null}var Ce=class Ce{constructor(){this.isWeb=nt||ho()}_toPath(e){return e?typeof e=="string"?e:e instanceof z.Uri?e.fsPath||e.path:String(e):""}_toUri(e){if(e instanceof z.Uri)return e;if(typeof e=="string")return z.Uri.file(e);throw new Error(`Unsupported target type: ${typeof e}`)}async stat(e){if(!this.isWeb&&T)return T.stat(this._toPath(e));let t=this._toUri(e),o=await z.workspace.fs.stat(t);return{...o,mtime:new Date(o.mtime),ctime:new Date(o.ctime),birthtime:new Date(o.ctime),isFile:l(()=>o.type===z.FileType.File,"isFile"),isDirectory:l(()=>o.type===z.FileType.Directory,"isDirectory")}}async readFile(e,t="utf8"){if(!this.isWeb&&T)return T.readFile(this._toPath(e),t);let o=this._toUri(e),i=await z.workspace.fs.readFile(o);return t===null||t==="binary"?i:new TextDecoder(t).decode(i)}async writeFile(e,t,o="utf8"){if(!this.isWeb&&T)return T.writeFile(this._toPath(e),t,o);let i=this._toUri(e),r=typeof t=="string"?new TextEncoder().encode(t):t;await z.workspace.fs.writeFile(i,r)}async mkdir(e,t={recursive:!0}){if(!this.isWeb&&T)return T.mkdir(this._toPath(e),t);let o=this._toUri(e);await z.workspace.fs.createDirectory(o)}async readdir(e,t={withFileTypes:!1}){if(!this.isWeb&&T)return T.readdir(this._toPath(e),t);let o=this._toUri(e),i=await z.workspace.fs.readDirectory(o);return t.withFileTypes?i.map(([r,s])=>({name:r,isDirectory:l(()=>s===z.FileType.Directory,"isDirectory"),isFile:l(()=>s===z.FileType.File,"isFile")})):i.map(([r])=>r)}async delete(e,t={recursive:!1}){if(!this.isWeb&&T){let i=this._toPath(e);return t.recursive?T.rm?T.rm(i,t):T.rmdir(i,t):T.unlink(i)}let o=this._toUri(e);await z.workspace.fs.delete(o,t)}async exists(e){try{return await this.stat(e),!0}catch{return!1}}async ensureDirectory(e){let t=uo(this._toPath(e));await this.mkdir(t,{recursive:!0})}};l(Ce,"FileSystemAdapter");var ne=Ce,go=new ne;ct.exports={FileSystemAdapter:ne,fileSystem:go}});var dt=S((Ni,lt)=>{var N=require("vscode"),{getLogger:po}=P(),{fileSystem:mo}=j(),{normalizePath:_e,getRelativePath:fo,getFileName:wo}=O(),De=class De{constructor(){this._logger=po(),this._fs=mo,this._commonExclusions=["node_modules",".npm",".yarn","coverage","nyc_output","dist","build","out","target","bin","obj",".vscode",".idea",".vs",".vscode-test",".git",".svn",".hg",".bzr",".pnpm-store","bower_components","jspm_packages","tmp","temp",".tmp",".cache",".parcel-cache",".DS_Store","Thumbs.db","__pycache__",".pytest_cache",".tox","venv",".env",".virtualenv","vendor",".docker","logs","*.log"],this._patternScores=new Map,this._workspaceAnalysis=new Map,this._logger.info("SmartExclusionManager initialized")}async analyzeWorkspace(e){try{let t=_e(e?.fsPath||e?.path||""),o={detectedPatterns:[],suggestedExclusions:[],projectType:"unknown",riskFolders:[]};o.projectType=await this._detectProjectType(e);let i=await this._scanForExclusionCandidates(e,t),r=this._scorePatterns(i,o.projectType);return o.detectedPatterns=i,o.suggestedExclusions=r.filter(s=>s.score>.7).map(s=>s.pattern),o.riskFolders=r.filter(s=>s.riskLevel==="high").map(s=>s.pattern),this._workspaceAnalysis.set(t,o),this._logger.info(`Workspace analysis complete for ${t}`,o),o}catch(t){return this._logger.error("Failed to analyze workspace",t),null}}async _detectProjectType(e){let t=[{file:"package.json",type:"javascript"},{file:"pom.xml",type:"java"},{file:"Cargo.toml",type:"rust"},{file:"setup.py",type:"python"},{file:"requirements.txt",type:"python"},{file:"Gemfile",type:"ruby"},{file:"composer.json",type:"php"},{file:"go.mod",type:"go"},{file:"CMakeLists.txt",type:"cpp"},{file:"Dockerfile",type:"docker"}];if(!e)return"unknown";for(let o of t)try{let i=N.Uri.joinPath(e,o.file);if(await this._fs.exists(i))return o.type}catch{}return"unknown"}async _scanForExclusionCandidates(e,t,o=2){let i=[],r=l(async(s,n=0)=>{if(!(n>o))try{let d=await this._fs.readdir(s,{withFileTypes:!0});for(let c of d)if(c.isDirectory()){let u=N.Uri.joinPath(s,c.name),h=_e(u.fsPath||u.path),f=fo(t,h);this._commonExclusions.includes(c.name)&&i.push({name:c.name,path:f,type:"common",size:await this._getDirectorySize(u)});let w=await this._getDirectorySize(u);w>10485760&&i.push({name:c.name,path:f,type:"large",size:w}),await r(u,n+1)}}catch{}},"scanDirectory");return await r(e),i}async _getDirectorySize(e){try{let t=await this._fs.readdir(e,{withFileTypes:!0}),o=0,i=0;for(let r of t){if(i>100)break;if(r.isFile())try{let s=N.Uri.joinPath(e,r.name),n=await this._fs.stat(s);o+=n.size,i++}catch{}}return o}catch{return 0}}_scorePatterns(e,t){return e.map(o=>{let i=0,r="low";switch(o.type==="common"&&(i+=.8),o.size>100*1024*1024?(i+=.9,r="high"):o.size>10*1024*1024&&(i+=.5,r="medium"),t){case"javascript":["node_modules",".npm","coverage","dist","build"].includes(o.name)&&(i+=.9);break;case"python":["__pycache__",".pytest_cache","venv",".env"].includes(o.name)&&(i+=.9);break;case"java":["target","build",".gradle"].includes(o.name)&&(i+=.9);break}return["src","lib","app","components","pages"].includes(o.name.toLowerCase())&&(i=0,r="none"),{pattern:o.name,path:o.path,score:Math.min(i,1),riskLevel:r,size:o.size,type:o.type}})}getWorkspaceExclusions(e){let o=N.workspace.getConfiguration("explorerDates").get("workspaceExclusionProfiles",{}),i=this._getWorkspaceKey(e);return o[i]||[]}async saveWorkspaceExclusions(e,t){let o=N.workspace.getConfiguration("explorerDates"),i=o.get("workspaceExclusionProfiles",{}),r=this._getWorkspaceKey(e);i[r]=t,await o.update("workspaceExclusionProfiles",i,N.ConfigurationTarget.Global),this._logger.info(`Saved workspace exclusions for ${r}`,t)}async getCombinedExclusions(e){let t=N.workspace.getConfiguration("explorerDates"),o=t.get("excludedFolders",[]),i=t.get("excludedPatterns",[]),r=t.get("smartExclusions",!0),s=[...o],n=[...i],d=this.getWorkspaceExclusions(e);if(s.push(...d),r){let c=await this.analyzeWorkspace(e);c&&s.push(...c.suggestedExclusions)}return s=[...new Set(s)],n=[...new Set(n)],{folders:s,patterns:n}}_getWorkspaceKey(e){if(!e)return"unknown-workspace";let t=e.fsPath||e.path||"";return wo(t)||_e(t)}async suggestExclusions(e){let t=await this.analyzeWorkspace(e);if(!t||t.suggestedExclusions.length===0)return;let o=`Found ${t.suggestedExclusions.length} folders that could be excluded for better performance.`,i=await N.window.showInformationMessage(o,"Apply Suggestions","Review","Dismiss");i==="Apply Suggestions"?(await this.saveWorkspaceExclusions(e,t.suggestedExclusions),N.window.showInformationMessage("Smart exclusions applied!")):i==="Review"&&this._showExclusionReview(t)}_showExclusionReview(e){let t=N.window.createWebviewPanel("exclusionReview","Smart Exclusion Review",N.ViewColumn.One,{enableScripts:!0});t.webview.html=this._generateReviewHTML(e)}_generateReviewHTML(e){let t=l(i=>{if(i<1024)return`${i} B`;let r=i/1024;return r<1024?`${r.toFixed(1)} KB`:`${(r/1024).toFixed(1)} MB`},"formatSize"),o=e.detectedPatterns.map(i=>`
            <tr>
                <td>${i.name}</td>
                <td>${i.path}</td>
                <td>${t(i.size)}</td>
...
${t.description}`;await C.window.showInformationMessage(o,"Show More Tips","Got it!")==="Show More Tips"&&await this.showFeatureTour()}async showWhatsNew(e){try{let t=C.window.createWebviewPanel("explorerDatesWhatsNew",`Explorer Dates v${e} - What's New`,C.ViewColumn.One,{enableScripts:!0,retainContextWhenHidden:!1});t.webview.html=this._generateWhatsNewHTML(e),t.webview.onDidReceiveMessage(async o=>{switch(o.command){case"openSettings":await C.commands.executeCommand("workbench.action.openSettings","explorerDates"),t.dispose();break;case"tryFeature":o.feature==="badgePriority"&&(await C.workspace.getConfiguration("explorerDates").update("badgePriority","author",C.ConfigurationTarget.Global),C.window.showInformationMessage("Badge priority set to author! You should see author initials on files now."));break;case"dismiss":t.dispose();break}})}catch(t){this._logger.error("Failed to show what's new",t)}}_generateWhatsNewHTML(e){return`
        ...
        `}};l(We,"OnboardingManager");var Ne=We;Wt.exports={OnboardingManager:Ne}});var Ut=S((dr,Bt)=>{var _=require("vscode"),{getLogger:ri}=P(),{fileSystem:si}=j(),{GLOBAL_STATE_KEYS:ai}=X(),M=ri(),Be=class Be{constructor(e){this._context=e,this._storage=e?.globalState||null,this._storageKey=ai.TEMPLATE_STORE,this._fs=si,this.templatesPath=null,this.builtInTemplates=this.getBuiltInTemplates(),M.info("Workspace Templates Manager initialized")}_getStoredTemplates(){return this._storage?this._storage.get(this._storageKey,{}):{}}async _saveStoredTemplates(e){if(!this._storage)throw new Error("Template storage unavailable");await this._storage.update(this._storageKey,e)}_getTemplate(e){return this.builtInTemplates[e]?this.builtInTemplates[e]:this._getStoredTemplates()[e]}getBuiltInTemplates(){return{"web-development":{name:"Web Development",description:"Optimized for web projects with focus on source files",settings:{"explorerDates.showDateDecorations":!0,"explorerDates.dateDecorationFormat":"relative-short","explorerDates.colorScheme":"file-type","explorerDates.showFileSize":!0,"explorerDates.fadeOldFiles":!0,"explorerDates.fadeThreshold":14,"explorerDates.excludePatterns":["**/node_modules/**","**/dist/**","**/build/**","**/.next/**","**/coverage/**"],"explorerDates.enableContextMenu":!0,"explorerDates.showGitInfo":"author"}},"data-science":{name:"Data Science",description:"Focused on notebooks and data files with detailed timestamps",settings:{"explorerDates.showDateDecorations":!0,"explorerDates.dateDecorationFormat":"absolute-long","explorerDates.colorScheme":"none","explorerDates.showFileSize":!0,"explorerDates.showGitInfo":"none","explorerDates.highContrastMode":!1,"explorerDates.excludePatterns":["**/__pycache__/**","**/.ipynb_checkpoints/**","**/data/raw/**"],"explorerDates.badgePriority":"size"}},documentation:{name:"Documentation",description:"Clean display for documentation projects",settings:{"explorerDates.showDateDecorations":!0,"explorerDates.dateDecorationFormat":"smart","explorerDates.colorScheme":"subtle","explorerDates.showFileSize":!1,"explorerDates.excludePatterns":["**/node_modules/**","**/.git/**"],"explorerDates.fadeOldFiles":!1,"explorerDates.enableContextMenu":!1}},enterprise:{name:"Enterprise",description:"Full feature set with Git integration and analytics",settings:{"explorerDates.showDateDecorations":!0,"explorerDates.dateDecorationFormat":"smart","explorerDates.colorScheme":"recency","explorerDates.showFileSize":!0,"explorerDates.showGitInfo":"author","explorerDates.enableContextMenu":!0,"explorerDates.showStatusBar":!0,"explorerDates.smartExclusions":!0,"explorerDates.progressiveLoading":!0,"explorerDates.persistentCache":!0,"explorerDates.enableReporting":!0}},minimal:{name:"Minimal",description:"Clean, distraction-free setup",settings:{"explorerDates.showDateDecorations":!0,"explorerDates.dateDecorationFormat":"relative-short","explorerDates.colorScheme":"none","explorerDates.showFileSize":!1,"explorerDates.badgePriority":"time","explorerDates.enableContextMenu":!1,"explorerDates.progressiveLoading":!1}}}}async saveCurrentConfiguration(e,t=""){try{let o=_.workspace.getConfiguration("explorerDates"),i={},r=o.inspect();if(r)for(let[u,h]of Object.entries(r))h&&typeof h=="object"&&"workspaceValue"in h?i[`explorerDates.${u}`]=h.workspaceValue:h&&typeof h=="object"&&"globalValue"in h&&(i[`explorerDates.${u}`]=h.globalValue);let s={name:e,description:t,createdAt:new Date().toISOString(),version:"1.0.0",settings:i},n=e.toLowerCase().replace(/[^a-z0-9-]/g,"-"),d=this._getStoredTemplates();d[n]=s,await this._saveStoredTemplates(d);let c=o.get("templateSyncPath","");if(c&&!this._fs.isWeb)try{let u=`${c.replace(/[/\\]?$/,"")}/${n}.json`;await this._fs.writeFile(u,JSON.stringify(s,null,2)),M.info(`Synced template to ${u}`)}catch(u){M.warn("Failed to sync template to disk path",u)}return _.window.showInformationMessage(`Template "${e}" saved successfully!`),M.info(`Saved workspace template: ${e}`),!0}catch(o){return M.error("Failed to save template:",o),_.window.showErrorMessage(`Failed to save template: ${o.message}`),!1}}async loadTemplate(e){try{let t=this._getTemplate(e);if(!t)throw new Error(`Template "${e}" not found`);let o=_.workspace.getConfiguration();for(let[i,r]of Object.entries(t.settings))await o.update(i,r,_.ConfigurationTarget.Workspace);return _.window.showInformationMessage(`Template "${t.name}" applied successfully!`),M.info(`Applied workspace template: ${t.name}`),!0}catch(t){return M.error("Failed to load template:",t),_.window.showErrorMessage(`Failed to load template: ${t.message}`),!1}}async getAvailableTemplates(){let e=[];for(let[t,o]of Object.entries(this.builtInTemplates))e.push({id:t,name:o.name,description:o.description,type:"built-in",createdAt:null});try{let t=this._getStoredTemplates();for(let[o,i]of Object.entries(t))e.push({id:o,name:i.name,description:i.description,type:"custom",createdAt:i.createdAt})}catch(t){M.error("Failed to load custom templates:",t)}return e}async deleteTemplate(e){try{if(this.builtInTemplates[e])return _.window.showErrorMessage("Cannot delete built-in templates"),!1;let t=this._getStoredTemplates();if(!t[e])throw new Error(`Template "${e}" not found`);return delete t[e],await this._saveStoredTemplates(t),_.window.showInformationMessage(`Template "${e}" deleted successfully!`),M.info(`Deleted workspace template: ${e}`),!0}catch(t){return M.error("Failed to delete template:",t),_.window.showErrorMessage(`Failed to delete template: ${t.message}`),!1}}async exportTemplate(e,t){try{let o=this._getTemplate(e);if(!o)throw new Error(`Template "${e}" not found`);let i=JSON.stringify(o,null,2);if(this._fs.isWeb){let s=encodeURIComponent(i);return await _.env.openExternal(_.Uri.parse(`data:application/json;charset=utf-8,${s}`)),_.window.showInformationMessage("Template download triggered in browser"),!0}let r=t instanceof _.Uri?t.fsPath:t;return await this._fs.writeFile(r,i),_.window.showInformationMessage(`Template exported to ${r}`),M.info(`Exported template ${e} to ${r}`),!0}catch(o){return M.error("Failed to export template:",o),_.window.showErrorMessage(`Failed to export template: ${o.message}`),!1}}async importTemplate(e){try{let t=e instanceof _.Uri?e:_.Uri.file(e),o=await this._fs.readFile(t,"utf8"),i=JSON.parse(o);if(!i.name||!i.settings)throw new Error("Invalid template format");let r=i.name.toLowerCase().replace(/[^a-z0-9-]/g,"-"),s=this._getStoredTemplates();return s[r]=i,await this._saveStoredTemplates(s),_.window.showInformationMessage(`Template "${i.name}" imported successfully!`),M.info(`Imported template: ${i.name}`),!0}catch(t){return M.error("Failed to import template:",t),_.window.showErrorMessage(`Failed to import template: ${t.message}`),!1}}async showTemplateManager(){try{let e=await this.getAvailableTemplates(),t=_.window.createWebviewPanel("templateManager","Explorer Dates - Template Manager",_.ViewColumn.One,{enableScripts:!0,retainContextWhenHidden:!0});t.webview.html=this.getTemplateManagerHtml(e),t.webview.onDidReceiveMessage(async o=>{switch(o.command){case"loadTemplate":await this.loadTemplate(o.templateId);break;case"deleteTemplate":{await this.deleteTemplate(o.templateId);let i=await this.getAvailableTemplates();t.webview.postMessage({command:"refreshTemplates",templates:i});break}case"exportTemplate":{let i=await _.window.showSaveDialog({defaultUri:_.Uri.file(`${o.templateId}.json`),filters:{JSON:["json"]}});i&&await this.exportTemplate(o.templateId,i);break}case"saveConfig":{await this.saveCurrentConfiguration(o.name,o.description);let i=await this.getAvailableTemplates();t.webview.postMessage({command:"refreshTemplates",templates:i});break}case"importTemplate":{let i=await _.window.showOpenDialog({canSelectMany:!1,filters:{JSON:["json"]}});if(i&&i[0]){await this.importTemplate(i[0]);let r=await this.getAvailableTemplates();t.webview.postMessage({command:"refreshTemplates",templates:r})}break}}}),M.info("Template Manager opened")}catch(e){M.error("Failed to show template manager:",e),_.window.showErrorMessage("Failed to open Template Manager")}}getTemplateManagerHtml(e){return`<!DOCTYPE html>
        <html>
        <head>
            <meta charset="UTF-8">
            <meta name="viewport" content="width=device-width, initial-scale=1.0">
...
explorerDatesApi.registerPlugin('myPlugin', myPlugin);
    ...
    </html>`}l(bi,"getApiInformationHtml");function yi(a){let e=l(o=>{if(o<1024)return`${o} B`;let i=o/1024;return i<1024?`${i.toFixed(1)} KB`:`${(i/1024).toFixed(1)} MB`},"formatFileSize"),t=a.map(o=>`
        <tr>
            <td>${o.path}</td>
    ...
    `}l(yi,"generateWorkspaceActivityHTML");function Ci(a){return`
        <!DOCTYPE html>
        <html>
        <head>
            <meta charset="UTF-8">
    ...
    `}l(Ci,"generateDiagnosticsHTML");function _i(a){return`<!DOCTYPE html>
    <html>
    <head>
        <meta charset="UTF-8">
    ...
    </html>`}l(_i,"generateDiagnosticsWebview");function xi(a){let e=l(t=>{if(t===0)return"0 B";let o=1024,i=["B","KB","MB","GB"],r=Math.floor(Math.log(t)/Math.log(o));return parseFloat((t/Math.pow(o,r)).toFixed(2))+" "+i[r]},"formatBytes");return`
        <!DOCTYPE html>
        <html>
        <head>
            <meta charset="UTF-8">
    ...
    `}l(xi,"generatePerformanceAnalyticsHTML");function Kt(a){let e=b.window.createStatusBarItem(b.StatusBarAlignment.Right,100);e.command="explorerDates.showFileDetails",e.tooltip="Click to show detailed file information";let t=l(async()=>{try{let o=b.window.activeTextEditor;if(!o){e.hide();return}let i=o.document.uri;if(i.scheme!=="file"){e.hide();return}let r=await mi.stat(i),s=r.mtime instanceof Date?r.mtime:new Date(r.mtime),n=W._formatDateBadge(s,"smart"),d=W._formatFileSize(r.size,"auto");e.text=`$(clock) ${n} $(file) ${d}`,e.show()}catch(o){e.hide(),D.debug("Failed to update status bar",o)}},"updateStatusBar");return b.window.onDidChangeActiveTextEditor(t),b.window.onDidChangeTextEditorSelection(t),t(),a.subscriptions.push(e),e}l(Kt,"initializeStatusBar");async function Di(a){try{D=gi(),le=pi(),D.info("Explorer Dates: Extension activated");let e=b.env.uiKind===b.UIKind.Web;await b.commands.executeCommand("setContext","explorerDates.gitFeaturesAvailable",!e);let t=b.workspace.getConfiguration("explorerDates"),o=t.get("enableWorkspaceTemplates",!0),i=t.get("enableReporting",!0),r=t.get("enableExtensionApi",!0);W=new ui;let s=b.window.registerFileDecorationProvider(W);a.subscriptions.push(s),a.subscriptions.push(W),a.subscriptions.push(D),await W.initializeAdvancedSystems(a);let n=null,d=null,c=null,u=null,h=l(()=>{if(!n){let{OnboardingManager:y}=Ot();n=new y(a)}return n},"getOnboardingManager"),f=l(()=>{if(!o)throw new Error("Workspace templates are disabled via explorerDates.enableWorkspaceTemplates");if(!d){let{WorkspaceTemplatesManager:y}=Ut();d=new y(a)}return d},"getWorkspaceTemplatesManager"),w=l(()=>{if(!c){let{ExtensionApiManager:y}=qt();c=new y}return c},"getExtensionApiManager"),v=l(()=>{if(!i)throw new Error("Reporting is disabled via explorerDates.enableReporting");if(!u){let{ExportReportingManager:y}=Gt();u=new y}return u},"getExportReportingManager"),B=l(()=>w().getApi(),"apiFactory");r?a.exports=B:(a.exports=void 0,D.info("Explorer Dates API exports disabled via explorerDates.enableExtensionApi")),b.workspace.getConfiguration("explorerDates").get("showWelcomeOnStartup",!0)&&await h().shouldShowOnboarding()&&setTimeout(()=>{h().showWelcomeMessage()},5e3),fi({context:a,fileDateProvider:W,logger:D,l10n:le}),wi({context:a,fileDateProvider:W,logger:D,generators:{generateWorkspaceActivityHTML:yi,generatePerformanceAnalyticsHTML:xi,generateDiagnosticsHTML:Ci,generateDiagnosticsWebview:_i}}),vi({context:a,logger:D,getOnboardingManager:h});let te=b.commands.registerCommand("explorerDates.openTemplateManager",async()=>{try{if(!o){b.window.showInformationMessage("Workspace templates are disabled. Enable explorerDates.enableWorkspaceTemplates to use this command.");return}await f().showTemplateManager(),D.info("Template manager opened")}catch(y){D.error("Failed to open template manager",y),b.window.showErrorMessage(`Failed to open template manager: ${y.message}`)}});a.subscriptions.push(te);let de=b.commands.registerCommand("explorerDates.saveTemplate",async()=>{try{if(!o){b.window.showInformationMessage("Workspace templates are disabled. Enable explorerDates.enableWorkspaceTemplates to save templates.");return}let y=await b.window.showInputBox({prompt:"Enter template name",placeHolder:"e.g., My Project Setup"});if(y){let U=await b.window.showInputBox({prompt:"Enter description (optional)",placeHolder:"Brief description of this template"})||"";await f().saveCurrentConfiguration(y,U)}D.info("Template saved")}catch(y){D.error("Failed to save template",y),b.window.showErrorMessage(`Failed to save template: ${y.message}`)}});a.subscriptions.push(de);let oe=b.commands.registerCommand("explorerDates.generateReport",async()=>{try{if(!i){b.window.showInformationMessage("Reporting features are disabled. Enable explorerDates.enableReporting to generate reports.");return}await v().showReportDialog(),D.info("Report generation started")}catch(y){D.error("Failed to generate report",y),b.window.showErrorMessage(`Failed to generate report: ${y.message}`)}});a.subscriptions.push(oe);let Y=b.commands.registerCommand("explorerDates.showApiInfo",async()=>{try{if(!r){b.window.showInformationMessage("Explorer Dates API is disabled via settings.");return}let y=b.window.createWebviewPanel("apiInfo","Explorer Dates API Information",b.ViewColumn.One,{enableScripts:!0});y.webview.html=bi(B()),D.info("API information panel opened")}catch(y){D.error("Failed to show API information",y),b.window.showErrorMessage(`Failed to show API information: ${y.message}`)}});a.subscriptions.push(Y);let q;b.workspace.getConfiguration("explorerDates").get("showStatusBar",!1)&&(q=Kt(a)),b.workspace.onDidChangeConfiguration(y=>{if(y.affectsConfiguration("explorerDates.showStatusBar")){let U=b.workspace.getConfiguration("explorerDates").get("showStatusBar",!1);U&&!q?q=Kt(a):!U&&q&&(q.dispose(),q=null)}}),D.info("Explorer Dates: Date decorations ready")}catch(e){let t=`${le?le.getString("activationError"):"Explorer Dates failed to activate"}: ${e.message}`;throw D&&D.error("Extension activation failed",e),b.window.showErrorMessage(t),e}}l(Di,"activate");async function Si(){try{D&&D.info("Explorer Dates extension is being deactivated"),W&&typeof W.dispose=="function"&&await W.dispose(),D&&D.info("Explorer Dates extension deactivated successfully")}catch(a){D&&D.error("Explorer Dates: Error during deactivation",a)}}l(Si,"deactivate");Vt.exports={activate:Di,deactivate:Si}});var Qt=Jt();module.exports={activate:Qt.activate,deactivate:Qt.deactivate};
