var ao=Object.defineProperty;var d=(a,e)=>ao(a,"name",{value:e,configurable:!0});var S=(a,e)=>()=>(e||a((e={exports:{}}).exports,e),e.exports);var P=S((Ii,ht)=>{var Fe=require("vscode"),Te=class Te{constructor(){this._outputChannel=Fe.window.createOutputChannel("Explorer Dates"),this._isEnabled=!1,this._configurationWatcher=null,this._updateConfig(),this._configurationWatcher=Fe.workspace.onDidChangeConfiguration(e=>{e.affectsConfiguration("explorerDates.enableLogging")&&this._updateConfig()})}_updateConfig(){let e=Fe.workspace.getConfiguration("explorerDates");this._isEnabled=e.get("enableLogging",!1)}debug(e,...t){if(this._isEnabled){let i=`[${new Date().toISOString()}] [DEBUG] ${e}`;this._outputChannel.appendLine(i),t.length>0&&this._outputChannel.appendLine(JSON.stringify(t,null,2))}}info(e,...t){let i=`[${new Date().toISOString()}] [INFO] ${e}`;this._outputChannel.appendLine(i),t.length>0&&this._outputChannel.appendLine(JSON.stringify(t,null,2))}warn(e,...t){let i=`[${new Date().toISOString()}] [WARN] ${e}`;this._outputChannel.appendLine(i),t.length>0&&this._outputChannel.appendLine(JSON.stringify(t,null,2))}error(e,t,...o){let s=`[${new Date().toISOString()}] [ERROR] ${e}`;this._outputChannel.appendLine(s),t instanceof Error&&(this._outputChannel.appendLine(`Error: ${t.message}`),t.stack&&this._outputChannel.appendLine(`Stack: ${t.stack}`)),o.length>0&&this._outputChannel.appendLine(JSON.stringify(o,null,2))}show(){this._outputChannel.show()}clear(){this._outputChannel.clear()}dispose(){this._outputChannel.dispose(),this._configurationWatcher&&(this._configurationWatcher.dispose(),this._configurationWatcher=null),ie===this&&(ie=null)}};d(Te,"Logger");var pe=Te,ie=null;function no(){return ie||(ie=new pe),ie}d(no,"getLogger");ht.exports={Logger:pe,getLogger:no}});var re=S((Wi,ut)=>{var ke=require("vscode"),fe={en:{now:"now",minutes:"m",hours:"h",days:"d",weeks:"w",months:"mo",years:"y",justNow:"just now",minutesAgo:d(a=>`${a} minute${a!==1?"s":""} ago`,"minutesAgo"),hoursAgo:d(a=>`${a} hour${a!==1?"s":""} ago`,"hoursAgo"),yesterday:"yesterday",daysAgo:d(a=>`${a} day${a!==1?"s":""} ago`,"daysAgo"),lastModified:"Last modified",refreshSuccess:"Date decorations refreshed",activationError:"Explorer Dates failed to activate",errorAccessingFile:"Error accessing file for decoration"},es:{now:"ahora",minutes:"m",hours:"h",days:"d",weeks:"s",months:"m",years:"a",justNow:"ahora mismo",minutesAgo:d(a=>`hace ${a} minuto${a!==1?"s":""}`,"minutesAgo"),hoursAgo:d(a=>`hace ${a} hora${a!==1?"s":""}`,"hoursAgo"),yesterday:"ayer",daysAgo:d(a=>`hace ${a} d\xEDa${a!==1?"s":""}`,"daysAgo"),lastModified:"\xDAltima modificaci\xF3n",refreshSuccess:"Decoraciones de fecha actualizadas",activationError:"Explorer Dates no se pudo activar",errorAccessingFile:"Error al acceder al archivo para decoraci\xF3n"},fr:{now:"maintenant",minutes:"m",hours:"h",days:"j",weeks:"s",months:"m",years:"a",justNow:"\xE0 l'instant",minutesAgo:d(a=>`il y a ${a} minute${a!==1?"s":""}`,"minutesAgo"),hoursAgo:d(a=>`il y a ${a} heure${a!==1?"s":""}`,"hoursAgo"),yesterday:"hier",daysAgo:d(a=>`il y a ${a} jour${a!==1?"s":""}`,"daysAgo"),lastModified:"Derni\xE8re modification",refreshSuccess:"D\xE9corations de date actualis\xE9es",activationError:"\xC9chec de l'activation d'Explorer Dates",errorAccessingFile:"Erreur lors de l'acc\xE8s au fichier pour la d\xE9coration"},de:{now:"jetzt",minutes:"Min",hours:"Std",days:"T",weeks:"W",months:"Mon",years:"J",justNow:"gerade eben",minutesAgo:d(a=>`vor ${a} Minute${a!==1?"n":""}`,"minutesAgo"),hoursAgo:d(a=>`vor ${a} Stunde${a!==1?"n":""}`,"hoursAgo"),yesterday:"gestern",daysAgo:d(a=>`vor ${a} Tag${a!==1?"en":""}`,"daysAgo"),lastModified:"Zuletzt ge\xE4ndert",refreshSuccess:"Datumsdekorationen aktualisiert",activationError:"Explorer Dates konnte nicht aktiviert werden",errorAccessingFile:"Fehler beim Zugriff auf Datei f\xFCr Dekoration"},ja:{now:"\u4ECA",minutes:"\u5206",hours:"\u6642\u9593",days:"\u65E5",weeks:"\u9031",months:"\u30F6\u6708",years:"\u5E74",justNow:"\u305F\u3063\u305F\u4ECA",minutesAgo:d(a=>`${a}\u5206\u524D`,"minutesAgo"),hoursAgo:d(a=>`${a}\u6642\u9593\u524D`,"hoursAgo"),yesterday:"\u6628\u65E5",daysAgo:d(a=>`${a}\u65E5\u524D`,"daysAgo"),lastModified:"\u6700\u7D42\u66F4\u65B0",refreshSuccess:"\u65E5\u4ED8\u88C5\u98FE\u304C\u66F4\u65B0\u3055\u308C\u307E\u3057\u305F",activationError:"Explorer Dates\u306E\u30A2\u30AF\u30C6\u30A3\u30D9\u30FC\u30B7\u30E7\u30F3\u306B\u5931\u6557\u3057\u307E\u3057\u305F",errorAccessingFile:"\u30D5\u30A1\u30A4\u30EB\u30A2\u30AF\u30BB\u30B9\u4E2D\u306B\u30A8\u30E9\u30FC\u304C\u767A\u751F\u3057\u307E\u3057\u305F"},zh:{now:"\u73B0\u5728",minutes:"\u5206\u949F",hours:"\u5C0F\u65F6",days:"\u5929",weeks:"\u5468",months:"\u6708",years:"\u5E74",justNow:"\u521A\u521A",minutesAgo:d(a=>`${a}\u5206\u949F\u524D`,"minutesAgo"),hoursAgo:d(a=>`${a}\u5C0F\u65F6\u524D`,"hoursAgo"),yesterday:"\u6628\u5929",daysAgo:d(a=>`${a}\u5929\u524D`,"daysAgo"),lastModified:"\u6700\u540E\u4FEE\u6539",refreshSuccess:"\u65E5\u671F\u88C5\u9970\u5DF2\u5237\u65B0",activationError:"Explorer Dates \u6FC0\u6D3B\u5931\u8D25",errorAccessingFile:"\u8BBF\u95EE\u6587\u4EF6\u88C5\u9970\u65F6\u51FA\u9519"}},$e=class $e{constructor(){this._currentLocale="en",this._configurationWatcher=null,this._updateLocale(),this._configurationWatcher=ke.workspace.onDidChangeConfiguration(e=>{e.affectsConfiguration("explorerDates.locale")&&this._updateLocale()})}_updateLocale(){let t=ke.workspace.getConfiguration("explorerDates").get("locale","auto");t==="auto"&&(t=ke.env.language.split("-")[0]),fe[t]||(t="en"),this._currentLocale=t}getString(e,...t){let i=(fe[this._currentLocale]||fe.en)[e];return typeof i=="function"?i(...t):i||fe.en[e]||e}getCurrentLocale(){return this._currentLocale}formatDate(e,t={}){try{return e.toLocaleDateString(this._currentLocale,t)}catch{return e.toLocaleDateString("en",t)}}dispose(){this._configurationWatcher&&(this._configurationWatcher.dispose(),this._configurationWatcher=null),se===this&&(se=null)}};d($e,"LocalizationManager");var me=$e,se=null;function co(){return se||(se=new me),se}d(co,"getLocalization");ut.exports={LocalizationManager:me,getLocalization:co}});var Me=S((Li,gt)=>{var ee=require("vscode");function lo(){var a,e;try{return((a=ee==null?void 0:ee.env)==null?void 0:a.uiKind)===((e=ee==null?void 0:ee.UIKind)==null?void 0:e.Web)}catch{return!1}}d(lo,"isWebEnvironment");gt.exports={isWebEnvironment:lo}});var B=S((Bi,ft)=>{function V(a=""){return a?a.replace(/\\/g,"/"):""}d(V,"normalizePath");function ho(a=""){let e=V(a);return e?e.split("/").filter(Boolean):[]}d(ho,"getSegments");function pt(a=""){let e=ho(a);return e.length?e[e.length-1]:""}d(pt,"getFileName");function uo(a=""){let e=pt(a),t=e.lastIndexOf(".");return t<=0?"":e.substring(t).toLowerCase()}d(uo,"getExtension");function go(a=""){let e=V(a),t=e.lastIndexOf("/");return t===-1?"":e.substring(0,t)}d(go,"getDirectory");function po(...a){return V(a.filter(Boolean).join("/")).replace(/\/+/g,"/")}d(po,"joinPath");function fo(a=""){return V(a).toLowerCase()}d(fo,"getCacheKey");function mo(a=""){if(!a)return"";if(typeof a=="string")return a;if(typeof a.fsPath=="string"&&a.fsPath.length>0)return a.fsPath;if(typeof a.path=="string"&&a.path.length>0)return a.path;if(typeof a.toString=="function")try{return a.toString(!0)}catch{return a.toString()}return String(a)}d(mo,"getUriPath");function wo(a="",e=""){let t=V(a),o=V(e);return t&&o.startsWith(t)?o.substring(t.length).replace(/^\/+/,""):o}d(wo,"getRelativePath");ft.exports={normalizePath:V,getFileName:pt,getExtension:uo,getDirectory:go,joinPath:po,getCacheKey:fo,getUriPath:mo,getRelativePath:wo}});var U=S((Ui,wt)=>{var R=require("vscode"),{isWebEnvironment:vo}=Me(),{normalizePath:bo}=B(),mt=!1,$=null;if(!mt)try{$=require("fs").promises}catch{$=null}var Ee=class Ee{constructor(){this.isWeb=mt||vo()}_toPath(e){return e?typeof e=="string"?e:e instanceof R.Uri?e.fsPath||e.path:String(e):""}_toUri(e){if(e instanceof R.Uri)return e;if(typeof e=="string")return R.Uri.file(e);throw new Error(`Unsupported target type: ${typeof e}`)}async stat(e){if(!this.isWeb&&$)return $.stat(this._toPath(e));let t=this._toUri(e),o=await R.workspace.fs.stat(t);return{...o,mtime:new Date(o.mtime),ctime:new Date(o.ctime),birthtime:new Date(o.ctime),isFile:d(()=>o.type===R.FileType.File,"isFile"),isDirectory:d(()=>o.type===R.FileType.Directory,"isDirectory")}}async readFile(e,t="utf8"){if(!this.isWeb&&$)return $.readFile(this._toPath(e),t);let o=this._toUri(e),i=await R.workspace.fs.readFile(o);return t===null||t==="binary"?i:new TextDecoder(t).decode(i)}async writeFile(e,t,o="utf8"){if(!this.isWeb&&$)return $.writeFile(this._toPath(e),t,o);let i=this._toUri(e),s=typeof t=="string"?new TextEncoder().encode(t):t;await R.workspace.fs.writeFile(i,s)}async mkdir(e,t={recursive:!0}){if(!this.isWeb&&$)return $.mkdir(this._toPath(e),t);let o=this._toUri(e);await R.workspace.fs.createDirectory(o)}async readdir(e,t={withFileTypes:!1}){if(!this.isWeb&&$)return $.readdir(this._toPath(e),t);let o=this._toUri(e),i=await R.workspace.fs.readDirectory(o);return t.withFileTypes?i.map(([s,r])=>({name:s,isDirectory:d(()=>r===R.FileType.Directory,"isDirectory"),isFile:d(()=>r===R.FileType.File,"isFile")})):i.map(([s])=>s)}async delete(e,t={recursive:!1}){if(!this.isWeb&&$){let i=this._toPath(e);return t.recursive?$.rm?$.rm(i,t):$.rmdir(i,t):$.unlink(i)}let o=this._toUri(e);await R.workspace.fs.delete(o,t)}async exists(e){try{return await this.stat(e),!0}catch{return!1}}async ensureDirectory(e){let t=bo(this._toPath(e));await this.mkdir(t,{recursive:!0})}};d(Ee,"FileSystemAdapter");var we=Ee,yo=new we;wt.exports={FileSystemAdapter:we,fileSystem:yo}});var bt=S((Gi,vt)=>{var I=require("vscode"),{getLogger:_o}=P(),{fileSystem:Co}=U(),{normalizePath:Ae,getRelativePath:xo,getFileName:Do}=B(),Ie=class Ie{constructor(){this._logger=_o(),this._fs=Co,this._commonExclusions=["node_modules",".npm",".yarn","coverage","nyc_output","dist","build","out","target","bin","obj",".vscode",".idea",".vs",".vscode-test",".git",".svn",".hg",".bzr",".pnpm-store","bower_components","jspm_packages","tmp","temp",".tmp",".cache",".parcel-cache",".DS_Store","Thumbs.db","__pycache__",".pytest_cache",".tox","venv",".env",".virtualenv","vendor",".docker","logs","*.log"],this._patternScores=new Map,this._workspaceAnalysis=new Map,this._logger.info("SmartExclusionManager initialized")}async cleanupAllWorkspaceProfiles(){let e=I.workspace.getConfiguration("explorerDates"),t=e.get("workspaceExclusionProfiles",{}),o=!1;for(let[i,s]of Object.entries(t)){let r=Array.isArray(s)?s:[],n=this._dedupeList(r);this._areListsEqual(r,n)||(t[i]=n,o=!0,this._logger.debug(`Deduped workspace exclusions for ${i}`,{before:r.length,after:n.length}))}o?(await e.update("workspaceExclusionProfiles",t,I.ConfigurationTarget.Global),this._logger.info("Cleaned up duplicate workspace exclusions",{workspaceCount:Object.keys(t).length})):this._logger.debug("Workspace exclusion profiles already clean")}async analyzeWorkspace(e){try{let t=Ae((e==null?void 0:e.fsPath)||(e==null?void 0:e.path)||""),o={detectedPatterns:[],suggestedExclusions:[],projectType:"unknown",riskFolders:[]};o.projectType=await this._detectProjectType(e);let i=await this._scanForExclusionCandidates(e,t),s=this._scorePatterns(i,o.projectType);return o.detectedPatterns=i,o.suggestedExclusions=s.filter(r=>r.score>.7).map(r=>r.pattern),o.riskFolders=s.filter(r=>r.riskLevel==="high").map(r=>r.pattern),this._workspaceAnalysis.set(t,o),this._logger.info(`Workspace analysis complete for ${t}`,o),o}catch(t){return this._logger.error("Failed to analyze workspace",t),null}}async _detectProjectType(e){let t=[{file:"package.json",type:"javascript"},{file:"pom.xml",type:"java"},{file:"Cargo.toml",type:"rust"},{file:"setup.py",type:"python"},{file:"requirements.txt",type:"python"},{file:"Gemfile",type:"ruby"},{file:"composer.json",type:"php"},{file:"go.mod",type:"go"},{file:"CMakeLists.txt",type:"cpp"},{file:"Dockerfile",type:"docker"}];if(!e)return"unknown";for(let o of t)try{let i=I.Uri.joinPath(e,o.file);if(await this._fs.exists(i))return o.type}catch{}return"unknown"}async _scanForExclusionCandidates(e,t,o=2){let i=[],s=d(async(r,n=0)=>{if(!(n>o))try{let l=await this._fs.readdir(r,{withFileTypes:!0});for(let c of l)if(c.isDirectory()){let h=I.Uri.joinPath(r,c.name),u=Ae(h.fsPath||h.path),f=xo(t,u);this._commonExclusions.includes(c.name)&&i.push({name:c.name,path:f,type:"common",size:await this._getDirectorySize(h)});let g=await this._getDirectorySize(h);g>10485760&&i.push({name:c.name,path:f,type:"large",size:g}),await s(h,n+1)}}catch{}},"scanDirectory");return await s(e),i}async _getDirectorySize(e){try{let t=await this._fs.readdir(e,{withFileTypes:!0}),o=0,i=0;for(let s of t){if(i>100)break;if(s.isFile())try{let r=I.Uri.joinPath(e,s.name),n=await this._fs.stat(r);o+=n.size,i++}catch{}}return o}catch{return 0}}_scorePatterns(e,t){return e.map(o=>{let i=0,s="low";switch(o.type==="common"&&(i+=.8),o.size>100*1024*1024?(i+=.9,s="high"):o.size>10*1024*1024&&(i+=.5,s="medium"),t){case"javascript":["node_modules",".npm","coverage","dist","build"].includes(o.name)&&(i+=.9);break;case"python":["__pycache__",".pytest_cache","venv",".env"].includes(o.name)&&(i+=.9);break;case"java":["target","build",".gradle"].includes(o.name)&&(i+=.9);break}return["src","lib","app","components","pages"].includes(o.name.toLowerCase())&&(i=0,s="none"),{pattern:o.name,path:o.path,score:Math.min(i,1),riskLevel:s,size:o.size,type:o.type}})}async getWorkspaceExclusions(e){let t=I.workspace.getConfiguration("explorerDates"),o=t.get("workspaceExclusionProfiles",{}),i=this._getWorkspaceKey(e),s=o[i]||[],r=this._dedupeList(s);if(r.length!==s.length){o[i]=r;try{await t.update("workspaceExclusionProfiles",o,I.ConfigurationTarget.Global),this._logger.info(`Cleaned duplicate exclusions for ${i}`,{before:s.length,after:r.length})}catch(n){this._logger.warn(`Failed to persist cleaned exclusions for ${i}`,n)}}return r}async saveWorkspaceExclusions(e,t){let o=I.workspace.getConfiguration("explorerDates"),i=o.get("workspaceExclusionProfiles",{}),s=this._getWorkspaceKey(e),r=this._dedupeList(t);if(Array.isArray(i[s])?this._areListsEqual(i[s],r):!1){this._logger.debug(`No workspace exclusion changes for ${s}`);return}i[s]=r,await o.update("workspaceExclusionProfiles",i,I.ConfigurationTarget.Global),this._logger.info(`Saved workspace exclusions for ${s}`,r)}async getCombinedExclusions(e){let t=I.workspace.getConfiguration("explorerDates"),o=t.get("excludedFolders",[]),i=t.get("excludedPatterns",[]),s=t.get("smartExclusions",!0),r=[...o],n=[...i],l=await this.getWorkspaceExclusions(e);if(r.push(...l),s){let c=await this.analyzeWorkspace(e);c&&r.push(...c.suggestedExclusions)}return r=[...new Set(r)],n=[...new Set(n)],{folders:r,patterns:n}}_getWorkspaceKey(e){if(!e)return"unknown-workspace";let t=e.fsPath||e.path||"";return Do(t)||Ae(t)}async suggestExclusions(e){let t=await this.analyzeWorkspace(e),o=this._dedupeList((t==null?void 0:t.suggestedExclusions)||[]);if(!t||o.length===0)return;let i=await this.getWorkspaceExclusions(e),s=o.filter(c=>!i.includes(c));if(s.length===0){this._logger.debug("No new smart exclusions detected",{workspace:this._getWorkspaceKey(e)});return}let r=this._mergeExclusions(i,s);await this.saveWorkspaceExclusions(e,r);let n=s.length===1?`Explorer Dates automatically excluded "${s[0]}" to keep Explorer responsive.`:`Explorer Dates automatically excluded ${s.length} folders to keep Explorer responsive.`,l=await I.window.showInformationMessage(`${n} Keep these exclusions?`,"Keep","Review","Revert");l==="Revert"?(await this.saveWorkspaceExclusions(e,i),I.window.showInformationMessage("Smart exclusions reverted. Decorations will refresh for the restored folders."),this._logger.info("User reverted smart exclusions",{reverted:s})):l==="Review"?(this._showExclusionReview(t),this._logger.info("User reviewing smart exclusions",{pending:s})):this._logger.info("User kept smart exclusions",{accepted:s})}_dedupeList(e=[]){return Array.from(new Set(e.filter(Boolean)))}_mergeExclusions(e=[],t=[]){return this._dedupeList([...e||[],...t||[]])}_areListsEqual(e=[],t=[]){return e.length!==t.length?!1:e.every((o,i)=>o===t[i])}_showExclusionReview(e){let t=I.window.createWebviewPanel("exclusionReview","Smart Exclusion Review",I.ViewColumn.One,{enableScripts:!0});t.webview.html=this._generateReviewHTML(e)}_generateReviewHTML(e){let t=d(i=>{if(i<1024)return`${i} B`;let s=i/1024;return s<1024?`${s.toFixed(1)} KB`:`${(s/1024).toFixed(1)} MB`},"formatSize"),o=e.detectedPatterns.map(i=>`
            <tr>
                <td>${i.name}</td>
                <td>${i.path}</td>
                <td>${t(i.size)}</td>
...
`;let f=i.fileSizeLabel||this._formatFileSize(o.size,n||"auto");if(u+=`\u{1F4CA} Size: ${f} (${o.size.toLocaleString()} bytes)
`,h&&(u+=`\u{1F3F7}\uFE0F Type: ${h.toUpperCase()} file
`),l)try{let g=t||e,F=(await this._fileSystem.readFile(g,"utf8")).split(`
`).length;u+=`\u{1F4CF} Lines: ${F.toLocaleString()}
`}catch{}return u+=`\u{1F4C2} Path: ${e}`,s&&(u+=`

\u{1F464} Last Modified By: ${s.authorName}`,s.authorEmail&&(u+=` (${s.authorEmail})`),s.authorDate&&(u+=`
   ${s.authorDate}`)),u}_formatDateReadable(e){let t=new Date,o=t.getTime()-e.getTime(),i=Math.floor(o/(1e3*60)),s=Math.floor(o/(1e3*60*60)),r=Math.floor(o/(1e3*60*60*24));return i<1?this._l10n.getString("justNow"):i<60?this._l10n.getString("minutesAgo",i):s<24&&e.toDateString()===t.toDateString()?this._l10n.getString("hoursAgo",s):r<7?r===1?this._l10n.getString("yesterday"):this._l10n.getString("daysAgo",r):e.getFullYear()===t.getFullYear()?this._l10n.formatDate(e,{month:"short",day:"numeric"}):this._l10n.formatDate(e,{month:"short",day:"numeric",year:"numeric"})}async _getGitBlameInfo(e,t=null){if(!this._gitAvailable||!ne)return null;try{let o=w.workspace.getWorkspaceFolder(w.Uri.file(e));if(!o)return null;let i=o.uri.fsPath||o.uri.path,s=Ko(i,e),r=this._getGitCacheKey(i,s,t),n=this._getCachedGitInfo(r);if(n)return n;let l=Date.now();try{let{stdout:c}=await ne(`git log -1 --format="%H|%an|%ae|%ad" -- "${s}"`,{cwd:o.uri.fsPath,timeout:2e3});if(!c||!c.trim())return null;let[h,u,f,g]=c.trim().split("|"),v={hash:h||"",authorName:u||"Unknown",authorEmail:f||"",authorDate:g||""};return this._setCachedGitInfo(r,v),v}finally{let c=Date.now()-l;this._metrics.gitBlameTimeMs+=c,this._metrics.gitBlameCalls++}}catch{return null}}_getInitials(e){if(!e||typeof e!="string")return null;let t=e.trim().split(/\s+/).filter(Boolean);return t.length===0?null:t.length===1?t[0].substring(0,2).toUpperCase():(t[0][0]+(t[1][0]||"")).substring(0,2).toUpperCase()}_formatCompactSize(e){if(typeof e!="number"||isNaN(e))return null;let t=["B","K","M","G","T"],o=0,i=e;for(;i>=1024&&o<t.length-1;)i=i/1024,o++;let s=Math.round(i),r=t[o];if(s<=9)return`${s}${r}`;let n=String(s);return n.length>=2?n.slice(0,2):n}_formatFullDate(e){let t={year:"numeric",month:"long",day:"numeric",hour:"2-digit",minute:"2-digit",second:"2-digit",timeZoneName:"short"};return e.toLocaleString("en-US",t)}_getCacheKey(e){return Vo(J(e))}async provideFileDecoration(e,t){var i,s,r,n,l;let o=Date.now();try{if(!e){this._logger.error("\u274C Invalid URI provided to provideFileDecoration:",e);return}let c=J(e);if(!c){this._logger.error("\u274C Could not resolve path for URI in provideFileDecoration:",e);return}let h=j(c);this._performanceMode||(this._logger.info(`\u{1F50D} VSCODE REQUESTED DECORATION: ${h} (${c})`),this._logger.info(`\u{1F4CA} Call context: token=${!!t}, cancelled=${t==null?void 0:t.isCancellationRequested}`));let u=w.workspace.getConfiguration("explorerDates"),f=d((A,lt)=>{if(this._previewSettings&&Object.prototype.hasOwnProperty.call(this._previewSettings,A)){let dt=this._previewSettings[A];return this._logger.debug(`\u{1F3AD} Using preview value for ${A}: ${dt} (config has: ${u.get(A,lt)})`),dt}return u.get(A,lt)},"_get");if(this._previewSettings&&this._logger.info(`\u{1F3AD} Processing ${h} in PREVIEW MODE with settings:`,this._previewSettings),!f("showDateDecorations",!0)){this._performanceMode||this._logger.info(`\u274C RETURNED UNDEFINED: Decorations disabled globally for ${h}`);return}if(await this._isExcludedSimple(e)){this._performanceMode||this._logger.info(`\u274C File excluded: ${h}`);return}this._logger.debug(`\u{1F50D} Processing file: ${h}`);let g=this._getCacheKey(e);if(this._previewSettings)this._logger.debug(`\u{1F504} Skipping cache due to active preview settings for: ${h}`);else{let A=await this._getCachedDecoration(g,h);if(A)return A}if(this._metrics.cacheMisses++,this._logger.debug(`\u274C Cache miss for: ${h} (key: ${g.substring(0,50)}...)`),t!=null&&t.isCancellationRequested){this._logger.debug(`Decoration cancelled for: ${c}`);return}let v=Date.now(),F=await this._fileSystem.stat(e);if(this._metrics.fileStatTimeMs+=Date.now()-v,this._metrics.fileStatCalls++,!(typeof F.isFile=="function"?F.isFile():!0))return;let Z=F.mtime instanceof Date?F.mtime:new Date(F.mtime),_e=F.birthtime instanceof Date?F.birthtime:new Date(F.birthtime||F.ctime||F.mtime),le={mtime:Z,birthtime:_e,size:F.size},oe=Date.now()-Z.getTime(),G=f("dateDecorationFormat","smart"),O=this._performanceMode?"none":f("colorScheme","none"),de=f("highContrastMode",!1),rt=this._performanceMode?!1:f("showFileSize",!1),he=f("fileSizeFormat","auto"),y=f("accessibilityMode",!1),X=this._performanceMode?!1:f("fadeOldFiles",!1),Ce=f("fadeThreshold",30),ue=this._performanceMode?"none":f("showGitInfo","none"),q=this._performanceMode?"time":f("badgePriority","time"),xe=(ue!=="none"||q==="author")&&this._gitAvailable&&!this._performanceMode,at=xe?ue:"none";q==="author"&&!xe&&(q="time");let nt=xe?await this._getGitBlameInfo(c,Z.getTime()):null,De=this._generateBadgeDetails({filePath:c,stat:le,diffMs:oe,dateFormat:G,badgePriority:q,showFileSize:rt,fileSizeFormat:he,gitBlame:nt,showGitInfo:at}),io=ve(c),so=[".js",".ts",".jsx",".tsx",".py",".rb",".php",".java",".cpp",".c",".cs",".go",".rs",".kt",".swift"].includes(io),ct=y&&((i=this._accessibility)==null?void 0:i.shouldEnhanceAccessibility());this._logger.debug(`\u{1F50D} Tooltip generation for ${h}: accessibilityMode=${y}, shouldUseAccessible=${ct}, previewMode=${!!this._previewSettings}`);let ge=await this._buildTooltipContent({filePath:c,resourceUri:e,stat:le,badgeDetails:De,gitBlame:at==="none"?null:nt,shouldUseAccessibleTooltips:ct,fileSizeFormat:he,isCodeFile:so}),H;O!=="none"&&(H=this._themeIntegration?this._themeIntegration.applyThemeAwareColorScheme(O,c,oe):this._getColorByScheme(Z,O,c)),this._logger.debug(`\u{1F3A8} Color scheme setting: ${O}, using color: ${H?"yes":"no"}`),X&&Math.floor(oe/864e5)>Ce&&(H=new w.ThemeColor("editorGutter.commentRangeForeground"));let Se=It(De.displayBadge)||It(De.badge)||"??";(s=this._accessibility)!=null&&s.shouldEnhanceAccessibility()&&(Se=this._accessibility.getAccessibleBadge(Se));let k;try{if(k=new w.FileDecoration(Se),ge&&ge.length<500&&(k.tooltip=ge,this._logger.debug(`\u{1F4DD} Added tooltip (${ge.length} chars)`)),H){let A=this._enhanceColorForSelection(H);k.color=A,this._logger.debug(`\u{1F3A8} Added enhanced color: ${A.id||A} (original: ${H.id||H})`)}k.propagate=!1}catch(A){this._logger.error("\u274C Failed to create decoration:",A),k=new w.FileDecoration("!!"),k.propagate=!1}if(this._logger.debug(`\u{1F3A8} Color/contrast check for ${h}: colorScheme=${O}, highContrastMode=${de}, hasColor=${!!H}, previewMode=${!!this._previewSettings}`),de&&(k.color=new w.ThemeColor("editorWarning.foreground"),this._logger.info(`\u{1F506} Applied high contrast color (overriding colorScheme=${O})`)),this._previewSettings?this._logger.debug(`\u{1F504} Skipping cache storage due to preview mode for: ${h}`):await this._storeDecorationInCache(g,k,h),this._metrics.totalDecorations++,!(k!=null&&k.badge)){this._logger.error(`\u274C Decoration badge is invalid for: ${h}`);return}let ro=Date.now()-o;return this._performanceMode||(this._logger.info(`\u2705 Decoration created for: ${h} (badge: ${k.badge||"undefined"}) - Cache key: ${g.substring(0,30)}...`),this._logger.info("\u{1F3AF} RETURNING DECORATION TO VSCODE:",{file:h,badge:k.badge,hasTooltip:!!k.tooltip,hasColor:!!k.color,colorType:(n=(r=k.color)==null?void 0:r.constructor)==null?void 0:n.name,processingTimeMs:ro,decorationType:k.constructor.name})),k}catch(c){this._metrics.errors++;let h=o?Date.now()-o:0,u=j(e),f=J(e)||"unknown-uri";this._logger.error(`\u274C DECORATION ERROR for ${u}:`,{error:c.message,stack:(l=c.stack)==null?void 0:l.split(`
`)[0],processingTimeMs:h,uri:f}),this._logger.error(`\u274C CRITICAL ERROR DETAILS for ${u}: ${c.message}`),this._logger.error(`\u274C Error type: ${c.constructor.name}`),this._logger.error(`\u274C Full stack: ${c.stack}`),this._logger.info(`\u274C RETURNED UNDEFINED: Error occurred for ${u}`);return}}getMetrics(){let e={...this._metrics,cacheSize:this._decorationCache.size,cacheHitRate:this._metrics.cacheHits+this._metrics.cacheMisses>0?(this._metrics.cacheHits/(this._metrics.cacheHits+this._metrics.cacheMisses)*100).toFixed(2)+"%":"0.00%"};return this._advancedCache&&(e.advancedCache=this._advancedCache.getStats()),this._batchProcessor&&(e.batchProcessor=this._batchProcessor.getMetrics()),e.cacheDebugging={memoryCacheKeys:Array.from(this._decorationCache.keys()).slice(0,5),cacheTimeout:this._cacheTimeout,maxCacheSize:this._maxCacheSize,keyStatsSize:this._cacheKeyStats?this._cacheKeyStats.size:0},e.performanceTiming={avgGitBlameMs:this._metrics.gitBlameCalls>0?(this._metrics.gitBlameTimeMs/this._metrics.gitBlameCalls).toFixed(1):"0.0",avgFileStatMs:this._metrics.fileStatCalls>0?(this._metrics.fileStatTimeMs/this._metrics.fileStatCalls).toFixed(1):"0.0",totalGitBlameTimeMs:this._metrics.gitBlameTimeMs,totalFileStatTimeMs:this._metrics.fileStatTimeMs,gitBlameCalls:this._metrics.gitBlameCalls,fileStatCalls:this._metrics.fileStatCalls},e}async initializeAdvancedSystems(e){try{if(this._extensionContext=e,this._isWeb&&await this._maybeWarnAboutGitLimitations(),this._performanceMode){this._logger.info("Performance mode enabled - skipping advanced cache, batch processor, and progressive loading");return}this._advancedCache=new jo(e),await this._advancedCache.initialize(),this._logger.info("Advanced cache initialized"),this._batchProcessor.initialize(),this._logger.info("Batch processor initialized"),await this._applyProgressiveLoadingSetting(),w.workspace.getConfiguration("explorerDates").get("autoThemeAdaptation",!0)&&(await this._themeIntegration.autoConfigureForTheme(),this._logger.info("Theme integration configured")),this._accessibility.shouldEnhanceAccessibility()&&(await this._accessibility.applyAccessibilityRecommendations(),this._logger.info("Accessibility recommendations applied"));try{await this._smartExclusion.cleanupAllWorkspaceProfiles()}catch(o){this._logger.warn("Failed to clean workspace exclusion profiles",o)}if(w.workspace.workspaceFolders)for(let o of w.workspace.workspaceFolders)try{await this._smartExclusion.suggestExclusions(o.uri),this._logger.info(`Smart exclusions analyzed for: ${o.name}`)}catch(i){this._logger.error(`Failed to analyze smart exclusions for ${o.name}`,i)}this._logger.info("Advanced systems initialized successfully")}catch(t){this._logger.error("Failed to initialize advanced systems",t)}}async _maybeWarnAboutGitLimitations(){var e;if(!this._gitWarningShown){this._gitWarningShown=!0;try{let t=(e=this._extensionContext)==null?void 0:e.globalState,o=Yo.WEB_GIT_NOTICE;if(t==null?void 0:t.get(o,!1))return;if(t!=null&&t.update)try{await t.update(o,!0)}catch(s){this._logger.debug("Failed to persist Git limitation notice flag",s)}Promise.resolve().then(()=>{w.window.showInformationMessage("Explorer Dates: Git attribution badges are unavailable on VS Code for Web. Time-based decorations remain available.")})}catch(t){this._logger.debug("Failed to display Git limitation notice",t)}}}_enhanceColorForSelection(e){let t={"charts.yellow":"list.warningForeground","charts.red":"list.errorForeground","charts.green":"list.highlightForeground","charts.blue":"symbolIcon.functionForeground","charts.purple":"symbolIcon.classForeground","charts.orange":"list.warningForeground","terminal.ansiYellow":"list.warningForeground","terminal.ansiGreen":"list.highlightForeground","terminal.ansiRed":"list.errorForeground","terminal.ansiBlue":"symbolIcon.functionForeground","terminal.ansiMagenta":"symbolIcon.classForeground","terminal.ansiCyan":"symbolIcon.stringForeground","editorGutter.commentRangeForeground":"list.deemphasizedForeground","editorWarning.foreground":"list.warningForeground","editorError.foreground":"list.errorForeground","editorInfo.foreground":"list.highlightForeground"},o=e.id||e,i=t[o];return i?(this._logger.debug(`\u{1F527} Enhanced color ${o} \u2192 ${i} for better selection visibility`),new w.ThemeColor(i)):e}async dispose(){this._logger.info("Disposing FileDateDecorationProvider",this.getMetrics()),this._refreshTimer&&(clearInterval(this._refreshTimer),this._refreshTimer=null,this._logger.info("Cleared periodic refresh timer")),this._advancedCache&&await this._advancedCache.dispose(),this._cancelProgressiveWarmupJobs(),this._batchProcessor&&this._batchProcessor.dispose(),this._accessibility&&typeof this._accessibility.dispose=="function"&&this._accessibility.dispose(),this._decorationCache.clear(),this._gitCache.clear(),this._onDidChangeFileDecorations.dispose(),this._fileWatcher&&this._fileWatcher.dispose(),this._configurationWatcher&&(this._configurationWatcher.dispose(),this._configurationWatcher=null)}};d(He,"FileDateDecorationProvider");var Ge=He;Rt.exports={FileDateDecorationProvider:Ge}});var Nt=S((exports,module)=>{var vscode=require("vscode"),{fileSystem}=U(),{getFileName,getRelativePath}=B(),isWeb=!1,childProcess=null;function loadChildProcess(){return!childProcess&&!isWeb&&(childProcess=eval("require")("child_process")),childProcess}d(loadChildProcess,"loadChildProcess");function registerCoreCommands({context:a,fileDateProvider:e,logger:t,l10n:o}){let i=[];i.push(vscode.commands.registerCommand("explorerDates.refreshDateDecorations",()=>{try{if(e){e.clearAllCaches(),e.refreshAll();let s=(o==null?void 0:o.getString("refreshSuccess"))||"Date decorations refreshed - all caches cleared";vscode.window.showInformationMessage(s),t.info("Date decorations refreshed manually with cache clear")}}catch(s){t.error("Failed to refresh decorations",s),vscode.window.showErrorMessage(`Failed to refresh decorations: ${s.message}`)}})),i.push(vscode.commands.registerCommand("explorerDates.previewConfiguration",s=>{try{e&&(e.applyPreviewSettings(s),t.info("Configuration preview applied",s))}catch(r){t.error("Failed to apply configuration preview",r)}})),i.push(vscode.commands.registerCommand("explorerDates.clearPreview",()=>{try{e&&(e.applyPreviewSettings(null),t.info("Configuration preview cleared"))}catch(s){t.error("Failed to clear configuration preview",s)}})),i.push(vscode.commands.registerCommand("explorerDates.showMetrics",()=>{try{if(e){let s=e.getMetrics(),r=`Explorer Dates Metrics:
...
Also set: "explorerDates.colorScheme": "custom"`,l=await vscode.window.showInformationMessage("Custom colors configuration",{modal:!0,detail:n},"Copy to Clipboard","Open Settings");if(l==="Copy to Clipboard"){let c=`"workbench.colorCustomizations": {
  ...
  "explorerDates.customColor.recent": "${r.recent}",
  "explorerDates.customColor.old": "${r.old}"
}`;await vscode.env.clipboard.writeText(c),vscode.window.showInformationMessage("Custom color configuration copied to clipboard")}else l==="Open Settings"&&await vscode.commands.executeCommand("workbench.action.openSettings","workbench.colorCustomizations");t.info("Custom colors help displayed")}catch(s){t.error("Failed to apply custom colors",s),vscode.window.showErrorMessage(`Failed to apply custom colors: ${s.message}`)}})),i.forEach(s=>a.subscriptions.push(s))}d(registerCoreCommands,"registerCoreCommands");module.exports={registerCoreCommands}});var Ot=S((as,Bt)=>{var M=require("vscode"),{getLogger:Xo}=P(),Ve=class Ve{constructor(e){this._logger=Xo(),this._provider=e,this._testResults=[]}async runComprehensiveDiagnostics(){var t,o;this._logger.info("\u{1F50D} Starting comprehensive decoration diagnostics...");let e={timestamp:new Date().toISOString(),vscodeVersion:M.version,extensionVersion:(o=(t=M.extensions.getExtension("incredincomp.explorer-dates"))==null?void 0:t.packageJSON)==null?void 0:o.version,tests:{}};return e.tests.vscodeSettings=await this._testVSCodeSettings(),e.tests.providerRegistration=await this._testProviderRegistration(),e.tests.fileProcessing=await this._testFileProcessing(),e.tests.decorationCreation=await this._testDecorationCreation(),e.tests.cacheAnalysis=await this._testCacheAnalysis(),e.tests.extensionConflicts=await this._testExtensionConflicts(),e.tests.uriPathIssues=await this._testURIPathIssues(),this._logger.info("\u{1F50D} Comprehensive diagnostics completed",e),e}async _testVSCodeSettings(){let e=M.workspace.getConfiguration("explorer"),t=M.workspace.getConfiguration("workbench"),o=M.workspace.getConfiguration("explorerDates"),i={"explorer.decorations.badges":e.get("decorations.badges"),"explorer.decorations.colors":e.get("decorations.colors"),"workbench.colorTheme":t.get("colorTheme"),"explorerDates.showDateDecorations":o.get("showDateDecorations"),"explorerDates.colorScheme":o.get("colorScheme"),"explorerDates.showGitInfo":o.get("showGitInfo")},s=[];return i["explorer.decorations.badges"]===!1&&s.push("CRITICAL: explorer.decorations.badges is disabled"),i["explorer.decorations.colors"]===!1&&s.push("WARNING: explorer.decorations.colors is disabled"),i["explorerDates.showDateDecorations"]===!1&&s.push("CRITICAL: explorerDates.showDateDecorations is disabled"),{status:s.length>0?"ISSUES_FOUND":"OK",settings:i,issues:s}}async _testProviderRegistration(){let e=[];if(!this._provider)return e.push("CRITICAL: Decoration provider is null/undefined"),{status:"FAILED",issues:e};typeof this._provider.provideFileDecoration!="function"&&e.push("CRITICAL: provideFileDecoration method missing"),this._provider.onDidChangeFileDecorations||e.push("WARNING: onDidChangeFileDecorations event emitter missing");let t=M.Uri.file("/test/path");try{let o=await this._provider.provideFileDecoration(t);this._logger.debug("Provider test call completed",{result:!!o})}catch(o){e.push(`ERROR: Provider test call failed: ${o.message}`)}return{status:e.length>0?"ISSUES_FOUND":"OK",providerActive:!!this._provider,issues:e}}async _testFileProcessing(){let e=M.workspace.workspaceFolders;if(!e||e.length===0)return{status:"NO_WORKSPACE",issues:["No workspace folders available"]};let t=[],o=[];try{let i=["package.json","README.md","extension.js","src/logger.js"];for(let s of i){let r=M.Uri.joinPath(e[0].uri,s);try{await M.workspace.fs.stat(r);let n=this._provider._isExcludedSimple?await this._provider._isExcludedSimple(r):!1,l=await this._provider.provideFileDecoration(r);t.push({file:s,exists:!0,excluded:n,hasDecoration:!!l,badge:l==null?void 0:l.badge,uri:r.toString()})}catch(n){t.push({file:s,exists:!1,error:n.message})}}}catch(i){o.push(`File processing test failed: ${i.message}`)}return{status:o.length>0?"ISSUES_FOUND":"OK",testFiles:t,issues:o}}async _testDecorationCreation(){let e=[],t=[];try{let i=new M.FileDecoration("test");e.push({name:"Simple decoration",success:!0,badge:i.badge})}catch(i){e.push({name:"Simple decoration",success:!1,error:i.message}),t.push("CRITICAL: Cannot create simple FileDecoration")}try{let i=new M.FileDecoration("test","Test tooltip");e.push({name:"Decoration with tooltip",success:!0,hasTooltip:!!(i&&i.tooltip)})}catch(i){e.push({name:"Decoration with tooltip",success:!1,error:i.message}),t.push("WARNING: Cannot create FileDecoration with tooltip")}try{let i=new M.FileDecoration("test","Test tooltip",new M.ThemeColor("charts.red"));e.push({name:"Decoration with color",success:!0,hasColor:!!i.color})}catch(i){e.push({name:"Decoration with color",success:!1,error:i.message}),t.push("WARNING: Cannot create FileDecoration with color")}let o=["1d","10m","2h","!!","\u25CF\u25CF","JA12","123456789"];for(let i of o)try{let s=new M.FileDecoration(i);e.push({name:`Badge format: ${i}`,success:!0,badge:s.badge,length:i.length})}catch(s){e.push({name:`Badge format: ${i}`,success:!1,error:s.message}),i.length<=8&&t.push(`WARNING: Valid badge format '${i}' failed`)}return{status:t.length>0?"ISSUES_FOUND":"OK",tests:e,issues:t}}async _testCacheAnalysis(){var o;let e={memoryCache:{size:((o=this._provider._decorationCache)==null?void 0:o.size)||0,maxSize:this._provider._maxCacheSize||0},advancedCache:{available:!!this._provider._advancedCache,initialized:!1},metrics:this._provider.getMetrics?this._provider.getMetrics():null},t=[];return e.memoryCache.size>e.memoryCache.maxSize*.9&&t.push("WARNING: Memory cache is nearly full"),e.metrics&&e.metrics.cacheHits===0&&e.metrics.cacheMisses>10&&t.push("WARNING: Cache hit rate is 0% - potential cache key issues"),{status:t.length>0?"ISSUES_FOUND":"OK",cacheInfo:e,issues:t}}async _testExtensionConflicts(){var s,r;let e=M.extensions.all,t=[],o=[];for(let n of e){if(!n.isActive)continue;let l=n.packageJSON;(r=(s=l.contributes)==null?void 0:s.commands)!=null&&r.some(h=>{var u,f,g,v;return((u=h.command)==null?void 0:u.includes("decoration"))||((f=h.title)==null?void 0:f.includes("decoration"))||((g=h.title)==null?void 0:g.includes("badge"))||((v=h.title)==null?void 0:v.includes("explorer"))})&&o.push({id:n.id,name:l.displayName||l.name,version:l.version}),["file-icons","vscode-icons","material-icon-theme","explorer-exclude","hide-files","file-watcher"].some(h=>n.id.includes(h))&&t.push({id:n.id,name:l.displayName||l.name,reason:"Known to potentially interfere with file decorations"})}let i=[];return o.length>1&&i.push(`WARNING: ${o.length} extensions might provide file decorations`),t.length>0&&i.push(`WARNING: ${t.length} potentially conflicting extensions detected`),{status:i.length>0?"ISSUES_FOUND":"OK",decorationExtensions:o,potentialConflicts:t,issues:i}}async _testURIPathIssues(){let e=M.workspace.workspaceFolders;if(!e||e.length===0)return{status:"NO_WORKSPACE",issues:["No workspace available for URI testing"]};let t=[],o=[],i=["package.json","src/logger.js","README.md",".gitignore"];for(let s of i){let r=M.Uri.joinPath(e[0].uri,s);t.push({path:s,scheme:r.scheme,fsPath:r.fsPath,authority:r.authority,valid:r.scheme==="file"&&r.fsPath.length>0}),r.scheme!=="file"&&o.push(`WARNING: Non-file URI scheme for ${s}: ${r.scheme}`),(r.fsPath.includes("\\\\")||r.fsPath.includes("//"))&&o.push(`WARNING: Potential path separator issues in ${s}`)}return{status:o.length>0?"ISSUES_FOUND":"OK",tests:t,issues:o}}};d(Ve,"DecorationDiagnostics");var qe=Ve;Bt.exports={DecorationDiagnostics:qe}});var jt=S((cs,Ut)=>{var Q=require("vscode"),{getFileName:ei}=B();async function ti(){let a=P().getLogger();a.info("\u{1F3A8} Testing VS Code decoration rendering...");let i=class i{constructor(){this._onDidChangeFileDecorations=new Q.EventEmitter,this.onDidChangeFileDecorations=this._onDidChangeFileDecorations.event}provideFileDecoration(r){let n=ei(r.fsPath||r.path),l=new Q.FileDecoration("TEST");return l.tooltip=`Test decoration for ${n}`,l.color=new Q.ThemeColor("charts.red"),a.info(`\u{1F9EA} Test provider returning decoration for: ${n}`),l}};d(i,"TestDecorationProvider");let e=i,t=new e,o=Q.window.registerFileDecorationProvider(t);return a.info("\u{1F9EA} Test decoration provider registered"),setTimeout(()=>{t._onDidChangeFileDecorations.fire(void 0),a.info("\u{1F504} Test decoration refresh triggered"),setTimeout(()=>{o.dispose(),a.info("\u{1F9EA} Test decoration provider disposed")},1e4)},1e3),"Test decoration provider registered for 10 seconds"}d(ti,"testVSCodeDecorationRendering");async function oi(){let a=P().getLogger();a.info("\u{1F527} Testing FileDecoration API...");let e=[];try{let o=new Q.FileDecoration("MIN");e.push({name:"Minimal decoration",success:!0,badge:o.badge}),a.info("\u2705 Minimal decoration created successfully")}catch(o){e.push({name:"Minimal decoration",success:!1,error:o.message}),a.error("\u274C Minimal decoration failed:",o)}try{let o=new Q.FileDecoration("FULL","Full decoration tooltip",new Q.ThemeColor("charts.blue"));o.propagate=!1,e.push({name:"Full decoration",success:!0,badge:o.badge,hasTooltip:!!o.tooltip,hasColor:!!o.color,propagate:o.propagate}),a.info("\u2705 Full decoration created successfully")}catch(o){e.push({name:"Full decoration",success:!1,error:o.message}),a.error("\u274C Full decoration failed:",o)}let t=["charts.red","charts.blue","charts.green","charts.yellow","terminal.ansiRed","terminal.ansiGreen","terminal.ansiBlue","editorError.foreground","editorWarning.foreground","editorInfo.foreground"];for(let o of t)try{e.push({name:`ThemeColor: ${o}`,success:!0,colorId:o})}catch(i){e.push({name:`ThemeColor: ${o}`,success:!1,error:i.message}),a.error(`\u274C ThemeColor ${o} failed:`,i)}return e}d(oi,"testFileDecorationAPI");Ut.exports={testVSCodeDecorationRendering:ti,testFileDecorationAPI:oi}});var Ht=S((ds,Gt)=>{var m=require("vscode"),{fileSystem:ii}=U(),{getFileName:si,getRelativePath:ri}=B();function ai({context:a,fileDateProvider:e,logger:t,generators:o}){let{generateWorkspaceActivityHTML:i,generatePerformanceAnalyticsHTML:s,generateDiagnosticsHTML:r,generateDiagnosticsWebview:n}=o,l=[];l.push(m.commands.registerCommand("explorerDates.showWorkspaceActivity",async()=>{try{let c=m.window.createWebviewPanel("workspaceActivity","Workspace File Activity",m.ViewColumn.One,{enableScripts:!0});if(!m.workspace.workspaceFolders){m.window.showWarningMessage("No workspace folder open");return}let h=m.workspace.workspaceFolders[0],u=[],f=await m.workspace.findFiles("**/*","**/node_modules/**",100);for(let g of f)try{let v=await ii.stat(g);(typeof v.isFile!="function"||v.isFile())&&u.push({path:ri(h.uri.fsPath||h.uri.path,g.fsPath||g.path),modified:v.mtime instanceof Date?v.mtime:new Date(v.mtime),size:v.size})}catch{}u.sort((g,v)=>v.modified.getTime()-g.modified.getTime()),c.webview.html=i(u.slice(0,50)),t.info("Workspace activity panel opened")}catch(c){t.error("Failed to show workspace activity",c),m.window.showErrorMessage(`Failed to show workspace activity: ${c.message}`)}})),l.push(m.commands.registerCommand("explorerDates.showPerformanceAnalytics",async()=>{try{let c=m.window.createWebviewPanel("performanceAnalytics","Explorer Dates Performance Analytics",m.ViewColumn.One,{enableScripts:!0}),h=e?e.getMetrics():{};c.webview.html=s(h),t.info("Performance analytics panel opened")}catch(c){t.error("Failed to show performance analytics",c),m.window.showErrorMessage(`Failed to show performance analytics: ${c.message}`)}})),l.push(m.commands.registerCommand("explorerDates.debugCache",async()=>{try{if(e){let c=e.getMetrics(),h={"Cache Summary":{"Memory Cache Size":c.cacheSize,"Cache Hit Rate":c.cacheHitRate,"Total Hits":c.cacheHits,"Total Misses":c.cacheMisses,"Cache Timeout":`${c.cacheDebugging.cacheTimeout}ms`},"Advanced Cache":c.advancedCache||"Not available","Sample Cache Keys":c.cacheDebugging.memoryCacheKeys||[]};m.window.showInformationMessage(`Cache Debug Info:
${JSON.stringify(h,null,2)}`,{modal:!0}),t.info("Cache debug info displayed",h)}}catch(c){t.error("Failed to show cache debug info",c),m.window.showErrorMessage(`Failed to show cache debug info: ${c.message}`)}})),l.push(m.commands.registerCommand("explorerDates.runDiagnostics",async()=>{try{let c=m.workspace.getConfiguration("explorerDates"),h=m.window.activeTextEditor,u={"Extension Status":{"Provider Active":e?"Yes":"No","Decorations Enabled":c.get("showDateDecorations",!0)?"Yes":"No","VS Code Version":m.version,"Extension Version":a.extension.packageJSON.version}};if(h){let{uri:g}=h.document;g.scheme==="file"&&(u["Current File"]={"File Path":g.fsPath,"File Extension":si(g.fsPath||g.path).split(".").pop()||"No extension","Is Excluded":e?await e._isExcludedSimple(g):"Unknown"})}if(u.Configuration={"Excluded Folders":c.get("excludedFolders",[]),"Excluded Patterns":c.get("excludedPatterns",[]),"Color Scheme":c.get("colorScheme","none"),"Cache Timeout":`${c.get("cacheTimeout",3e4)}ms`},e){let g=e.getMetrics();u.Performance={"Total Decorations":g.totalDecorations,"Cache Size":g.cacheSize,"Cache Hit Rate":g.cacheHitRate,Errors:g.errors},g.performanceTiming&&(u["Performance Timing"]={"Avg Git Blame (ms)":g.performanceTiming.avgGitBlameMs,"Avg File Stat (ms)":g.performanceTiming.avgFileStatMs,"Git Calls":g.performanceTiming.gitBlameCalls,"File Stat Calls":g.performanceTiming.fileStatCalls,"Total Git Time (ms)":g.performanceTiming.totalGitBlameTimeMs,"Total File Stat Time (ms)":g.performanceTiming.totalFileStatTimeMs})}let f=m.window.createWebviewPanel("explorerDatesDiagnostics","Explorer Dates Diagnostics",m.ViewColumn.One,{enableScripts:!0});f.webview.html=r(u),t.info("Diagnostics panel opened",u)}catch(c){t.error("Failed to run diagnostics",c),m.window.showErrorMessage(`Failed to run diagnostics: ${c.message}`)}})),l.push(m.commands.registerCommand("explorerDates.testDecorations",async()=>{try{t.info("\u{1F50D} Starting comprehensive decoration diagnostics...");let{DecorationDiagnostics:c}=Ot(),u=await new c(e).runComprehensiveDiagnostics(),f=m.window.createWebviewPanel("decorationDiagnostics","Decoration Diagnostics - Root Cause Analysis",m.ViewColumn.One,{enableScripts:!0});f.webview.html=n(u);let g=[],v=[];Object.values(u.tests).forEach(F=>{F.issues&&F.issues.forEach(Y=>{Y.startsWith("CRITICAL:")?g.push(Y):Y.startsWith("WARNING:")&&v.push(Y)})}),g.length>0?m.window.showErrorMessage(`CRITICAL ISSUES FOUND: ${g.join(", ")}`):v.length>0?m.window.showWarningMessage(`Warnings found: ${v.length} potential issues detected. Check diagnostics panel.`):m.window.showInformationMessage("No critical issues found. Decorations should be working properly."),t.info("\u{1F50D} Comprehensive diagnostics completed",u)}catch(c){t.error("Failed to run comprehensive diagnostics",c),m.window.showErrorMessage(`Diagnostics failed: ${c.message}`)}})),l.push(m.commands.registerCommand("explorerDates.monitorDecorations",async()=>{if(!e){m.window.showErrorMessage("Decoration provider not available");return}e.startProviderCallMonitoring(),e.forceRefreshAllDecorations(),setTimeout(()=>{let c=e.getProviderCallStats(),h=`VS Code Decoration Requests: ${c.totalCalls} calls for ${c.uniqueFiles} files`;m.window.showInformationMessage(h),t.info("\u{1F50D} Decoration monitoring results:",c)},5e3),m.window.showInformationMessage("Started monitoring VS Code decoration requests. Results in 5 seconds...")})),l.push(m.commands.registerCommand("explorerDates.testVSCodeRendering",async()=>{try{let{testVSCodeDecorationRendering:c,testFileDecorationAPI:h}=jt();t.info("\u{1F3A8} Testing VS Code decoration rendering system...");let u=await h();t.info("\u{1F527} FileDecoration API tests:",u);let f=await c();t.info("\u{1F3A8} Decoration rendering test:",f),m.window.showInformationMessage('VS Code decoration rendering test started. Check Output panel and Explorer for "TEST" badges on files.')}catch(c){t.error("Failed to test VS Code rendering:",c),m.window.showErrorMessage(`VS Code rendering test failed: ${c.message}`)}})),l.push(m.commands.registerCommand("explorerDates.quickFix",async()=>{try{let c=m.workspace.getConfiguration("explorerDates"),h=[];c.get("showDateDecorations",!0)||h.push({issue:"Date decorations are disabled",description:"Enable date decorations",fix:d(async()=>c.update("showDateDecorations",!0,m.ConfigurationTarget.Global),"fix")});let u=c.get("excludedPatterns",[]);if(u.includes("**/*")&&h.push({issue:"All files are excluded by pattern",description:"Remove overly broad exclusion pattern",fix:d(async()=>{let g=u.filter(v=>v!=="**/*");await c.update("excludedPatterns",g,m.ConfigurationTarget.Global)},"fix")}),h.length===0){m.window.showInformationMessage("No common issues detected. Decorations should be working.");return}let f=await m.window.showQuickPick(h.map(g=>({label:g.description,description:g.issue,fix:g.fix})),{placeHolder:"Select an issue to fix automatically"});f&&(await f.fix(),m.window.showInformationMessage("Fixed! Try refreshing decorations now."),e&&(e.clearAllCaches(),e.refreshAll()))}catch(c){t.error("Failed to run quick fix",c),m.window.showErrorMessage(`Failed to run quick fix: ${c.message}`)}})),l.push(m.commands.registerCommand("explorerDates.showKeyboardShortcuts",async()=>{try{e!=null&&e._accessibility?await e._accessibility.showKeyboardShortcutsHelp():m.window.showInformationMessage("Keyboard shortcuts: Ctrl+Shift+D (toggle), Ctrl+Shift+C (copy date), Ctrl+Shift+I (file details), Ctrl+Shift+R (refresh), Ctrl+Shift+A (workspace activity)"),t.info("Keyboard shortcuts help shown")}catch(c){t.error("Failed to show keyboard shortcuts help",c),m.window.showErrorMessage(`Failed to show keyboard shortcuts help: ${c.message}`)}})),l.forEach(c=>a.subscriptions.push(c))}d(ai,"registerAnalysisCommands");Gt.exports={registerAnalysisCommands:ai}});var Vt=S((us,qt)=>{var te=require("vscode");function ni({context:a,logger:e,getOnboardingManager:t}){let o=[];o.push(te.commands.registerCommand("explorerDates.showFeatureTour",async()=>{try{await t().showFeatureTour(),e.info("Feature tour opened")}catch(i){e.error("Failed to show feature tour",i),te.window.showErrorMessage(`Failed to show feature tour: ${i.message}`)}})),o.push(te.commands.registerCommand("explorerDates.showQuickSetup",async()=>{try{await t().showQuickSetupWizard(),e.info("Quick setup wizard opened")}catch(i){e.error("Failed to show quick setup wizard",i),te.window.showErrorMessage(`Failed to show quick setup wizard: ${i.message}`)}})),o.push(te.commands.registerCommand("explorerDates.showWhatsNew",async()=>{try{let i=a.extension.packageJSON.version;await t().showWhatsNew(i),e.info("What's new panel opened")}catch(i){e.error("Failed to show what's new",i),te.window.showErrorMessage(`Failed to show what's new: ${i.message}`)}})),o.forEach(i=>a.subscriptions.push(i))}d(ni,"registerOnboardingCommands");qt.exports={registerOnboardingCommands:ni}});var Jt=S((ps,Kt)=>{var _=require("vscode"),{getLogger:ci}=P(),{getLocalization:li}=re(),Je=class Je{constructor(e){this._context=e,this._logger=ci(),this._l10n=li(),this._hasShownWelcome=e.globalState.get("explorerDates.hasShownWelcome",!1),this._hasCompletedSetup=e.globalState.get("explorerDates.hasCompletedSetup",!1),this._onboardingVersion=e.globalState.get("explorerDates.onboardingVersion","0.0.0"),this._logger.info("OnboardingManager initialized",{hasShownWelcome:this._hasShownWelcome,hasCompletedSetup:this._hasCompletedSetup,onboardingVersion:this._onboardingVersion})}async shouldShowOnboarding(){let e=this._context.extension.packageJSON.version;return!this._hasShownWelcome||!this._hasCompletedSetup||this._shouldShowVersionUpdate(e)}_shouldShowVersionUpdate(e){if(this._onboardingVersion==="0.0.0")return!0;let[t]=e.split(".").map(Number),[o]=this._onboardingVersion.split(".").map(Number);return t>o}_isMinorUpdate(e){if(this._onboardingVersion==="0.0.0")return!1;let[t,o]=e.split(".").map(Number),[i,s]=this._onboardingVersion.split(".").map(Number);return t===i&&o>s}async showWelcomeMessage(){try{let e=this._context.extension.packageJSON.version,t=this._hasShownWelcome,o=this._isMinorUpdate(e);if(o)return this._showGentleUpdateNotification(e);let i=t?`Explorer Dates has been updated to v${e} with new features and improvements!`:"See file modification dates right in VS Code Explorer with intuitive time badges, file sizes, Git info, and much more!",s=t?["\u{1F4D6} What's New","\u2699\uFE0F Settings","Dismiss"]:["\u{1F680} Quick Setup","\u{1F4D6} Feature Tour","\u2699\uFE0F Settings","Maybe Later"],r=await _.window.showInformationMessage(i,{modal:!1},...s);switch(await this._context.globalState.update("explorerDates.hasShownWelcome",!0),await this._context.globalState.update("explorerDates.onboardingVersion",e),r){case"\u{1F680} Quick Setup":await this.showQuickSetupWizard();break;case"\u{1F4D6} Feature Tour":await this.showFeatureTour();break;case"\u{1F4D6} What's New":await this.showWhatsNew(e);break;case"\u2699\uFE0F Settings":await _.commands.executeCommand("workbench.action.openSettings","explorerDates");break;case"previewConfiguration":await _.commands.executeCommand("explorerDates.previewConfiguration",i.settings);break;case"clearPreview":await _.commands.executeCommand("explorerDates.clearPreview");break}this._logger.info("Welcome message shown",{action:r,isUpdate:t,isMinorUpdate:o})}catch(e){this._logger.error("Failed to show welcome message",e)}}async _showGentleUpdateNotification(e){let t=_.window.createStatusBarItem(_.StatusBarAlignment.Right,100);t.text=`$(check) Explorer Dates updated to v${e}`,t.tooltip="Click to see what's new in Explorer Dates",t.command="explorerDates.showWhatsNew",t.show(),setTimeout(()=>{t.dispose()},1e4),await this._context.globalState.update("explorerDates.onboardingVersion",e),this._logger.info("Showed gentle update notification",{version:e})}async showQuickSetupWizard(){try{let e=_.window.createWebviewPanel("explorerDatesSetup","Explorer Dates Quick Setup",_.ViewColumn.One,{enableScripts:!0,retainContextWhenHidden:!0});e.webview.html=this._generateSetupWizardHTML(),e.webview.onDidReceiveMessage(async t=>{await this._handleSetupWizardMessage(t,e)}),this._logger.info("Quick setup wizard opened")}catch(e){this._logger.error("Failed to show setup wizard",e)}}async _handleSetupWizardMessage(e,t){try{switch(e.command){case"applyConfiguration":await this._applyQuickConfiguration(e.configuration),await this._context.globalState.update("explorerDates.hasCompletedSetup",!0),_.window.showInformationMessage("\u2705 Explorer Dates configured successfully!"),t.dispose();break;case"previewConfiguration":e.settings&&(await _.commands.executeCommand("explorerDates.previewConfiguration",e.settings),this._logger.info("Configuration preview applied via webview",e.settings));break;case"clearPreview":await _.commands.executeCommand("explorerDates.clearPreview"),this._logger.info("Configuration preview cleared via webview");break;case"skipSetup":await this._context.globalState.update("explorerDates.hasCompletedSetup",!0),t.dispose();break;case"openSettings":await _.commands.executeCommand("workbench.action.openSettings","explorerDates"),t.dispose();break}}catch(o){this._logger.error("Failed to handle setup wizard message",o)}}async _applyQuickConfiguration(e){let t=_.workspace.getConfiguration("explorerDates");if(e.preset){let i=this._getConfigurationPresets()[e.preset];if(i){this._logger.info(`Applying preset: ${e.preset}`,i.settings);for(let[s,r]of Object.entries(i.settings))await t.update(s,r,_.ConfigurationTarget.Global),this._logger.debug(`Updated setting: explorerDates.${s} = ${r}`);this._logger.info(`Applied preset: ${e.preset}`,i.settings),_.window.showInformationMessage(`Applied "${i.name}" configuration. Changes should be visible immediately!`)}}if(e.individual){for(let[o,i]of Object.entries(e.individual))await t.update(o,i,_.ConfigurationTarget.Global);this._logger.info("Applied individual settings",e.individual)}try{await _.commands.executeCommand("explorerDates.refreshDateDecorations"),this._logger.info("Decorations refreshed after configuration change")}catch(o){this._logger.warn("Failed to refresh decorations after configuration change",o)}}_getConfigurationPresets(){return{minimal:{name:"Minimal",description:"Clean and simple - just show modification times in short format",settings:{dateDecorationFormat:"relative-short",colorScheme:"none",highContrastMode:!1,showFileSize:!1,showGitInfo:"none",badgePriority:"time",fadeOldFiles:!1,enableContextMenu:!1,showStatusBar:!1}},developer:{name:"Developer",description:"Perfect for development - includes Git info, file sizes, and color coding",settings:{dateDecorationFormat:"smart",colorScheme:"recency",highContrastMode:!1,showFileSize:!0,fileSizeFormat:"auto",showGitInfo:"author",badgePriority:"time",fadeOldFiles:!0,fadeThreshold:30,enableContextMenu:!0,showStatusBar:!0}},powerUser:{name:"Power User",description:"Maximum information - all features enabled with vibrant colors",settings:{dateDecorationFormat:"smart",colorScheme:"vibrant",highContrastMode:!1,showFileSize:!0,fileSizeFormat:"auto",showGitInfo:"both",badgePriority:"time",fadeOldFiles:!0,fadeThreshold:14,enableContextMenu:!0,showStatusBar:!0,smartExclusions:!0,progressiveLoading:!0,persistentCache:!0}},gitFocused:{name:"Git-Focused",description:"Show author initials as badges with full Git information in tooltips",settings:{dateDecorationFormat:"smart",colorScheme:"file-type",highContrastMode:!1,showFileSize:!1,showGitInfo:"both",badgePriority:"author",fadeOldFiles:!1,enableContextMenu:!0,showStatusBar:!0}},accessible:{name:"Accessible",description:"High contrast and screen reader friendly with detailed tooltips",settings:{dateDecorationFormat:"relative-short",colorScheme:"none",highContrastMode:!0,accessibilityMode:!0,showFileSize:!1,showGitInfo:"none",badgePriority:"time",fadeOldFiles:!1,enableContextMenu:!0,keyboardNavigation:!0}}}}async showFeatureTour(){try{let e=_.window.createWebviewPanel("explorerDatesFeatureTour","Explorer Dates Feature Tour",_.ViewColumn.One,{enableScripts:!0,retainContextWhenHidden:!0});e.webview.html=this._generateFeatureTourHTML(),e.webview.onDidReceiveMessage(async t=>{t.command==="openSettings"?await _.commands.executeCommand("workbench.action.openSettings",t.setting||"explorerDates"):t.command==="runCommand"&&await _.commands.executeCommand(t.commandId)}),this._logger.info("Feature tour opened")}catch(e){this._logger.error("Failed to show feature tour",e)}}_generateSetupWizardHTML(){let e=this._getConfigurationPresets(),t={minimal:e.minimal,developer:e.developer,accessible:e.accessible};return`
            <!DOCTYPE html>
            <html>
            <head>
                <meta charset="UTF-8">
...
${t.description}`;await _.window.showInformationMessage(o,"Show More Tips","Got it!")==="Show More Tips"&&await this.showFeatureTour()}async showWhatsNew(e){try{let t=_.window.createWebviewPanel("explorerDatesWhatsNew",`Explorer Dates v${e} - What's New`,_.ViewColumn.One,{enableScripts:!0,retainContextWhenHidden:!1});t.webview.html=this._generateWhatsNewHTML(e),t.webview.onDidReceiveMessage(async o=>{switch(o.command){case"openSettings":await _.commands.executeCommand("workbench.action.openSettings","explorerDates"),t.dispose();break;case"tryFeature":o.feature==="badgePriority"&&(await _.workspace.getConfiguration("explorerDates").update("badgePriority","author",_.ConfigurationTarget.Global),_.window.showInformationMessage("Badge priority set to author! You should see author initials on files now."));break;case"dismiss":t.dispose();break}})}catch(t){this._logger.error("Failed to show what's new",t)}}_generateWhatsNewHTML(e){return`
        ...
        </html>`}};d(Ye,"WorkspaceTemplatesManager");var Qe=Ye;Qt.exports={WorkspaceTemplatesManager:Qe}});var Xt=S((vs,Zt)=>{var z=require("vscode"),{getLogger:gi}=P(),et=class et{constructor(){this._listeners=new Map}on(e,t){let o=this._listeners.get(e)||[];return o.push(t),this._listeners.set(e,o),this}off(e,t){let o=this._listeners.get(e);if(!o)return this;let i=o.indexOf(t);return i!==-1&&o.splice(i,1),this}emit(e,...t){let o=this._listeners.get(e);return o&&o.slice().forEach(i=>{try{i(...t)}catch{}}),this}};d(et,"BaseEventEmitter");var Ze=et,T=gi(),tt=class tt extends Ze{constructor(){super(),this.plugins=new Map,this.api=null,this.decorationProviders=new Map,this._configurationWatcher=null,this.initialize(),this._setupConfigurationListener()}initialize(){this.api=this.createPublicApi(),T.info("Extension API Manager initialized")}createPublicApi(){return{getFileDecorations:this.getFileDecorations.bind(this),refreshDecorations:this.refreshDecorations.bind(this),registerPlugin:this.registerPlugin.bind(this),unregisterPlugin:this.unregisterPlugin.bind(this),registerDecorationProvider:this.registerDecorationProvider.bind(this),unregisterDecorationProvider:this.unregisterDecorationProvider.bind(this),onDecorationChanged:this.onDecorationChanged.bind(this),onFileScanned:this.onFileScanned.bind(this),formatDate:this.formatDate.bind(this),getFileStats:this.getFileStats.bind(this),version:"1.1.0",apiVersion:"1.0.0"}}async getFileDecorations(e){if(!this._isApiUsable("getFileDecorations"))return[];try{let t=[];for(let o of e){let i=z.Uri.file(o),s=await this.getDecorationForFile(i);s&&t.push({uri:i.toString(),decoration:s})}return t}catch(t){return T.error("Failed to get file decorations:",t),[]}}async getDecorationForFile(e){if(!this._isApiUsable("getDecorationForFile"))return null;try{let t=await z.workspace.fs.stat(e),o=new Date(t.mtime),i={badge:this.formatDate(o,"smart"),color:void 0,tooltip:`Modified: ${o.toLocaleString()}`};for(let[s,r]of this.decorationProviders)try{let n=await r.provideDecoration(e,t,i);n&&(i={...i,...n})}catch(n){T.error(`Decoration provider ${s} failed:`,n)}return i}catch(t){return T.error("Failed to get decoration for file:",t),null}}async refreshDecorations(e=null){if(!this._isApiUsable("refreshDecorations"))return!1;try{return this.emit("decorationRefreshRequested",e),T.info("Decoration refresh requested"),!0}catch(t){return T.error("Failed to refresh decorations:",t),!1}}registerPlugin(e,t){if(!this._canUsePlugins(`registerPlugin:${e}`))return!1;try{if(!this.validatePlugin(t))throw new Error("Invalid plugin structure");return this.plugins.set(e,{...t,registeredAt:new Date,active:!0}),typeof t.activate=="function"&&t.activate(this.api),this.emit("pluginRegistered",{pluginId:e,plugin:t}),T.info(`Plugin registered: ${e}`),!0}catch(o){return T.error(`Failed to register plugin ${e}:`,o),!1}}unregisterPlugin(e){if(!this._canUsePlugins(`unregisterPlugin:${e}`))return!1;try{let t=this.plugins.get(e);return t?(typeof t.deactivate=="function"&&t.deactivate(),this.plugins.delete(e),this.emit("pluginUnregistered",{pluginId:e}),T.info(`Plugin unregistered: ${e}`),!0):!1}catch(t){return T.error(`Failed to unregister plugin ${e}:`,t),!1}}registerDecorationProvider(e,t){if(!this._canUsePlugins(`registerDecorationProvider:${e}`))return!1;try{if(!this.validateDecorationProvider(t))throw new Error("Invalid decoration provider");return this.decorationProviders.set(e,t),this.emit("decorationProviderRegistered",{providerId:e,provider:t}),T.info(`Decoration provider registered: ${e}`),!0}catch(o){return T.error(`Failed to register decoration provider ${e}:`,o),!1}}unregisterDecorationProvider(e){if(!this._canUsePlugins(`unregisterDecorationProvider:${e}`))return!1;try{let t=this.decorationProviders.delete(e);return t&&(this.emit("decorationProviderUnregistered",{providerId:e}),T.info(`Decoration provider unregistered: ${e}`)),t}catch(t){return T.error(`Failed to unregister decoration provider ${e}:`,t),!1}}onDecorationChanged(e){return this.on("decorationChanged",e),()=>this.off("decorationChanged",e)}onFileScanned(e){return this.on("fileScanned",e),()=>this.off("fileScanned",e)}formatDate(e,t=null){if(!this._isApiUsable("formatDate"))return"";try{let o=z.workspace.getConfiguration("explorerDates"),i=t||o.get("displayFormat","smart"),r=new Date-e,n=Math.floor(r/(1e3*60*60*24));switch(i){case"relative-short":return this.getRelativeTimeShort(r);case"relative-long":return this.getRelativeTimeLong(r);case"absolute-short":return e.toLocaleDateString("en-US",{month:"short",day:"numeric"});case"absolute-long":return e.toLocaleDateString("en-US",{year:"numeric",month:"long",day:"numeric"});case"smart":default:return n<7?this.getRelativeTimeShort(r):e.toLocaleDateString("en-US",{month:"short",day:"numeric"})}}catch(o){return T.error("Failed to format date:",o),e.toLocaleDateString()}}async getFileStats(e){if(!this._isApiUsable("getFileStats"))return null;try{let t=z.Uri.file(e),o=await z.workspace.fs.stat(t);return{path:e,size:o.size,created:new Date(o.ctime),modified:new Date(o.mtime),type:o.type===z.FileType.Directory?"directory":"file"}}catch(t){return T.error("Failed to get file stats:",t),null}}getApi(){return this.api}getRegisteredPlugins(){let e=[];for(let[t,o]of this.plugins)e.push({id:t,name:o.name,version:o.version,author:o.author,active:o.active,registeredAt:o.registeredAt});return e}validatePlugin(e){return!(!e||typeof e!="object"||!e.name||!e.version||e.activate&&typeof e.activate!="function"||e.deactivate&&typeof e.deactivate!="function")}validateDecorationProvider(e){return!(!e||typeof e!="object"||typeof e.provideDecoration!="function")}getRelativeTimeShort(e){let t=Math.floor(e/1e3),o=Math.floor(t/60),i=Math.floor(o/60),s=Math.floor(i/24);if(t<60)return`${t}s`;if(o<60)return`${o}m`;if(i<24)return`${i}h`;if(s<30)return`${s}d`;let r=Math.floor(s/30);return r<12?`${r}mo`:`${Math.floor(r/12)}y`}getRelativeTimeLong(e){let t=Math.floor(e/1e3),o=Math.floor(t/60),i=Math.floor(o/60),s=Math.floor(i/24);if(t<60)return`${t} second${t!==1?"s":""} ago`;if(o<60)return`${o} minute${o!==1?"s":""} ago`;if(i<24)return`${i} hour${i!==1?"s":""} ago`;if(s<30)return`${s} day${s!==1?"s":""} ago`;let r=Math.floor(s/30);if(r<12)return`${r} month${r!==1?"s":""} ago`;let n=Math.floor(r/12);return`${n} year${n!==1?"s":""} ago`}getColorForAge(e){if(!z.workspace.getConfiguration("explorerDates").get("colorCoding",!1))return;let s=(new Date-e)/(1e3*60*60);return s<1?new z.ThemeColor("charts.green"):s<24?new z.ThemeColor("charts.yellow"):s<168?new z.ThemeColor("charts.orange"):new z.ThemeColor("charts.red")}createExamplePlugin(){return{name:"File Size Display",version:"1.0.0",author:"Explorer Dates",description:"Adds file size to decorations",activate:d(e=>{e.registerDecorationProvider("fileSize",{provideDecoration:d(async(t,o,i)=>{let s=this.formatFileSize(o.size);return{badge:`${i.badge} \u2022 ${s}`,tooltip:`${i.tooltip}
Size: ${s}`}},"provideDecoration")})},"activate"),deactivate:d(()=>{},"deactivate")}}_setupConfigurationListener(){this._configurationWatcher&&this._configurationWatcher.dispose(),this._configurationWatcher=z.workspace.onDidChangeConfiguration(e=>{(e.affectsConfiguration("explorerDates.enableExtensionApi")||e.affectsConfiguration("explorerDates.allowExternalPlugins"))&&T.info("Explorer Dates API configuration changed",{apiEnabled:this._isApiEnabled(),externalPluginsAllowed:this._allowsExternalPlugins()})})}_isApiEnabled(){return z.workspace.getConfiguration("explorerDates").get("enableExtensionApi",!0)}_allowsExternalPlugins(){return z.workspace.getConfiguration("explorerDates").get("allowExternalPlugins",!0)}_isApiUsable(e){return this._isApiEnabled()?!0:(T.warn(`Explorer Dates API request "${e}" ignored because enableExtensionApi is disabled.`),!1)}_canUsePlugins(e){return this._isApiUsable(e)?this._allowsExternalPlugins()?!0:(T.warn(`Explorer Dates plugin request "${e}" ignored because allowExternalPlugins is disabled.`),!1):!1}formatFileSize(e){if(e===0)return"0 B";let t=1024,o=["B","KB","MB","GB"],i=Math.floor(Math.log(e)/Math.log(t));return parseFloat((e/Math.pow(t,i)).toFixed(1))+" "+o[i]}dispose(){this._configurationWatcher&&(this._configurationWatcher.dispose(),this._configurationWatcher=null),this.plugins.clear(),this.decorationProviders.clear(),T.info("Extension API Manager disposed")}};d(tt,"ExtensionApiManager");var Xe=tt;Zt.exports={ExtensionApiManager:Xe}});var to=S((ys,eo)=>{var x=require("vscode"),{getLogger:pi}=P(),{fileSystem:fi}=U(),{getExtension:ot,normalizePath:mi}=B(),W=pi(),wi=!1,st=class st{constructor(){this.fileActivityCache=new Map,this.allowedFormats=["json","csv","html","markdown"],this.activityTrackingDays=30,this.activityCutoffMs=null,this.timeTrackingIntegration="none",this._configurationWatcher=null,this._fileWatcher=null,this._fileWatcherSubscriptions=[],this._loadConfiguration(),this._setupConfigurationWatcher(),this.initialize()}_loadConfiguration(){try{let e=x.workspace.getConfiguration("explorerDates"),t=e.get("reportFormats",["json","html"]),o=["json","csv","html","markdown"];this.allowedFormats=Array.from(new Set([...t,...o]));let i=e.get("activityTrackingDays",30);this.activityTrackingDays=Math.max(1,Math.min(365,i)),this.activityCutoffMs=this.activityTrackingDays*24*60*60*1e3,this.timeTrackingIntegration=e.get("timeTrackingIntegration","none")}catch(e){W.error("Failed to load reporting configuration",e)}}_setupConfigurationWatcher(){this._configurationWatcher&&this._configurationWatcher.dispose(),this._configurationWatcher=x.workspace.onDidChangeConfiguration(e=>{(e.affectsConfiguration("explorerDates.reportFormats")||e.affectsConfiguration("explorerDates.activityTrackingDays")||e.affectsConfiguration("explorerDates.timeTrackingIntegration"))&&(this._loadConfiguration(),W.info("Reporting configuration updated",{allowedFormats:this.allowedFormats,activityTrackingDays:this.activityTrackingDays,timeTrackingIntegration:this.timeTrackingIntegration}))})}async initialize(){try{this.startFileWatcher(),W.info("Export & Reporting Manager initialized")}catch(e){W.error("Failed to initialize Export & Reporting Manager:",e)}}startFileWatcher(){if(this._fileWatcher)return;let e=x.workspace.createFileSystemWatcher("**/*");this._fileWatcher=e,this._fileWatcherSubscriptions=[e.onDidChange(t=>this.recordFileActivity(t,"modified")),e.onDidCreate(t=>this.recordFileActivity(t,"created")),e.onDidDelete(t=>this.recordFileActivity(t,"deleted"))]}recordFileActivity(e,t){try{let o=e.fsPath||e.path,i=new Date;this.fileActivityCache.has(o)||this.fileActivityCache.set(o,[]),this.fileActivityCache.get(o).push({action:t,timestamp:i,path:o}),this._enforceActivityRetention(o)}catch(o){W.error("Failed to record file activity:",o)}}_enforceActivityRetention(e){let t=this.fileActivityCache.get(e);if(!(!t||t.length===0)){if(this.activityCutoffMs){let o=new Date(Date.now()-this.activityCutoffMs);for(;t.length&&t[0].timestamp<o;)t.shift()}t.length>100&&t.splice(0,t.length-100)}}async generateFileModificationReport(e={}){try{let{format:t="json",timeRange:o="all",includeDeleted:i=!1,outputPath:s=null}=e;if(!this.allowedFormats.includes(t)){let l=`Report format "${t}" is disabled. Allowed formats: ${this.allowedFormats.join(", ")}`;return x.window.showWarningMessage(l),W.warn(l),null}let r=await this.collectFileData(o,i),n=await this.formatReport(r,t);return s&&(await this.saveReport(n,s),x.window.showInformationMessage(`Report saved to ${s}`)),n}catch(t){return W.error("Failed to generate file modification report:",t),x.window.showErrorMessage("Failed to generate report"),null}}async collectFileData(e,t){let o=[],i=x.workspace.workspaceFolders;if(!i)return{files:[],summary:this.createSummary([])};for(let r of i){let n=await this.scanWorkspaceFolder(r.uri,e,t);o.push(...n)}let s=this.createSummary(o);return s.integrationTarget=this.timeTrackingIntegration,s.activityTrackingDays=this.activityTrackingDays,{generatedAt:new Date().toISOString(),workspace:i.map(r=>r.uri.fsPath),timeRange:e,files:o,summary:s}}async scanWorkspaceFolder(e,t,o){let i=[],r=x.workspace.getConfiguration("explorerDates").get("excludedPatterns",[]);try{let n=await x.workspace.fs.readDirectory(e);for(let[l,c]of n){let h=x.Uri.joinPath(e,l),u=x.workspace.asRelativePath(h);if(!this.isExcluded(u,r)){if(c===x.FileType.File){let f=await this.getFileData(h,t);f&&i.push(f)}else if(c===x.FileType.Directory){let f=await this.scanWorkspaceFolder(h,t,o);i.push(...f)}}}if(o&&e.fsPath){let l=this.getDeletedFiles(e.fsPath,t);i.push(...l)}}catch(n){W.error(`Failed to scan folder ${e.fsPath||e.path}:`,n)}return i}async getFileData(e,t){try{let o=await x.workspace.fs.stat(e),i=x.workspace.asRelativePath(e),s=e.fsPath||e.path,r=this.fileActivityCache.get(s)||[],n=this.filterActivitiesByTimeRange(r,t);return{path:i,fullPath:s,size:o.size,created:new Date(o.ctime),modified:new Date(o.mtime),type:this.getFileType(i),extension:ot(i),activities:n,activityCount:n.length,lastActivity:n.length>0?n[n.length-1].timestamp:new Date(o.mtime)}}catch(o){return W.error(`Failed to get file data for ${e.fsPath||e.path}:`,o),null}}filterActivitiesByTimeRange(e,t){let o=e;if(t!=="all"){let i=new Date,s;switch(t){case"24h":s=new Date(i-1440*60*1e3);break;case"7d":s=new Date(i-10080*60*1e3);break;case"30d":s=new Date(i-720*60*60*1e3);break;case"90d":s=new Date(i-2160*60*60*1e3);break;default:s=null}s&&(o=o.filter(r=>r.timestamp>=s))}if(this.activityCutoffMs){let i=new Date(Date.now()-this.activityCutoffMs);o=o.filter(s=>s.timestamp>=i)}return o}getDeletedFiles(e,t){if(!e)return[];let o=[];for(let[i,s]of this.fileActivityCache)if(i.startsWith(e)){let r=s.filter(l=>l.action==="deleted"),n=this.filterActivitiesByTimeRange(r,t);n.length>0&&o.push({path:x.workspace.asRelativePath(i),fullPath:i,size:0,created:null,modified:null,type:"deleted",extension:ot(i),activities:n,activityCount:n.length,lastActivity:n[n.length-1].timestamp})}return o}createSummary(e){let t={totalFiles:e.length,totalSize:e.reduce((i,s)=>i+(s.size||0),0),fileTypes:{},activityByDay:{},mostActiveFiles:[],recentlyModified:[],largestFiles:[],oldestFiles:[]};e.forEach(i=>{let s=i.type||"unknown";t.fileTypes[s]=(t.fileTypes[s]||0)+1});let o=new Date(Date.now()-this.activityTrackingDays*24*60*60*1e3);return e.forEach(i=>{i.activities.forEach(s=>{if(s.timestamp>=o){let r=s.timestamp.toISOString().split("T")[0];t.activityByDay[r]=(t.activityByDay[r]||0)+1}})}),t.mostActiveFiles=e.sort((i,s)=>s.activityCount-i.activityCount).slice(0,10).map(i=>({path:i.path,activityCount:i.activityCount,lastActivity:i.lastActivity})),t.recentlyModified=e.filter(i=>i.modified).sort((i,s)=>s.modified-i.modified).slice(0,20).map(i=>({path:i.path,modified:i.modified,size:i.size})),t.largestFiles=e.sort((i,s)=>(s.size||0)-(i.size||0)).slice(0,10).map(i=>({path:i.path,size:i.size,modified:i.modified})),t.oldestFiles=e.filter(i=>i.modified).sort((i,s)=>i.modified-s.modified).slice(0,10).map(i=>({path:i.path,modified:i.modified,size:i.size})),t}async formatReport(e,t){switch(t.toLowerCase()){case"json":return JSON.stringify(e,null,2);case"csv":return this.formatAsCSV(e);case"html":return this.formatAsHTML(e);case"markdown":return this.formatAsMarkdown(e);default:throw new Error(`Unsupported format: ${t}`)}}formatAsCSV(e){let t=["Path,Size,Created,Modified,Type,Extension,ActivityCount,LastActivity"];return e.files.forEach(o=>{t.push([o.path,o.size||0,o.created?o.created.toISOString():"",o.modified?o.modified.toISOString():"",o.type,o.extension,o.activityCount,o.lastActivity?o.lastActivity.toISOString():""].join(","))}),t.join(`
...
explorerDatesApi.registerPlugin('myPlugin', myPlugin);
    ...
    </html>`}d(Si,"getApiInformationHtml");function Fi(a){let e=d(o=>{if(o<1024)return`${o} B`;let i=o/1024;return i<1024?`${i.toFixed(1)} KB`:`${(i/1024).toFixed(1)} MB`},"formatFileSize"),t=a.map(o=>`
        <tr>
            <td>${o.path}</td>
    ...
    `}d(Fi,"generateWorkspaceActivityHTML");function Ti(a){return`
        <!DOCTYPE html>
        <html>
        <head>
            <meta charset="UTF-8">
    ...
    `}d(Ti,"generateDiagnosticsHTML");function ki(a){return`<!DOCTYPE html>
    <html>
    <head>
        <meta charset="UTF-8">
    ...
    </html>`}d(ki,"generateDiagnosticsWebview");function $i(a){let e=d(t=>{if(t===0)return"0 B";let o=1024,i=["B","KB","MB","GB"],s=Math.floor(Math.log(t)/Math.log(o));return parseFloat((t/Math.pow(o,s)).toFixed(2))+" "+i[s]},"formatBytes");return`
        <!DOCTYPE html>
        <html>
        <head>
            <meta charset="UTF-8">
    ...
    `}d($i,"generatePerformanceAnalyticsHTML");function oo(a){let e=b.window.createStatusBarItem(b.StatusBarAlignment.Right,100);e.command="explorerDates.showFileDetails",e.tooltip="Click to show detailed file information";let t=d(async()=>{try{let o=b.window.activeTextEditor;if(!o){e.hide();return}let i=o.document.uri;if(i.scheme!=="file"){e.hide();return}let s=await _i.stat(i),r=s.mtime instanceof Date?s.mtime:new Date(s.mtime),n=N._formatDateBadge(r,"smart"),l=N._formatFileSize(s.size,"auto");e.text=`$(clock) ${n} $(file) ${l}`,e.show()}catch(o){e.hide(),D.debug("Failed to update status bar",o)}},"updateStatusBar");return b.window.onDidChangeActiveTextEditor(t),b.window.onDidChangeTextEditorSelection(t),t(),a.subscriptions.push(e),e}d(oo,"initializeStatusBar");async function Mi(a){try{D=bi(),ce=yi(),a.subscriptions.push(ce),D.info("Explorer Dates: Extension activated");let e=b.env.uiKind===b.UIKind.Web;await b.commands.executeCommand("setContext","explorerDates.gitFeaturesAvailable",!e);let t=b.workspace.getConfiguration("explorerDates"),o=t.get("enableWorkspaceTemplates",!0),i=t.get("enableReporting",!0),s=t.get("enableExtensionApi",!0);N=new vi;let r=b.window.registerFileDecorationProvider(N);a.subscriptions.push(r),a.subscriptions.push(N),a.subscriptions.push(D),await N.initializeAdvancedSystems(a);let n=null,l=null,c=null,h=null,u=d(()=>{if(!n){let{OnboardingManager:y}=Jt();n=new y(a)}return n},"getOnboardingManager"),f=d(()=>{if(!o)throw new Error("Workspace templates are disabled via explorerDates.enableWorkspaceTemplates");if(!l){let{WorkspaceTemplatesManager:y}=Yt();l=new y(a)}return l},"getWorkspaceTemplatesManager"),g=d(()=>{if(!c){let{ExtensionApiManager:y}=Xt();c=new y,a.subscriptions.push(c)}return c},"getExtensionApiManager"),v=d(()=>{if(!i)throw new Error("Reporting is disabled via explorerDates.enableReporting");if(!h){let{ExportReportingManager:y}=to();h=new y,a.subscriptions.push(h)}return h},"getExportReportingManager"),F=d(()=>g().getApi(),"apiFactory");s?a.exports=F:(a.exports=void 0,D.info("Explorer Dates API exports disabled via explorerDates.enableExtensionApi")),b.workspace.getConfiguration("explorerDates").get("showWelcomeOnStartup",!0)&&await u().shouldShowOnboarding()&&setTimeout(()=>{u().showWelcomeMessage()},5e3),Ci({context:a,fileDateProvider:N,logger:D,l10n:ce}),xi({context:a,fileDateProvider:N,logger:D,generators:{generateWorkspaceActivityHTML:Fi,generatePerformanceAnalyticsHTML:$i,generateDiagnosticsHTML:Ti,generateDiagnosticsWebview:ki}}),Di({context:a,logger:D,getOnboardingManager:u});let Z=b.commands.registerCommand("explorerDates.openTemplateManager",async()=>{try{if(!o){b.window.showInformationMessage("Workspace templates are disabled. Enable explorerDates.enableWorkspaceTemplates to use this command.");return}await f().showTemplateManager(),D.info("Template manager opened")}catch(y){D.error("Failed to open template manager",y),b.window.showErrorMessage(`Failed to open template manager: ${y.message}`)}});a.subscriptions.push(Z);let _e=b.commands.registerCommand("explorerDates.saveTemplate",async()=>{try{if(!o){b.window.showInformationMessage("Workspace templates are disabled. Enable explorerDates.enableWorkspaceTemplates to save templates.");return}let y=await b.window.showInputBox({prompt:"Enter template name",placeHolder:"e.g., My Project Setup"});if(y){let X=await b.window.showInputBox({prompt:"Enter description (optional)",placeHolder:"Brief description of this template"})||"";await f().saveCurrentConfiguration(y,X)}D.info("Template saved")}catch(y){D.error("Failed to save template",y),b.window.showErrorMessage(`Failed to save template: ${y.message}`)}});a.subscriptions.push(_e);let le=b.commands.registerCommand("explorerDates.generateReport",async()=>{try{if(!i){b.window.showInformationMessage("Reporting features are disabled. Enable explorerDates.enableReporting to generate reports.");return}await v().showReportDialog(),D.info("Report generation started")}catch(y){D.error("Failed to generate report",y),b.window.showErrorMessage(`Failed to generate report: ${y.message}`)}});a.subscriptions.push(le);let oe=b.commands.registerCommand("explorerDates.showApiInfo",async()=>{try{if(!s){b.window.showInformationMessage("Explorer Dates API is disabled via settings.");return}let y=b.window.createWebviewPanel("apiInfo","Explorer Dates API Information",b.ViewColumn.One,{enableScripts:!0});y.webview.html=Si(F()),D.info("API information panel opened")}catch(y){D.error("Failed to show API information",y),b.window.showErrorMessage(`Failed to show API information: ${y.message}`)}});a.subscriptions.push(oe);let G,O=b.workspace.getConfiguration("explorerDates"),de=O.get("performanceMode",!1);O.get("showStatusBar",!1)&&!de&&(G=oo(a));let he=b.workspace.onDidChangeConfiguration(y=>{if(y.affectsConfiguration("explorerDates.showStatusBar")||y.affectsConfiguration("explorerDates.performanceMode")){let X=b.workspace.getConfiguration("explorerDates"),Ce=X.get("showStatusBar",!1),ue=X.get("performanceMode",!1),q=Ce&&!ue;q&&!G?G=oo(a):!q&&G&&(G.dispose(),G=null)}});a.subscriptions.push(he),D.info("Explorer Dates: Date decorations ready")}catch(e){let t=`${ce?ce.getString("activationError"):"Explorer Dates failed to activate"}: ${e.message}`;throw D&&D.error("Extension activation failed",e),b.window.showErrorMessage(t),e}}d(Mi,"activate");async function Ei(){try{D&&D.info("Explorer Dates extension is being deactivated"),N&&typeof N.dispose=="function"&&await N.dispose(),D&&D.info("Explorer Dates extension deactivated successfully")}catch(a){D&&D.error("Explorer Dates: Error during deactivation",a)}}d(Ei,"deactivate");module.exports={activate:Mi,deactivate:Ei};
