var oo=Object.defineProperty;var d=(a,e)=>oo(a,"name",{value:e,configurable:!0});var S=(a,e)=>()=>(e||a((e={exports:{}}).exports,e),e.exports);var A=S((Mi,rt)=>{var ve=require("vscode"),ye=class ye{constructor(){this._outputChannel=ve.window.createOutputChannel("Explorer Dates"),this._isEnabled=!1,this._updateConfig(),ve.workspace.onDidChangeConfiguration(e=>{e.affectsConfiguration("explorerDates.enableLogging")&&this._updateConfig()})}_updateConfig(){let e=ve.workspace.getConfiguration("explorerDates");this._isEnabled=e.get("enableLogging",!1)}debug(e,...t){if(this._isEnabled){let i=`[${new Date().toISOString()}] [DEBUG] ${e}`;this._outputChannel.appendLine(i),t.length>0&&this._outputChannel.appendLine(JSON.stringify(t,null,2))}}info(e,...t){let i=`[${new Date().toISOString()}] [INFO] ${e}`;this._outputChannel.appendLine(i),t.length>0&&this._outputChannel.appendLine(JSON.stringify(t,null,2))}warn(e,...t){let i=`[${new Date().toISOString()}] [WARN] ${e}`;this._outputChannel.appendLine(i),t.length>0&&this._outputChannel.appendLine(JSON.stringify(t,null,2))}error(e,t,...o){let s=`[${new Date().toISOString()}] [ERROR] ${e}`;this._outputChannel.appendLine(s),t instanceof Error&&(this._outputChannel.appendLine(`Error: ${t.message}`),t.stack&&this._outputChannel.appendLine(`Stack: ${t.stack}`)),o.length>0&&this._outputChannel.appendLine(JSON.stringify(o,null,2))}show(){this._outputChannel.show()}clear(){this._outputChannel.clear()}dispose(){this._outputChannel.dispose()}};d(ye,"Logger");var re=ye,be=null;function io(){return be||(be=new re),be}d(io,"getLogger");rt.exports={Logger:re,getLogger:io}});var X=S((Ai,at)=>{var Ce=require("vscode"),ae={en:{now:"now",minutes:"m",hours:"h",days:"d",weeks:"w",months:"mo",years:"y",justNow:"just now",minutesAgo:d(a=>`${a} minute${a!==1?"s":""} ago`,"minutesAgo"),hoursAgo:d(a=>`${a} hour${a!==1?"s":""} ago`,"hoursAgo"),yesterday:"yesterday",daysAgo:d(a=>`${a} day${a!==1?"s":""} ago`,"daysAgo"),lastModified:"Last modified",refreshSuccess:"Date decorations refreshed",activationError:"Explorer Dates failed to activate",errorAccessingFile:"Error accessing file for decoration"},es:{now:"ahora",minutes:"m",hours:"h",days:"d",weeks:"s",months:"m",years:"a",justNow:"ahora mismo",minutesAgo:d(a=>`hace ${a} minuto${a!==1?"s":""}`,"minutesAgo"),hoursAgo:d(a=>`hace ${a} hora${a!==1?"s":""}`,"hoursAgo"),yesterday:"ayer",daysAgo:d(a=>`hace ${a} d\xEDa${a!==1?"s":""}`,"daysAgo"),lastModified:"\xDAltima modificaci\xF3n",refreshSuccess:"Decoraciones de fecha actualizadas",activationError:"Explorer Dates no se pudo activar",errorAccessingFile:"Error al acceder al archivo para decoraci\xF3n"},fr:{now:"maintenant",minutes:"m",hours:"h",days:"j",weeks:"s",months:"m",years:"a",justNow:"\xE0 l'instant",minutesAgo:d(a=>`il y a ${a} minute${a!==1?"s":""}`,"minutesAgo"),hoursAgo:d(a=>`il y a ${a} heure${a!==1?"s":""}`,"hoursAgo"),yesterday:"hier",daysAgo:d(a=>`il y a ${a} jour${a!==1?"s":""}`,"daysAgo"),lastModified:"Derni\xE8re modification",refreshSuccess:"D\xE9corations de date actualis\xE9es",activationError:"\xC9chec de l'activation d'Explorer Dates",errorAccessingFile:"Erreur lors de l'acc\xE8s au fichier pour la d\xE9coration"},de:{now:"jetzt",minutes:"Min",hours:"Std",days:"T",weeks:"W",months:"Mon",years:"J",justNow:"gerade eben",minutesAgo:d(a=>`vor ${a} Minute${a!==1?"n":""}`,"minutesAgo"),hoursAgo:d(a=>`vor ${a} Stunde${a!==1?"n":""}`,"hoursAgo"),yesterday:"gestern",daysAgo:d(a=>`vor ${a} Tag${a!==1?"en":""}`,"daysAgo"),lastModified:"Zuletzt ge\xE4ndert",refreshSuccess:"Datumsdekorationen aktualisiert",activationError:"Explorer Dates konnte nicht aktiviert werden",errorAccessingFile:"Fehler beim Zugriff auf Datei f\xFCr Dekoration"},ja:{now:"\u4ECA",minutes:"\u5206",hours:"\u6642\u9593",days:"\u65E5",weeks:"\u9031",months:"\u30F6\u6708",years:"\u5E74",justNow:"\u305F\u3063\u305F\u4ECA",minutesAgo:d(a=>`${a}\u5206\u524D`,"minutesAgo"),hoursAgo:d(a=>`${a}\u6642\u9593\u524D`,"hoursAgo"),yesterday:"\u6628\u65E5",daysAgo:d(a=>`${a}\u65E5\u524D`,"daysAgo"),lastModified:"\u6700\u7D42\u66F4\u65B0",refreshSuccess:"\u65E5\u4ED8\u88C5\u98FE\u304C\u66F4\u65B0\u3055\u308C\u307E\u3057\u305F",activationError:"Explorer Dates\u306E\u30A2\u30AF\u30C6\u30A3\u30D9\u30FC\u30B7\u30E7\u30F3\u306B\u5931\u6557\u3057\u307E\u3057\u305F",errorAccessingFile:"\u30D5\u30A1\u30A4\u30EB\u30A2\u30AF\u30BB\u30B9\u4E2D\u306B\u30A8\u30E9\u30FC\u304C\u767A\u751F\u3057\u307E\u3057\u305F"},zh:{now:"\u73B0\u5728",minutes:"\u5206\u949F",hours:"\u5C0F\u65F6",days:"\u5929",weeks:"\u5468",months:"\u6708",years:"\u5E74",justNow:"\u521A\u521A",minutesAgo:d(a=>`${a}\u5206\u949F\u524D`,"minutesAgo"),hoursAgo:d(a=>`${a}\u5C0F\u65F6\u524D`,"hoursAgo"),yesterday:"\u6628\u5929",daysAgo:d(a=>`${a}\u5929\u524D`,"daysAgo"),lastModified:"\u6700\u540E\u4FEE\u6539",refreshSuccess:"\u65E5\u671F\u88C5\u9970\u5DF2\u5237\u65B0",activationError:"Explorer Dates \u6FC0\u6D3B\u5931\u8D25",errorAccessingFile:"\u8BBF\u95EE\u6587\u4EF6\u88C5\u9970\u65F6\u51FA\u9519"}},xe=class xe{constructor(){this._currentLocale="en",this._updateLocale(),Ce.workspace.onDidChangeConfiguration(e=>{e.affectsConfiguration("explorerDates.locale")&&this._updateLocale()})}_updateLocale(){let t=Ce.workspace.getConfiguration("explorerDates").get("locale","auto");t==="auto"&&(t=Ce.env.language.split("-")[0]),ae[t]||(t="en"),this._currentLocale=t}getString(e,...t){let i=(ae[this._currentLocale]||ae.en)[e];return typeof i=="function"?i(...t):i||ae.en[e]||e}getCurrentLocale(){return this._currentLocale}formatDate(e,t={}){try{return e.toLocaleDateString(this._currentLocale,t)}catch{return e.toLocaleDateString("en",t)}}};d(xe,"LocalizationManager");var ne=xe,_e=null;function so(){return _e||(_e=new ne),_e}d(so,"getLocalization");at.exports={LocalizationManager:ne,getLocalization:so}});var De=S((Ii,nt)=>{var Q=require("vscode");function ro(){var a,e;try{return((a=Q==null?void 0:Q.env)==null?void 0:a.uiKind)===((e=Q==null?void 0:Q.UIKind)==null?void 0:e.Web)}catch{return!1}}d(ro,"isWebEnvironment");nt.exports={isWebEnvironment:ro}});var B=S((Ri,lt)=>{function K(a=""){return a?a.replace(/\\/g,"/"):""}d(K,"normalizePath");function ao(a=""){let e=K(a);return e?e.split("/").filter(Boolean):[]}d(ao,"getSegments");function ct(a=""){let e=ao(a);return e.length?e[e.length-1]:""}d(ct,"getFileName");function no(a=""){let e=ct(a),t=e.lastIndexOf(".");return t<=0?"":e.substring(t).toLowerCase()}d(no,"getExtension");function co(a=""){let e=K(a),t=e.lastIndexOf("/");return t===-1?"":e.substring(0,t)}d(co,"getDirectory");function lo(...a){return K(a.filter(Boolean).join("/")).replace(/\/+/g,"/")}d(lo,"joinPath");function ho(a=""){return K(a).toLowerCase()}d(ho,"getCacheKey");function uo(a="",e=""){let t=K(a),o=K(e);return t&&o.startsWith(t)?o.substring(t.length).replace(/^\/+/,""):o}d(uo,"getRelativePath");lt.exports={normalizePath:K,getFileName:ct,getExtension:no,getDirectory:co,joinPath:lo,getCacheKey:ho,getRelativePath:uo}});var U=S((Ni,ht)=>{var z=require("vscode"),{isWebEnvironment:go}=De(),{normalizePath:po}=B(),dt=!1,k=null;if(!dt)try{k=require("fs").promises}catch{k=null}var Se=class Se{constructor(){this.isWeb=dt||go()}_toPath(e){return e?typeof e=="string"?e:e instanceof z.Uri?e.fsPath||e.path:String(e):""}_toUri(e){if(e instanceof z.Uri)return e;if(typeof e=="string")return z.Uri.file(e);throw new Error(`Unsupported target type: ${typeof e}`)}async stat(e){if(!this.isWeb&&k)return k.stat(this._toPath(e));let t=this._toUri(e),o=await z.workspace.fs.stat(t);return{...o,mtime:new Date(o.mtime),ctime:new Date(o.ctime),birthtime:new Date(o.ctime),isFile:d(()=>o.type===z.FileType.File,"isFile"),isDirectory:d(()=>o.type===z.FileType.Directory,"isDirectory")}}async readFile(e,t="utf8"){if(!this.isWeb&&k)return k.readFile(this._toPath(e),t);let o=this._toUri(e),i=await z.workspace.fs.readFile(o);return t===null||t==="binary"?i:new TextDecoder(t).decode(i)}async writeFile(e,t,o="utf8"){if(!this.isWeb&&k)return k.writeFile(this._toPath(e),t,o);let i=this._toUri(e),s=typeof t=="string"?new TextEncoder().encode(t):t;await z.workspace.fs.writeFile(i,s)}async mkdir(e,t={recursive:!0}){if(!this.isWeb&&k)return k.mkdir(this._toPath(e),t);let o=this._toUri(e);await z.workspace.fs.createDirectory(o)}async readdir(e,t={withFileTypes:!1}){if(!this.isWeb&&k)return k.readdir(this._toPath(e),t);let o=this._toUri(e),i=await z.workspace.fs.readDirectory(o);return t.withFileTypes?i.map(([s,r])=>({name:s,isDirectory:d(()=>r===z.FileType.Directory,"isDirectory"),isFile:d(()=>r===z.FileType.File,"isFile")})):i.map(([s])=>s)}async delete(e,t={recursive:!1}){if(!this.isWeb&&k){let i=this._toPath(e);return t.recursive?k.rm?k.rm(i,t):k.rmdir(i,t):k.unlink(i)}let o=this._toUri(e);await z.workspace.fs.delete(o,t)}async exists(e){try{return await this.stat(e),!0}catch{return!1}}async ensureDirectory(e){let t=po(this._toPath(e));await this.mkdir(t,{recursive:!0})}};d(Se,"FileSystemAdapter");var ce=Se,mo=new ce;ht.exports={FileSystemAdapter:ce,fileSystem:mo}});var gt=S((Oi,ut)=>{var W=require("vscode"),{getLogger:fo}=A(),{fileSystem:wo}=U(),{normalizePath:Fe,getRelativePath:vo,getFileName:bo}=B(),ke=class ke{constructor(){this._logger=fo(),this._fs=wo,this._commonExclusions=["node_modules",".npm",".yarn","coverage","nyc_output","dist","build","out","target","bin","obj",".vscode",".idea",".vs",".vscode-test",".git",".svn",".hg",".bzr",".pnpm-store","bower_components","jspm_packages","tmp","temp",".tmp",".cache",".parcel-cache",".DS_Store","Thumbs.db","__pycache__",".pytest_cache",".tox","venv",".env",".virtualenv","vendor",".docker","logs","*.log"],this._patternScores=new Map,this._workspaceAnalysis=new Map,this._logger.info("SmartExclusionManager initialized")}async analyzeWorkspace(e){try{let t=Fe((e==null?void 0:e.fsPath)||(e==null?void 0:e.path)||""),o={detectedPatterns:[],suggestedExclusions:[],projectType:"unknown",riskFolders:[]};o.projectType=await this._detectProjectType(e);let i=await this._scanForExclusionCandidates(e,t),s=this._scorePatterns(i,o.projectType);return o.detectedPatterns=i,o.suggestedExclusions=s.filter(r=>r.score>.7).map(r=>r.pattern),o.riskFolders=s.filter(r=>r.riskLevel==="high").map(r=>r.pattern),this._workspaceAnalysis.set(t,o),this._logger.info(`Workspace analysis complete for ${t}`,o),o}catch(t){return this._logger.error("Failed to analyze workspace",t),null}}async _detectProjectType(e){let t=[{file:"package.json",type:"javascript"},{file:"pom.xml",type:"java"},{file:"Cargo.toml",type:"rust"},{file:"setup.py",type:"python"},{file:"requirements.txt",type:"python"},{file:"Gemfile",type:"ruby"},{file:"composer.json",type:"php"},{file:"go.mod",type:"go"},{file:"CMakeLists.txt",type:"cpp"},{file:"Dockerfile",type:"docker"}];if(!e)return"unknown";for(let o of t)try{let i=W.Uri.joinPath(e,o.file);if(await this._fs.exists(i))return o.type}catch{}return"unknown"}async _scanForExclusionCandidates(e,t,o=2){let i=[],s=d(async(r,n=0)=>{if(!(n>o))try{let l=await this._fs.readdir(r,{withFileTypes:!0});for(let c of l)if(c.isDirectory()){let h=W.Uri.joinPath(r,c.name),u=Fe(h.fsPath||h.path),g=vo(t,u);this._commonExclusions.includes(c.name)&&i.push({name:c.name,path:g,type:"common",size:await this._getDirectorySize(h)});let v=await this._getDirectorySize(h);v>10485760&&i.push({name:c.name,path:g,type:"large",size:v}),await s(h,n+1)}}catch{}},"scanDirectory");return await s(e),i}async _getDirectorySize(e){try{let t=await this._fs.readdir(e,{withFileTypes:!0}),o=0,i=0;for(let s of t){if(i>100)break;if(s.isFile())try{let r=W.Uri.joinPath(e,s.name),n=await this._fs.stat(r);o+=n.size,i++}catch{}}return o}catch{return 0}}_scorePatterns(e,t){return e.map(o=>{let i=0,s="low";switch(o.type==="common"&&(i+=.8),o.size>100*1024*1024?(i+=.9,s="high"):o.size>10*1024*1024&&(i+=.5,s="medium"),t){case"javascript":["node_modules",".npm","coverage","dist","build"].includes(o.name)&&(i+=.9);break;case"python":["__pycache__",".pytest_cache","venv",".env"].includes(o.name)&&(i+=.9);break;case"java":["target","build",".gradle"].includes(o.name)&&(i+=.9);break}return["src","lib","app","components","pages"].includes(o.name.toLowerCase())&&(i=0,s="none"),{pattern:o.name,path:o.path,score:Math.min(i,1),riskLevel:s,size:o.size,type:o.type}})}getWorkspaceExclusions(e){let o=W.workspace.getConfiguration("explorerDates").get("workspaceExclusionProfiles",{}),i=this._getWorkspaceKey(e);return o[i]||[]}async saveWorkspaceExclusions(e,t){let o=W.workspace.getConfiguration("explorerDates"),i=o.get("workspaceExclusionProfiles",{}),s=this._getWorkspaceKey(e);i[s]=t,await o.update("workspaceExclusionProfiles",i,W.ConfigurationTarget.Global),this._logger.info(`Saved workspace exclusions for ${s}`,t)}async getCombinedExclusions(e){let t=W.workspace.getConfiguration("explorerDates"),o=t.get("excludedFolders",[]),i=t.get("excludedPatterns",[]),s=t.get("smartExclusions",!0),r=[...o],n=[...i],l=this.getWorkspaceExclusions(e);if(r.push(...l),s){let c=await this.analyzeWorkspace(e);c&&r.push(...c.suggestedExclusions)}return r=[...new Set(r)],n=[...new Set(n)],{folders:r,patterns:n}}_getWorkspaceKey(e){if(!e)return"unknown-workspace";let t=e.fsPath||e.path||"";return bo(t)||Fe(t)}async suggestExclusions(e){let t=await this.analyzeWorkspace(e);if(!t||t.suggestedExclusions.length===0)return;let o=`Found ${t.suggestedExclusions.length} folders that could be excluded for better performance.`,i=await W.window.showInformationMessage(o,"Apply Suggestions","Review","Dismiss");i==="Apply Suggestions"?(await this.saveWorkspaceExclusions(e,t.suggestedExclusions),W.window.showInformationMessage("Smart exclusions applied!")):i==="Review"&&this._showExclusionReview(t)}_showExclusionReview(e){let t=W.window.createWebviewPanel("exclusionReview","Smart Exclusion Review",W.ViewColumn.One,{enableScripts:!0});t.webview.html=this._generateReviewHTML(e)}_generateReviewHTML(e){let t=d(i=>{if(i<1024)return`${i} B`;let s=i/1024;return s<1024?`${s.toFixed(1)} KB`:`${(s/1024).toFixed(1)} MB`},"formatSize"),o=e.detectedPatterns.map(i=>`
            <tr>
                <td>${i.name}</td>
                <td>${i.path}</td>
                <td>${t(i.size)}</td>
...
explorerDatesApi.registerPlugin('myPlugin', myPlugin);
    ...
    </html>`}d(Ci,"getApiInformationHtml");function _i(a){let e=d(o=>{if(o<1024)return`${o} B`;let i=o/1024;return i<1024?`${i.toFixed(1)} KB`:`${(i/1024).toFixed(1)} MB`},"formatFileSize"),t=a.map(o=>`
        <tr>
            <td>${o.path}</td>
    ...
    `}d(_i,"generateWorkspaceActivityHTML");function xi(a){return`
        <!DOCTYPE html>
        <html>
        <head>
            <meta charset="UTF-8">
    ...
    `}d(xi,"generateDiagnosticsHTML");function Di(a){return`<!DOCTYPE html>
    <html>
    <head>
        <meta charset="UTF-8">
    ...
    </html>`}d(Di,"generateDiagnosticsWebview");function Si(a){let e=d(t=>{if(t===0)return"0 B";let o=1024,i=["B","KB","MB","GB"],s=Math.floor(Math.log(t)/Math.log(o));return parseFloat((t/Math.pow(o,s)).toFixed(2))+" "+i[s]},"formatBytes");return`
        <!DOCTYPE html>
        <html>
        <head>
            <meta charset="UTF-8">
    ...
    `}d(Si,"generatePerformanceAnalyticsHTML");function Qt(a){let e=b.window.createStatusBarItem(b.StatusBarAlignment.Right,100);e.command="explorerDates.showFileDetails",e.tooltip="Click to show detailed file information";let t=d(async()=>{try{let o=b.window.activeTextEditor;if(!o){e.hide();return}let i=o.document.uri;if(i.scheme!=="file"){e.hide();return}let s=await wi.stat(i),r=s.mtime instanceof Date?s.mtime:new Date(s.mtime),n=O._formatDateBadge(r,"smart"),l=O._formatFileSize(s.size,"auto");e.text=`$(clock) ${n} $(file) ${l}`,e.show()}catch(o){e.hide(),D.debug("Failed to update status bar",o)}},"updateStatusBar");return b.window.onDidChangeActiveTextEditor(t),b.window.onDidChangeTextEditorSelection(t),t(),a.subscriptions.push(e),e}d(Qt,"initializeStatusBar");async function Fi(a){try{D=mi(),de=fi(),D.info("Explorer Dates: Extension activated");let e=b.env.uiKind===b.UIKind.Web;await b.commands.executeCommand("setContext","explorerDates.gitFeaturesAvailable",!e);let t=b.workspace.getConfiguration("explorerDates"),o=t.get("enableWorkspaceTemplates",!0),i=t.get("enableReporting",!0),s=t.get("enableExtensionApi",!0);O=new pi;let r=b.window.registerFileDecorationProvider(O);a.subscriptions.push(r),a.subscriptions.push(O),a.subscriptions.push(D),await O.initializeAdvancedSystems(a);let n=null,l=null,c=null,h=null,u=d(()=>{if(!n){let{OnboardingManager:y}=jt();n=new y(a)}return n},"getOnboardingManager"),g=d(()=>{if(!o)throw new Error("Workspace templates are disabled via explorerDates.enableWorkspaceTemplates");if(!l){let{WorkspaceTemplatesManager:y}=qt();l=new y(a)}return l},"getWorkspaceTemplatesManager"),v=d(()=>{if(!c){let{ExtensionApiManager:y}=Kt();c=new y}return c},"getExtensionApiManager"),m=d(()=>{if(!i)throw new Error("Reporting is disabled via explorerDates.enableReporting");if(!h){let{ExportReportingManager:y}=Jt();h=new y}return h},"getExportReportingManager"),j=d(()=>v().getApi(),"apiFactory");s?a.exports=j:(a.exports=void 0,D.info("Explorer Dates API exports disabled via explorerDates.enableExtensionApi")),b.workspace.getConfiguration("explorerDates").get("showWelcomeOnStartup",!0)&&await u().shouldShowOnboarding()&&setTimeout(()=>{u().showWelcomeMessage()},5e3),vi({context:a,fileDateProvider:O,logger:D,l10n:de}),bi({context:a,fileDateProvider:O,logger:D,generators:{generateWorkspaceActivityHTML:_i,generatePerformanceAnalyticsHTML:Si,generateDiagnosticsHTML:xi,generateDiagnosticsWebview:Di}}),yi({context:a,logger:D,getOnboardingManager:u});let he=b.commands.registerCommand("explorerDates.openTemplateManager",async()=>{try{if(!o){b.window.showInformationMessage("Workspace templates are disabled. Enable explorerDates.enableWorkspaceTemplates to use this command.");return}await g().showTemplateManager(),D.info("Template manager opened")}catch(y){D.error("Failed to open template manager",y),b.window.showErrorMessage(`Failed to open template manager: ${y.message}`)}});a.subscriptions.push(he);let oe=b.commands.registerCommand("explorerDates.saveTemplate",async()=>{try{if(!o){b.window.showInformationMessage("Workspace templates are disabled. Enable explorerDates.enableWorkspaceTemplates to save templates.");return}let y=await b.window.showInputBox({prompt:"Enter template name",placeHolder:"e.g., My Project Setup"});if(y){let G=await b.window.showInputBox({prompt:"Enter description (optional)",placeHolder:"Brief description of this template"})||"";await g().saveCurrentConfiguration(y,G)}D.info("Template saved")}catch(y){D.error("Failed to save template",y),b.window.showErrorMessage(`Failed to save template: ${y.message}`)}});a.subscriptions.push(oe);let Z=b.commands.registerCommand("explorerDates.generateReport",async()=>{try{if(!i){b.window.showInformationMessage("Reporting features are disabled. Enable explorerDates.enableReporting to generate reports.");return}await m().showReportDialog(),D.info("Report generation started")}catch(y){D.error("Failed to generate report",y),b.window.showErrorMessage(`Failed to generate report: ${y.message}`)}});a.subscriptions.push(Z);let ue=b.commands.registerCommand("explorerDates.showApiInfo",async()=>{try{if(!s){b.window.showInformationMessage("Explorer Dates API is disabled via settings.");return}let y=b.window.createWebviewPanel("apiInfo","Explorer Dates API Information",b.ViewColumn.One,{enableScripts:!0});y.webview.html=Ci(j()),D.info("API information panel opened")}catch(y){D.error("Failed to show API information",y),b.window.showErrorMessage(`Failed to show API information: ${y.message}`)}});a.subscriptions.push(ue);let P;b.workspace.getConfiguration("explorerDates").get("showStatusBar",!1)&&(P=Qt(a)),b.workspace.onDidChangeConfiguration(y=>{if(y.affectsConfiguration("explorerDates.showStatusBar")){let G=b.workspace.getConfiguration("explorerDates").get("showStatusBar",!1);G&&!P?P=Qt(a):!G&&P&&(P.dispose(),P=null)}}),D.info("Explorer Dates: Date decorations ready")}catch(e){let t=`${de?de.getString("activationError"):"Explorer Dates failed to activate"}: ${e.message}`;throw D&&D.error("Extension activation failed",e),b.window.showErrorMessage(t),e}}d(Fi,"activate");async function Ti(){try{D&&D.info("Explorer Dates extension is being deactivated"),O&&typeof O.dispose=="function"&&await O.dispose(),D&&D.info("Explorer Dates extension deactivated successfully")}catch(a){D&&D.error("Explorer Dates: Error during deactivation",a)}}d(Ti,"deactivate");module.exports={activate:Fi,deactivate:Ti};
