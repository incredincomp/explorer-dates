var u=(r,e)=>()=>(e||r((e={exports:{}}).exports,e),e.exports);var T=u((le,M)=>{var d="__explorerDatesLogger",m=class{constructor(){this.n=null}i(e,t){if(this.n&&typeof this.n[e]=="function")try{return this.n[e](...t)}catch{}switch(e){case"debug":break;case"info":break;case"warn":break;case"error":break;default:break}}debug(...e){return this.i("debug",e)}info(...e){return this.i("info",e)}warn(...e){return this.i("warn",e)}error(...e){return this.i("error",e)}S(e){this.n=e}};function q(){return typeof global<"u"?(global[d]||(global[d]=new m),global[d]):typeof globalThis<"u"?(globalThis[d]||(globalThis[d]=new m),globalThis[d]):(y||(y=new m),y)}var _=class extends m{},y=null;M.exports={Logger:_,getLogger:q}});var A=u((ce,R)=>{var G=typeof process<"u"&&process.env?process.env:{},K=G.VSCODE_WEB==="true",E=null;if(!K)try{let{exec:r}=require("child_process"),{promisify:e}=require("util");E=e(r)}catch{E=null}R.exports={execAsync:E}});var C=u((ue,I)=>{var v=require("vscode");function $(){try{let r=v?.env?.uiKind,e=v?.UIKind?.Web;return r!==void 0&&e!==void 0&&r===e}catch{return!1}}I.exports={isWebEnvironment:$}});var N=u((exports,module)=>{var{getLogger}=T(),{isWebEnvironment}=C(),env=typeof process<"u"&&process.env?process.env:{},isWebBuild=env.VSCODE_WEB==="true"||isWebEnvironment(),WebWorkerCtor=typeof globalThis<"u"&&typeof globalThis.Worker=="function"?globalThis.Worker:null,WorkerThreads=null,NodeFs=null,NodePath=null;if(!isWebBuild&&typeof process<"u"&&process.versions?.node){try{WorkerThreads=eval("require")("worker_threads")}catch{WorkerThreads=null}try{NodeFs=eval("require")("fs")}catch{NodeFs=null}try{NodePath=eval("require")("path")}catch{NodePath=null}}var DEFAULT_WASM_PATH=(()=>{if(!NodePath)return null;try{return NodePath.join(__dirname,"..","..","assets","wasm","digest.wasm")}catch{return null}})(),PERFORMANCE_REPORT_INTERVAL_MS=3e4,PERFORMANCE_MIN_SAMPLE_COUNT=100,WORKER_SOURCE=`
(function () {
...
`).slice(2,8).join(`
`)}catch{}let e={eval:!0,workerData:{wasmPath:this.c}},t=new WorkerThreads.Worker(WORKER_SOURCE,e);return t.on("message",s=>this.l(s)),t.on("error",s=>this._logger.debug("Index worker error",s)),t}m(e){isWebBuild?this.t.postMessage(e):this.t.postMessage(e)}l(e){if(!e||typeof e!="object")return;if(e.type==="log"){let l=e.level||"info";(typeof this._logger[l]=="function"?this._logger[l].bind(this._logger):this._logger.info.bind(this._logger))(e.message||"[IndexWorker] log entry",e.details);return}let{id:t,result:s,error:i}=e,o=this.s.get(t);o&&(this.s.delete(t),i?o.reject(new Error(i.message||"Worker task failed")):o.resolve(s))}u(e){let t=e||env.EXPLORER_DATES_WASM_PATH||DEFAULT_WASM_PATH;if(!t||!NodeFs)return null;try{if(NodeFs.existsSync(t))return t}catch{}return null}d(e,t){return e==="digest"?Promise.resolve((t||[]).map(s=>this.p(s))):Promise.resolve(t)}p(e={}){let t=[e.path||"",e.mtimeMs||0,e.size||0].join(":");return{path:e.path,hash:this.b(t),sizeBucket:this.w(e.size),ageBucket:this.k(e.mtimeMs)}}b(e){let t=0;if(!e)return"0";for(let s=0;s<e.length;s++)t=(t<<5)-t+e.charCodeAt(s),t|=0;return Math.abs(t).toString(16)}w(e){return!Number.isFinite(e)||e<=0||e<1024?"tiny":e<1024*100?"small":e<1024*1024?"medium":e<1024*1024*10?"large":"huge"}k(e){if(!Number.isFinite(e))return"unknown";let t=Date.now()-e;return t<0?"future":t<1e3*60?"minute":t<1e3*60*60?"hour":t<1e3*60*60*24?"day":t<1e3*60*60*24*7?"week":"old"}};module.exports={IndexWorkerHost}});var j=u((he,D)=>{function V(){return typeof Date=="function"&&Date.now?Date.now():16409952e5}function x(r){return!!(r&&typeof r=="object"&&typeof r.getTime=="function")}function X(r){if(x(r))return r;if(typeof r=="number")return new Date(r);if(typeof r=="string"){let e=Date.parse(r);return isNaN(e)?new Date:new Date(e)}return new Date}function h(r=""){return r?r.replace(/\\/g,"/"):""}function J(r=""){let e=h(r);return e?e.split("/").filter(Boolean):[]}function L(r=""){let e=J(r);return e.length?e[e.length-1]:""}function Y(r=""){let e=L(r),t=e.lastIndexOf(".");return t<=0?"":e.substring(t).toLowerCase()}function Q(r=""){let e=h(r),t=e.lastIndexOf("/");return t===-1?"":e.substring(0,t)}function Z(...r){return h(r.filter(Boolean).join("/")).replace(/\/+/g,"/")}function ee(r=""){return h(r).toLowerCase()}function te(r=""){if(!r)return"";if(typeof r=="string")return r;if(typeof r.fsPath=="string"&&r.fsPath.length>0)return r.fsPath;if(typeof r.path=="string"&&r.path.length>0)return r.path;if(typeof r.toString=="function")try{return r.toString(!0)}catch{return r.toString()}return String(r)}function re(r="",e=""){let t=h(r),s=h(e);return t&&s.startsWith(t)?s.substring(t.length).replace(/^\/+/,""):s}D.exports={ensureDate:X,isDateLike:x,getCurrentTimestamp:V,normalizePath:h,getFileName:L,getExtension:Y,getDirectory:Q,joinPath:Z,getCacheKey:ee,getUriPath:te,getRelativePath:re}});var B=u((exports,module)=>{var chunk=null;try{let dynamicRequire=typeof eval=="function"?eval("require"):null;if(typeof dynamicRequire=="function"){try{chunk=dynamicRequire("../chunks/utils-shared-chunk")}catch{}try{chunk||(chunk=dynamicRequire("./chunks/utils-shared-chunk"))}catch{}try{chunk||(chunk=dynamicRequire("../chunks/path-utils-chunk"))}catch{}try{chunk||(chunk=dynamicRequire("./chunks/path-utils-chunk"))}catch{}}}catch{}if(chunk&&chunk.normalizePath)module.exports={normalizePath:chunk.normalizePath,getFileName:chunk.getFileName,getExtension:chunk.getExtension,getDirectory:chunk.getDirectory,joinPath:chunk.joinPath,getCacheKey:chunk.getCacheKey,getUriPath:chunk.getUriPath,getRelativePath:chunk.getRelativePath};else{let r=function(n=""){return n?n.replace(/\\/g,"/"):""},e=function(n=""){let a=r(n);return a?a.split("/").filter(Boolean):[]},t=function(n=""){let a=e(n);return a.length?a[a.length-1]:""},s=function(n=""){let a=t(n),c=a.lastIndexOf(".");return c<=0?"":a.substring(c).toLowerCase()},i=function(n=""){let a=r(n),c=a.lastIndexOf("/");return c===-1?"":a.substring(0,c)},o=function(...n){return r(n.filter(Boolean).join("/")).replace(/\/+/g,"/")},l=function(n=""){return r(n).toLowerCase()},f=function(n=""){if(!n)return"";if(typeof n=="string")return n;if(typeof n.fsPath=="string"&&n.fsPath.length>0)return n.fsPath;if(typeof n.path=="string"&&n.path.length>0)return n.path;if(typeof n.toString=="function")try{return n.toString(!0)}catch{return n.toString()}return String(n)},p=function(n="",a=""){let c=r(n),g=r(a);return c&&g.startsWith(c)?g.substring(c.length).replace(/^\/+/,""):g};normalizePath=r,getSegments=e,getFileName=t,getExtension=s,getDirectory=i,joinPath=o,getCacheKey=l,getUriPath=f,getRelativePath=p,module.exports={normalizePath:r,getFileName:t,getExtension:s,getDirectory:i,joinPath:o,getCacheKey:l,getUriPath:f,getRelativePath:p}}var normalizePath,getSegments,getFileName,getExtension,getDirectory,joinPath,getCacheKey,getUriPath,getRelativePath});var U=u((fe,O)=>{var{getLogger:se}=T(),{execAsync:b}=A(),{IndexWorkerHost:ne}=N(),w;try{let r=j();r&&(w=r.getRelativePath)}catch{}w||(w=B().getRelativePath);var ie=typeof process<"u"&&process.env?process.env:{},S=ie.EXPLORER_DATES_DISABLE_GIT_FEATURES==="1",k=class{constructor(){this._logger=se(),this.r=new Map,this.y=1e3,this.e=null,this.a=!1,this._metrics={gitBlameTimeMs:0,gitBlameCalls:0,cacheHits:0,cacheMisses:0}}async initialize(e={}){if(!this.a){if(S){this._logger.debug("\u{1F527} Git insights disabled via EXPLORER_DATES_DISABLE_GIT_FEATURES"),this.a=!0;return}if(this._logger.debug("\u{1F527} Initializing Git Insights Manager"),e.enableWorker&&e.enableWasm)try{this.e=new ne({logger:this._logger}),this.e.isEnabled()?this._logger.debug("\u{1F527} Git insights worker host enabled"):(this.e=null,this._logger.debug("\u{1F527} Git insights worker host disabled (not supported)"))}catch(t){this._logger.debug("\u{1F527} Failed to initialize git insights worker:",t.message),this.e=null}this.a=!0,this._logger.debug("\u{1F527} Git Insights Manager initialized")}}async dispose(){if(this._logger.debug("GitInsightsManager.dispose called"),this.e){try{typeof this.e.dispose=="function"&&(await this.e.dispose(),this._logger.debug("GitInsightsManager: awaited workerHost.dispose()"))}catch(e){this._logger.debug("Error disposing git insights worker:",e.message)}this.e=null}this.r.clear(),this.a=!1,this._logger.debug("\u{1F527} Git Insights Manager disposed")}async isGitAvailable(){if(S||!b)return!1;try{return await b("git --version",{timeout:1e3}),!0}catch{return!1}}async getGitBlameInfo(e,t=null){if(S||!b)return null;try{let s=require("vscode"),i=s.workspace.getWorkspaceFolder(s.Uri.file(e));if(!i)return null;let o=i.uri.fsPath||i.uri.path,l=w(o,e),f=this._(o,l,t),p=this.T(f);if(p)return this._metrics.cacheHits++,p;this._metrics.cacheMisses++;let n=Date.now();try{let{stdout:a}=await b(`git log -1 --format="%H|%an|%ae|%ad" -- "${l}"`,{cwd:i.uri.fsPath,timeout:2e3});if(!a||!a.trim())return null;let[c,g,z,F]=a.trim().split("|"),W={hash:c||"",authorName:g||"Unknown",authorEmail:z||"",authorDate:F||""};return this.E(f,W),W}finally{let a=Date.now()-n;this._metrics.gitBlameTimeMs+=a,this._metrics.gitBlameCalls++}}catch(s){return this._logger.debug(`Git blame failed for ${e}:`,s.message),null}}getInitials(e){if(!e||typeof e!="string")return null;let t=e.trim().split(/\s+/).filter(Boolean);return t.length===0?null:t.length===1?t[0].substring(0,2).toUpperCase():(t[0].charAt(0)+t[1].charAt(0)).toUpperCase()}clearCache(){this.r.clear(),this._logger.debug("\u{1F527} Git cache cleared")}getMetrics(){return{...this._metrics,cacheSize:this.r.size,workerEnabled:!!(this.e&&this.e.isEnabled&&this.e.isEnabled())}}async digestEntry(e){if(!this.e||!this.e.isEnabled())return null;try{let[t]=await this.e.runTask("digest",[e]);return t}catch(t){return this._logger.debug("Worker digest failed:",t.message),null}}_(e,t,s){let i=e||"unknown-workspace",o=t||"unknown-relative",l=Number.isFinite(s)?s:"unknown-mtime";return`${i}::${o}::${l}`}T(e){let t=this.r.get(e);return t?(t.lastAccess=Date.now(),t.value):null}E(e,t){if(this.r.size>=this.y){let s=null,i=1/0;for(let[o,l]of this.r.entries())l.lastAccess<i&&(i=l.lastAccess,s=o);s&&this.r.delete(s)}this.r.set(e,{value:t,lastAccess:Date.now()})}},P=null;function oe(){return P||(P=new k),P}O.exports={GitInsightsManager:k,getGitInsightsManager:oe}});var{getGitInsightsManager:H}=U();module.exports={default:H,getGitInsightsManager:H};
