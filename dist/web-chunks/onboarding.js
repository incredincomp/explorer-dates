...
var z=Object.create;var T=Object.defineProperty;var H=Object.getOwnPropertyDescriptor;var B=Object.getOwnPropertyNames;var G=Object.getPrototypeOf,V=Object.prototype.hasOwnProperty;var p=(i,e)=>()=>(e||i((e={exports:{}}).exports,e),e.exports);var K=(i,e,t,o)=>{if(e&&typeof e=="object"||typeof e=="function")for(let r of B(e))!V.call(i,r)&&r!==t&&T(i,r,{get:()=>e[r],enumerable:!(o=H(e,r))||o.enumerable});return i};var _=(i,e,t)=>(t=i!=null?z(G(i)):{},K(e||!i||!i.__esModule?T(t,"default",{value:i,enumerable:!0}):t,i));var b=p((ae,D)=>{var f="__explorerDatesLogger",m=class{constructor(){this.s=null}a(e,t){if(this.s&&typeof this.s[e]=="function")try{return this.s[e](...t)}catch{}switch(e){case"debug":break;case"info":break;case"warn":break;case"error":break;default:break}}debug(...e){return this.a("debug",e)}info(...e){return this.a("info",e)}warn(...e){return this.a("warn",e)}error(...e){return this.a("error",e)}P(e){this.s=e}};function $(){return typeof global<"u"?(global[f]||(global[f]=new m),global[f]):typeof globalThis<"u"?(globalThis[f]||(globalThis[f]=new m),globalThis[f]):(S||(S=new m),S)}var x=class extends m{},S=null;D.exports={Logger:x,getLogger:$}});var A=p((ne,O)=>{var U=["Ja","Fe","Mr","Ap","My","Jn","Jl","Au","Se","Oc","No","De"],q=Number(process.env.EXPLORER_DATES_DECORATION_POOL_SIZE||2048),Y=Number(process.env.EXPLORER_DATES_FLYWEIGHT_CACHE_SIZE||4096),Q=Number(process.env.EXPLORER_DATES_WORKSPACE_BALANCED_THRESHOLD||15e3),X=Number(process.env.EXPLORER_DATES_WORKSPACE_LARGE_THRESHOLD||25e4),M=Number(process.env.EXPLORER_DATES_WORKSPACE_EXTREME_THRESHOLD||4e5),j=Number(process.env.EXPLORER_DATES_WORKSPACE_SCAN_MAX_RESULTS||Math.min(M+1,50001)),J={ADVANCED_CACHE:"explorerDates.advancedCache",ADVANCED_CACHE_METADATA:"explorerDates.advancedCacheMetadata",TEMPLATE_STORE:"explorerDates.templates",WEB_GIT_NOTICE:"explorerDates.webGitNotice"},Z="explorerDatesChunks",ee="__explorerDatesChunks";O.exports={DEFAULT_CACHE_TIMEOUT:12e4,DEFAULT_MAX_CACHE_SIZE:1e4,DEFAULT_PERSISTENT_CACHE_TTL:864e5,DEFAULT_DECORATION_POOL_SIZE:q,DEFAULT_FLYWEIGHT_CACHE_SIZE:Y,MAX_BADGE_LENGTH:2,MONTH_ABBREVIATIONS:U,WORKSPACE_SCALE_BALANCED_THRESHOLD:Q,WORKSPACE_SCALE_LARGE_THRESHOLD:X,WORKSPACE_SCALE_EXTREME_THRESHOLD:M,WORKSPACE_SCAN_MAX_RESULTS:j,GLOBAL_STATE_KEYS:J,WEB_CHUNK_GLOBAL_KEY:Z,LEGACY_WEB_CHUNK_GLOBAL_KEY:ee}});var L=p((exports,module)=>{var{getLogger}=b();function createFallbackVscodeMinimal(){return{workspace:{workspaceFolders:[],getConfiguration:()=>({get:()=>{},async update(){},inspect:()=>({defaultValue:void 0,globalValue:void 0,workspaceValue:void 0,workspaceFolderValue:void 0})})},ConfigurationTarget:{Global:1,Workspace:2,WorkspaceFolder:3}}}function resolveVscodeMinimal(){try{return require("vscode")}catch{return createFallbackVscodeMinimal()}}var MinimalSettingsCoordinator=class{constructor(e={}){this.m=e.defaultSection||"explorerDates",this.n=new Map,this.g=new Map,this.N=Number(process.env.EXPLORER_DATES_LOCK_WAIT_WARN_MS||1e3),this._logger=getLogger()}v(e,t){let r=(this.n.get(e)||Promise.resolve()).then(()=>t()),s=r.catch(()=>{});return this.n.set(e,s),r.finally(()=>{this.n.get(e)===s&&this.n.delete(e)}),r}d(e,t){return resolveVscodeMinimal().workspace.getConfiguration(e||void 0,t)}o(e,t){let o=t||this.m;return o?e.startsWith(`${o}.`)?{section:o,key:e.slice(o.length+1),fullKey:e}:e.includes(".")?{section:void 0,key:e,fullKey:e}:{section:o,key:e,fullKey:`${o}.${e}`}:{section:void 0,key:e,fullKey:e}}async updateSetting(e,t,o={}){return this.v(this.o(e,o.section).fullKey,async()=>{let r=this.o(e,o.section),s=this.d(r.section,o.resource);try{let a=this.b(o.scope,o.resource);return await s.update(r.key,t,a),{key:r.fullKey,updated:!0}}catch(a){try{this._logger.warn(`Configuration update failed for ${r.fullKey}: ${a&&a.message}`)}catch{}return{key:r.fullKey,updated:!1,error:a}}})}async applySettings(e,t={}){let o=Array.isArray(e)?e:Object.entries(e).map(([a,c])=>({key:a,value:c})),r=[];for(let a of o)try{r.push(await this.updateSetting(a.key,a.value,t))}catch(c){r.push({key:this.o(a.key,t.section).fullKey,updated:!1,error:c})}let s=r.filter(a=>a&&a.error);if(s.length>0){let a=s.map(d=>`${d.key}: ${d.error&&d.error.message?d.error.message:String(d.error)}`),c=new Error(`Failed to apply ${s.length} setting(s): ${a.join("; ")}`);throw c.details=s,c}return r}b(e,t){return e&&e!=="auto"?this.w(e)||resolveVscodeMinimal().ConfigurationTarget.Workspace:t?resolveVscodeMinimal().ConfigurationTarget.WorkspaceFolder:resolveVscodeMinimal().workspace.workspaceFolders&&resolveVscodeMinimal().workspace.workspaceFolders.length>0?resolveVscodeMinimal().ConfigurationTarget.Workspace:resolveVscodeMinimal().ConfigurationTarget.Global}w(e){switch(e){case"user":return resolveVscodeMinimal().ConfigurationTarget.Global;case"workspace":return resolveVscodeMinimal().ConfigurationTarget.Workspace;case"workspaceFolder":return resolveVscodeMinimal().ConfigurationTarget.WorkspaceFolder;default:return}}getValue(e,t={}){let{section:o,resource:r}=t||{},s=this.o(e,o);return this.d(s.section,r).get(s.key)}inspect(e,t={}){let{section:o,resource:r}=t||{},s=this.o(e,o);return this.d(s.section,r).inspect(s.key)}async clearSetting(e,t={}){return this.updateSetting(e,void 0,t)}getLockWaitStats(){let e={};for(let[t,o]of this.g.entries())e[t]={...o};return e}resetLockWaitStats(){this.g.clear()}},cachedCoordinator=null;function getSettingsCoordinator(options){if(!cachedCoordinator||options&&options.forceNew){try{let dynamicRequire=typeof eval=="function"?eval("require"):null;if(typeof dynamicRequire=="function"){let i=null;try{i=dynamicRequire("../chunks/settings-coordinator-impl-chunk")}catch{}try{i||(i=dynamicRequire("../chunks/settingsCoordinator-impl-chunk"))}catch{}if(i&&typeof i.createSettingsCoordinatorImpl=="function")return cachedCoordinator=i.createSettingsCoordinatorImpl(options),cachedCoordinator}}catch{}try{let{WEB_CHUNK_GLOBAL_KEY:i,LEGACY_WEB_CHUNK_GLOBAL_KEY:e}=A(),t=typeof globalThis<"u"&&(globalThis[i]||globalThis[e])||null;if(t&&t.settingsCoordinatorImpl&&typeof t.settingsCoordinatorImpl.createSettingsCoordinatorImpl=="function")return cachedCoordinator=t.settingsCoordinatorImpl.createSettingsCoordinatorImpl(options),cachedCoordinator}catch{}cachedCoordinator=new MinimalSettingsCoordinator(options)}return cachedCoordinator}module.exports={getSettingsCoordinator,MinimalSettingsCoordinator}});var C=p((exports,module)=>{var vscode=require("vscode"),getLogger=()=>{try{let dynamicRequire=typeof eval=="function"?eval("require"):null;if(typeof dynamicRequire=="function"){let i=dynamicRequire("./chunks/logger-chunk");if(i&&typeof i.getLogger=="function")return getLogger=i.getLogger,getLogger()}}catch{}try{return getLogger=b().getLogger,getLogger()}catch{return getLogger=()=>({debug:(()=>{})?.bind(console)||console.log,info:(()=>{}).bind(console),warn:(()=>{}).bind(console),error:(()=>{}).bind(console)}),getLogger()}},{getLocalization}=require("./utils/localization"),{getSettingsCoordinator}=L(),OnboardingManager=class{constructor(e){this.e=e,this._logger=getLogger(),this.W=getLocalization(),this.u=getSettingsCoordinator(),this.p=e.globalState.get("explorerDates.hasShownWelcome",!1),this.h=e.globalState.get("explorerDates.hasCompletedSetup",!1),this.i=e.globalState.get("explorerDates.onboardingVersion","0.0.0"),this._logger.info("OnboardingManager initialized",{hasShownWelcome:this.p,hasCompletedSetup:this.h,onboardingVersion:this.i})}async shouldShowOnboarding(){let e=this.e.extension.packageJSON.version;return!this.p||!this.h||this.y(e)}y(e){if(this.i==="0.0.0")return!0;let[t]=e.split(".").map(Number),[o]=this.i.split(".").map(Number);return t>o}S(e){if(this.i==="0.0.0")return!1;let[t,o]=e.split(".").map(Number),[r,s]=this.i.split(".").map(Number);return t===r&&o>s}async showWelcomeMessage(){try{let e=this.e.extension.packageJSON.version,t=this.p,o=this.S(e);if(o)return this.x(e);let r=this.e.globalState.get("explorerDates.migrationHistory",[]),s=r.find(E=>E.extensionVersion===e&&E.migratedSettings.length>0),a=t?`Explorer Dates has been updated to v${e} with new features and improvements!`:"See file modification dates right in VS Code Explorer with intuitive time badges, file sizes, Git info, and much more!";s&&(a+=`
...
${t.description}`;await vscode.window.showInformationMessage(o,"Show More Tips","Got it!")==="Show More Tips"&&await this.showFeatureTour()}async showWhatsNew(e){try{let t=vscode.window.createWebviewPanel("explorerDatesWhatsNew",`Explorer Dates v${e} - What's New`,vscode.ViewColumn.One,{enableScripts:!0,retainContextWhenHidden:!1}),o=await this._(e);t.webview.html=o,t.webview.onDidReceiveMessage(async r=>{switch(r.command){case"openSettings":await vscode.commands.executeCommand("workbench.action.openSettings","explorerDates"),t.dispose();break;case"tryFeature":r.feature==="badgePriority"&&(await this.u.updateSetting("badgePriority","author",{scope:"user",reason:"whats-new-demo"}),vscode.window.showInformationMessage("Badge priority set to author! You should see author initials on files now."));break;case"dismiss":t.dispose();break}})}catch(t){this._logger.error("Failed to show what's new",t)}}async _(e){try{let{loadOnboardingAssets:t}=v(),o=await t();if(o)return this._logger.debug("Using chunked onboarding assets for what's new"),await o.getWhatsNewHTML(e)}catch(t){this._logger.warn("Failed to load chunked assets for what's new, using inline fallback",t)}return this.D(e)}D(e){return`<!DOCTYPE html><html><head><meta charset="utf-8"><title>What's New</title></head><body><h1>What's New ${e}</h1><p>Full content loads on demand.</p></body></html>`}};module.exports={OnboardingManager}});var N=p((ce,P)=>{var{OnboardingManager:F}=C();P.exports={OnboardingManager:F,createOnboardingManager:i=>new F(i)}});var I=p((le,W)=>{var{getLogger:te}=b(),g=class{constructor(){this._logger=te(),this.t=null,this.r=!1}async initialize(){if(!this.r)try{this.t={setupWizardTemplate:this.M(),featureTourTemplate:this.O(),whatsNewTemplate:this.A(),sharedStyles:this.c(),sharedScripts:this.l()},this.r=!0,this._logger.debug("Onboarding assets initialized (~23KB lazy loaded)")}catch(e){throw this._logger.error("Failed to initialize onboarding assets",e),e}}async getSetupWizardHTML(e){return await this.initialize(),this.L(this.t.setupWizardTemplate,e)}async getFeatureTourHTML(){return await this.initialize(),this.t.featureTourTemplate}async getWhatsNewHTML(e){return await this.initialize(),this.F(this.t.whatsNewTemplate,e)}L(e,t){let o=Object.entries(t).map(([s,a])=>`
        ...
        `).replace("{{PRESETS_JSON}}",JSON.stringify(t))}F(e,t){return e.replace(/{{VERSION}}/g,t)}M(){return`
            <!DOCTYPE html>
            <html>
            <head>
                <meta charset="UTF-8">
        ...
        `}getPresets(){return{minimal:{name:"Minimal",description:"Clean and simple - just show modification times in short format",settings:{dateDecorationFormat:"relative-short",colorScheme:"none",highContrastMode:!1,showFileSize:!1,showGitInfo:"none",badgePriority:"time",fadeOldFiles:!1,enableContextMenu:!1,showStatusBar:!1}},developer:{name:"Developer",description:"Perfect for development - includes Git info, file sizes, and color coding",settings:{dateDecorationFormat:"smart",colorScheme:"recency",showFileSize:!0,showGitInfo:"author",badgePriority:"time",fadeOldFiles:!0,enableContextMenu:!0,showStatusBar:!0}},accessible:{name:"Accessible",description:"High contrast and screen reader friendly with detailed tooltips",settings:{dateDecorationFormat:"relative-short",colorScheme:"none",highContrastMode:!0,accessibilityMode:!0,showFileSize:!1,showGitInfo:"none",badgePriority:"time",fadeOldFiles:!1,enableContextMenu:!0,keyboardNavigation:!0}}}}getTips(){return[{icon:"\u2328\uFE0F",title:"Keyboard Shortcuts",description:"Use Ctrl+Shift+D (Cmd+Shift+D on Mac) to quickly toggle decorations on/off."},{icon:"\u{1F3AF}",title:"Smart Exclusions",description:"The extension automatically detects and suggests excluding build folders for better performance."},{icon:"\u{1F4CA}",title:"Performance Analytics",description:'Use "Show Performance Analytics" to monitor cache performance and optimization opportunities.'},{icon:"\u{1F50D}",title:"Context Menu",description:"Right-click any file to access Git history, file details, and quick actions."}]}getMemoryInfo(){return{chunkName:"onboarding-assets",estimatedSize:"~23KB",templatesLoaded:this.r,templateCount:this.t?Object.keys(this.t).length:0,loaded:this.r}}dispose(){this.t=null,this.r=!1,this._logger.debug("Onboarding assets disposed")}};W.exports={OnboardingAssets:g,createOnboardingAssets:()=>new g,getPresets:()=>new g().getPresets(),getTips:()=>new g().getTips(),getMemoryInfo:(()=>{let i=null;return()=>(i||(i=new g),i.getMemoryInfo())})()}});var v=p((de,R)=>{var l=null,n=null,{getLogger:oe}=b(),k=oe(),u=require("vscode"),w=class{constructor(e){this.e=e}async showQuickSetupWizard(){let e=u.window.createWebviewPanel("explorerDatesSetup","Explorer Dates Quick Setup",u.ViewColumn.One,{enableScripts:!0,retainContextWhenHidden:!0});e.webview.html=`<!DOCTYPE html>
            ...
            </html>`}async showFeatureTour(){let e=u.window.createWebviewPanel("explorerDatesFeatureTour","Explorer Dates Feature Tour",u.ViewColumn.One,{enableScripts:!1,retainContextWhenHidden:!1});e.webview.html='<!DOCTYPE html><html><head><meta charset="utf-8"><title>Feature Tour</title></head><body><h1>Explorer Dates Feature Tour</h1><p>Feature tour is unavailable in this session.</p></body></html>'}async showWhatsNew(e=""){let t=u.window.createWebviewPanel("explorerDatesWhatsNew",`Explorer Dates ${e?`v${e}`:""} - What's New`,u.ViewColumn.One,{enableScripts:!1,retainContextWhenHidden:!1});t.webview.html=`<!DOCTYPE html><html><head><meta charset="utf-8"><title>What's New</title></head><body><h1>What's New ${e}</h1><p>What's new content is unavailable in this session.</p></body></html>`}async showWelcomeMessage(){await u.window.showInformationMessage("Explorer Dates onboarding is unavailable. Open settings to configure.","Open Settings").then(e=>{e==="Open Settings"&&u.commands.executeCommand("workbench.action.openSettings","explorerDates")})}};async function ie(){if(!(l&&n))try{let i=await Promise.resolve().then(()=>_(N()));if(l=i.OnboardingManager||i.default?.OnboardingManager||i.default,n=i.createOnboardingManager,typeof n!="function"&&typeof l=="function"&&(n=e=>new l(e)),typeof n!="function")throw new Error("Onboarding logic loaded without a valid factory")}catch{try{let i=await Promise.resolve().then(()=>_(C()));if(l=i.OnboardingManager||i.default?.OnboardingManager||i.default,n=i.createOnboardingManager,typeof n!="function"&&typeof l=="function"&&(n=e=>new l(e)),typeof n!="function")throw new Error("Onboarding fallback loaded without a valid factory")}catch(i){k.warn("Onboarding logic unavailable, using minimal fallback",i),l=w,n=e=>new w(e)}}}var y=!1,h=null,re=async()=>{if(y&&h)return h;try{return h=I().createOnboardingAssets(),await h.initialize(),y=!0,k.info("Onboarding webview assets loaded",{chunk:"onboarding-assets",estimatedKB:23}),h}catch(i){return k.warn("Failed to load onboarding assets, falling back to inline templates",i),null}};R.exports={OnboardingManager:l,createOnboardingManager:async i=>(await ie(),n(i)),loadOnboardingAssets:re,getAssetsMemoryInfo:()=>h?h.getMemoryInfo():{loaded:y,templatesLoaded:y,chunkName:"onboarding-assets",estimatedSize:"~23KB"}}});module.exports=v();
