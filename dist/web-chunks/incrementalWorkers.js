...
var g=(l,e)=>()=>(e||l((e={exports:{}}).exports,e),e.exports);var u=g((_,d)=>{var n="__explorerDatesLogger",i=class{constructor(){this.s=null}o(e,r){if(this.s&&typeof this.s[e]=="function")try{return this.s[e](...r)}catch{}switch(e){case"debug":break;case"info":break;case"warn":break;case"error":break;default:break}}debug(...e){return this.o("debug",e)}info(...e){return this.o("info",e)}warn(...e){return this.o("warn",e)}error(...e){return this.o("error",e)}w(e){this.s=e}};function b(){return typeof global<"u"?(global[n]||(global[n]=new i),global[n]):typeof globalThis<"u"?(globalThis[n]||(globalThis[n]=new i),globalThis[n]):(c||(c=new i),c)}var h=class extends i{},c=null;d.exports={Logger:h,getLogger:b}});var m=g((exports,module)=>{var{getLogger}=u(),isWebBuild=process.env.VSCODE_WEB==="true",WebWorkerCtor=typeof globalThis<"u"&&typeof globalThis.Worker=="function"?globalThis.Worker:null,WorkerThreads=null,NodeFs=null,NodePath=null;if(!isWebBuild){try{WorkerThreads=eval("require")("worker_threads")}catch{WorkerThreads=null}try{NodeFs=eval("require")("fs")}catch{NodeFs=null}try{NodePath=eval("require")("path")}catch{NodePath=null}}var DEFAULT_WASM_PATH=(()=>{if(!NodePath)return null;try{return NodePath.join(__dirname,"..","..","assets","wasm","digest.wasm")}catch{return null}})(),PERFORMANCE_REPORT_INTERVAL_MS=3e4,PERFORMANCE_MIN_SAMPLE_COUNT=100,WORKER_SOURCE=`
(function () {
