...
var u=(a,e)=>()=>(e||a((e={exports:{}}).exports,e),e.exports);var l=u((exports,module)=>{var vscode=require("vscode"),isWebRuntime=process.env.VSCODE_WEB==="true",inspectValue=isWebRuntime?a=>{if(typeof a=="string")return a;try{return JSON.stringify(a,null,2)}catch{return"<<unable to serialize log arg>>"}}:eval("require")("util").inspect,DEFAULT_LOG_PROFILE="default",SUPPORTED_PROFILES=new Set(["default","stress","soak"]),LOG_LEVEL_ORDER=["debug","info","warn","error"],DEFAULT_CONSOLE_LEVEL="warn",Logger=class{constructor(){this.t=vscode.window.createOutputChannel("Explorer Dates"),this.u=!1,this.a=null,this.n=(process.env.EXPLORER_DATES_LOG_PROFILE||DEFAULT_LOG_PROFILE).toLowerCase(),SUPPORTED_PROFILES.has(this.n)||(this.n=DEFAULT_LOG_PROFILE),this.i=new Map,this.d=DEFAULT_CONSOLE_LEVEL,this.p(),this.a=vscode.workspace.onDidChangeConfiguration(e=>{(e.affectsConfiguration("explorerDates.enableLogging")||e.affectsConfiguration("explorerDates.consoleLogLevel"))&&this.p()})}p(){let e=vscode.workspace.getConfiguration("explorerDates");this.u=e.get("enableLogging",!1);let t=(e.get("consoleLogLevel",DEFAULT_CONSOLE_LEVEL)||"").toLowerCase();this.d=LOG_LEVEL_ORDER.includes(t)?t:DEFAULT_CONSOLE_LEVEL}setLogProfile(e=DEFAULT_LOG_PROFILE){let t=(e||DEFAULT_LOG_PROFILE).toLowerCase();this.n=SUPPORTED_PROFILES.has(t)?t:DEFAULT_LOG_PROFILE,this.resetThrottle()}resetThrottle(e){if(e){this.i.delete(e);return}this.i.clear()}debug(e,...t){this.u&&this.l("debug",null,e,t)}info(e,...t){this.l("info",null,e,t)}infoWithOptions(e,t,...s){this.l("info",e||null,t,s)}warn(e,...t){this.l("warn",null,e,t)}error(e,t,...s){let n=`[${new Date().toISOString()}] [ERROR] ${e}`;this.t.appendLine(n),t instanceof Error?(this.t.appendLine(`Error: ${t.message}`),t.stack&&this.t.appendLine(`Stack: ${t.stack}`)):t&&this.t.appendLine(this.f(t));let r=this.m(s);r.length>0&&r.forEach(o=>this.t.appendLine(this.f(o))),this.c("error",n,[t,...r])}show(){this.t.show()}clear(){this.t.clear()}dispose(){this.t.dispose(),this.a&&(this.a.dispose(),this.a=null);let e="__explorerDatesLogger";typeof global<"u"&&global[e]===this?global[e]=null:typeof globalThis<"u"&&globalThis[e]===this?globalThis[e]=null:typeof window<"u"&&window[e]===this&&(window[e]=null),loggerInstance===this&&(loggerInstance=null)}l(e,t,s,i){if(e==="debug"&&!this.u||this.w(e,t))return;let r=`[${new Date().toISOString()}] [${e.toUpperCase()}] ${s}`;this.t.appendLine(r);let o=this.m(i);o.length>0&&o.forEach(g=>this.t.appendLine(this.f(g))),this.c(e,r,o)}m(e){return!e||e.length===0?[]:e.map(t=>{if(typeof t!="function")return t;try{return t()}catch(s){return`<<log arg threw: ${s.message}>>`}})}f(e){try{return typeof e=="string"?e:typeof e=="object"?JSON.stringify(e,null,2):inspectValue(e)}catch(t){return`<<failed to serialize log arg: ${t.message}>>`}}w(e,t){if(e!=="info"||!t||!t.throttleKey)return!1;let s=(t.profile||"stress").toLowerCase();if(!this.E(s))return!1;let i=Number(t.throttleLimit)||50,n=t.throttleKey,r=this.i.get(n)||{count:0,suppressed:0,noticeLogged:!1};if(r.count<i)return r.count+=1,this.i.set(n,r),!1;if(r.suppressed+=1,!r.noticeLogged){r.noticeLogged=!0;let o=`[${new Date().toISOString()}] [INFO] \u23F8\uFE0F Suppressing further logs for "${n}" after ${i} entries (profile=${this.n})`;this.t.appendLine(o),this.c("info",o)}return this.i.set(n,r),!0}E(e){let t=this.n||DEFAULT_LOG_PROFILE;return e==="default"?t===DEFAULT_LOG_PROFILE:t===e}b(e){let t=LOG_LEVEL_ORDER.indexOf(this.d),s=LOG_LEVEL_ORDER.indexOf(e);return t===-1||s===-1?!1:s>=t}c(e,t,s=[]){if(!this.b(e))return;(e==="warn"?console.warn:e==="error"?console.error:console.log).call(console,t,...s)}},GLOBAL_LOGGER_KEY="__explorerDatesLogger";function getLogger(){return typeof global<"u"?(global[GLOBAL_LOGGER_KEY]||(global[GLOBAL_LOGGER_KEY]=new Logger),global[GLOBAL_LOGGER_KEY]):typeof globalThis<"u"?(globalThis[GLOBAL_LOGGER_KEY]||(globalThis[GLOBAL_LOGGER_KEY]=new Logger),globalThis[GLOBAL_LOGGER_KEY]):typeof window<"u"?(window[GLOBAL_LOGGER_KEY]||(window[GLOBAL_LOGGER_KEY]=new Logger),window[GLOBAL_LOGGER_KEY]):(loggerInstance||(loggerInstance=new Logger),loggerInstance)}var loggerInstance=null;module.exports={Logger,getLogger}});var f=u((exports,module)=>{var{getLogger}=l(),isWebBuild=process.env.VSCODE_WEB==="true",WebWorkerCtor=typeof globalThis<"u"&&typeof globalThis.Worker=="function"?globalThis.Worker:null,WorkerThreads=null,NodeFs=null,NodePath=null;if(!isWebBuild){try{WorkerThreads=eval("require")("worker_threads")}catch{WorkerThreads=null}try{NodeFs=eval("require")("fs")}catch{NodeFs=null}try{NodePath=eval("require")("path")}catch{NodePath=null}}var DEFAULT_WASM_PATH=(()=>{if(!NodePath)return null;try{return NodePath.join(__dirname,"..","..","assets","wasm","digest.wasm")}catch{return null}})(),PERFORMANCE_REPORT_INTERVAL_MS=3e4,PERFORMANCE_MIN_SAMPLE_COUNT=100,WORKER_SOURCE=`
(function () {
...
`,IndexWorkerHost=class{constructor(e={}){this.e=e.logger||getLogger(),this.g=this._(e.wasmPath),this.h=this.O(),this.s=null,this.o=new Map,this.T=1,this.h&&(this.s=this.R(),this.s||(this.h=!1)),this.s||this.e.debug("IndexWorkerHost disabled (worker support unavailable)")}isEnabled(){return!!this.s}async runTask(e,t){if(!this.s)return this.k(e,t);let s=this.T++;return new Promise((i,n)=>{this.o.set(s,{resolve:i,reject:n});try{this.y({id:s,task:e,payload:t})}catch(r){this.o.delete(s),n(r)}})}dispose(){this.s&&(isWebBuild?this.s.terminate():this.s.terminate(),this.s=null),this.o.clear()}O(){if(isWebBuild){let e=typeof globalThis.Blob=="function",t=typeof globalThis.URL=="function"||typeof globalThis.URL=="object",s=!!(globalThis.URL&&typeof globalThis.URL.createObjectURL=="function");return!!(WebWorkerCtor&&e&&t&&s)}return!!WorkerThreads}R(){if(isWebBuild){if(!WebWorkerCtor)return this.e.debug("Web Worker constructor unavailable; worker disabled"),this.h=!1,null;let s=new Blob([WORKER_SOURCE],{type:"application/javascript"}),i=globalThis.URL.createObjectURL(s),n=new WebWorkerCtor(i);return n.onmessage=r=>this.L(r.data),n.onerror=r=>this.e.debug("Index worker (web) error",r),n}if(!WorkerThreads||!WorkerThreads.Worker)return this.e.debug("worker_threads unavailable; worker disabled"),this.h=!1,null;let e={eval:!0,workerData:{wasmPath:this.g}},t=new WorkerThreads.Worker(WORKER_SOURCE,e);return t.on("message",s=>this.L(s)),t.on("error",s=>this.e.debug("Index worker error",s)),t}y(e){isWebBuild?this.s.postMessage(e):this.s.postMessage(e)}L(e){if(!e||typeof e!="object")return;if(e.type==="log"){let r=e.level||"info";(typeof this.e[r]=="function"?this.e[r].bind(this.e):this.e.info.bind(this.e))(e.message||"[IndexWorker] log entry",e.details);return}let{id:t,result:s,error:i}=e,n=this.o.get(t);n&&(this.o.delete(t),i?n.reject(new Error(i.message||"Worker task failed")):n.resolve(s))}_(e){let t=e||process.env.EXPLORER_DATES_WASM_PATH||DEFAULT_WASM_PATH;if(!t||!NodeFs)return null;try{if(NodeFs.existsSync(t))return t}catch{}return null}k(e,t){switch(e){case"digest":return Promise.resolve((t||[]).map(s=>this.S(s)));default:return Promise.resolve(t)}}S(e={}){let t=[e.path||"",e.mtimeMs||0,e.size||0].join(":");return{path:e.path,hash:this.A(t),sizeBucket:this.P(e.size),ageBucket:this.W(e.mtimeMs)}}A(e){let t=0;if(!e)return"0";for(let s=0;s<e.length;s++)t=(t<<5)-t+e.charCodeAt(s),t|=0;return Math.abs(t).toString(16)}P(e){return!Number.isFinite(e)||e<=0||e<1024?"tiny":e<1024*100?"small":e<1024*1024?"medium":e<1024*1024*10?"large":"huge"}W(e){if(!Number.isFinite(e))return"unknown";let t=Date.now()-e;return t<0?"future":t<1e3*60?"minute":t<1e3*60*60?"hour":t<1e3*60*60*24?"day":t<1e3*60*60*24*7?"week":"old"}};module.exports={IndexWorkerHost}});var{IndexWorkerHost:c}=f(),{getLogger:d}=l(),h=class{constructor(e={}){this.e=e.logger||d(),this.r=null,this.g=e.wasmPath}async initialize(){return this.r||(this.r=new c({logger:this.e,wasmPath:this.g}),this.e.debug("Incremental workers initialized")),this.r}getWorkerHost(){return this.r}isWorkerEnabled(){return this.r?.isEnabled()||!1}async runTask(e,t){return this.r||await this.initialize(),this.r.runTask(e,t)}dispose(){this.r&&(this.r.dispose(),this.r=null,this.e.debug("Incremental workers disposed"))}};module.exports={IncrementalWorkersManager:h,IndexWorkerHost:c};
})(); (globalThis.__explorerDatesChunks = globalThis.__explorerDatesChunks || {})["incrementalWorkers"] = module.exports;
