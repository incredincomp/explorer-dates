...
var g=(r,e)=>()=>(e||r((e={exports:{}}).exports,e),e.exports);var T=g((re,R)=>{var d="__explorerDatesLogger",m=class{constructor(){this.n=null}i(e,t){if(this.n&&typeof this.n[e]=="function")try{return this.n[e](...t)}catch{}switch(e){case"debug":break;case"info":break;case"warn":break;case"error":break;default:break}}debug(...e){return this.i("debug",e)}info(...e){return this.i("info",e)}warn(...e){return this.i("warn",e)}error(...e){return this.i("error",e)}S(e){this.n=e}};function H(){return typeof global<"u"?(global[d]||(global[d]=new m),global[d]):typeof globalThis<"u"?(globalThis[d]||(globalThis[d]=new m),globalThis[d]):(y||(y=new m),y)}var _=class extends m{},y=null;R.exports={Logger:_,getLogger:H}});var W=g((se,A)=>{var z=process.env.VSCODE_WEB==="true",E=null;if(!z)try{let{exec:r}=require("child_process"),{promisify:e}=require("util");E=e(r)}catch{E=null}A.exports={execAsync:E}});var I=g((exports,module)=>{var{getLogger}=T(),isWebBuild=process.env.VSCODE_WEB==="true",WebWorkerCtor=typeof globalThis<"u"&&typeof globalThis.Worker=="function"?globalThis.Worker:null,WorkerThreads=null,NodeFs=null,NodePath=null;if(!isWebBuild){try{WorkerThreads=eval("require")("worker_threads")}catch{WorkerThreads=null}try{NodeFs=eval("require")("fs")}catch{NodeFs=null}try{NodePath=eval("require")("path")}catch{NodePath=null}}var DEFAULT_WASM_PATH=(()=>{if(!NodePath)return null;try{return NodePath.join(__dirname,"..","..","assets","wasm","digest.wasm")}catch{return null}})(),PERFORMANCE_REPORT_INTERVAL_MS=3e4,PERFORMANCE_MIN_SAMPLE_COUNT=100,WORKER_SOURCE=`
(function () {
