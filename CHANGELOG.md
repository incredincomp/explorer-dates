...
- Ensure custom colors are applied in Performance Mode when `explorerDates.colorScheme` is `custom`, while keeping performance optimizations disabled (references #29, #30).
